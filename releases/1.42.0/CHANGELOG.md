...
### `@backstage/cli` (0.33.1 → [0.34.0](../../changelogs/@backstage/cli.md#0340))
...
### `@backstage/core-compat-api` (0.4.4 → [0.5.0](../../changelogs/@backstage/core-compat-api.md#050))
...
### `@backstage/frontend-app-api` (0.11.4 → [0.12.0](../../changelogs/@backstage/frontend-app-api.md#0120))
...
### `@backstage/frontend-defaults` (0.2.4 → [0.3.0](../../changelogs/@backstage/frontend-defaults.md#030))
...
### `@backstage/frontend-plugin-api` (0.10.4 → [0.11.0](../../changelogs/@backstage/frontend-plugin-api.md#0110))
...
### `@backstage/plugin-app` (0.1.11 → [0.2.0](../../changelogs/@backstage/plugin-app.md#020))
...
### `@backstage/plugin-catalog-react` (1.19.1 → [1.20.0](../../changelogs/@backstage/plugin-catalog-react.md#1200))
...
### `@backstage/plugin-home` (0.8.10 → [0.8.11](../../changelogs/@backstage/plugin-home.md#0811))
...
### `@backstage/plugin-kubernetes-backend` (0.19.8 → [0.20.0](../../changelogs/@backstage/plugin-kubernetes-backend.md#0200))
...
### `@backstage/plugin-signals` (0.0.21 → [0.0.22](../../changelogs/@backstage/plugin-signals.md#0022))
...
### `@backstage/ui` (0.6.1 → [0.7.0](../../changelogs/@backstage/ui.md#070))
...
### `@backstage/backend-defaults` (0.11.1 → [0.12.0](../../changelogs/@backstage/backend-defaults.md#0120))
...
### `@backstage/backend-openapi-utils` (0.5.5 → [0.6.0](../../changelogs/@backstage/backend-openapi-utils.md#060))
...
### `@backstage/plugin-notifications-common` (0.0.10 → [0.1.0](../../changelogs/@backstage/plugin-notifications-common.md#010))
...
### `@backstage/plugin-scaffolder-node` (0.10.0 → [0.11.0](../../changelogs/@backstage/plugin-scaffolder-node.md#0110))
...
### `@backstage/core-components` (0.17.4 → [0.17.5](../../changelogs/@backstage/core-components.md#0175))
...
### `@backstage/create-app` (0.7.1 → [0.7.2](../../changelogs/@backstage/create-app.md#072))
...
### `@backstage/frontend-test-utils` (0.3.4 → [0.3.5](../../changelogs/@backstage/frontend-test-utils.md#035))
...
### `@backstage/plugin-api-docs` (0.12.9 → [0.12.10](../../changelogs/@backstage/plugin-api-docs.md#01210))
...
### `@backstage/plugin-app-visualizer` (0.1.21 → [0.1.22](../../changelogs/@backstage/plugin-app-visualizer.md#0122))
...
### `@backstage/plugin-auth-backend-module-okta-provider` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-auth-backend-module-okta-provider.md#026))
...
### `@backstage/plugin-catalog-backend-module-gcp` (0.3.10 → [0.3.11](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#0311))
...
### `@backstage/plugin-catalog-backend-module-github` (0.10.1 → [0.10.2](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#0102))
...
### `@backstage/plugin-catalog-backend-module-gitlab` (0.7.1 → [0.7.2](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#072))
...
### `@backstage/plugin-catalog-backend-module-gitlab-org` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab-org.md#0212))
...
### `@backstage/plugin-catalog-graph` (0.4.21 → [0.4.22](../../changelogs/@backstage/plugin-catalog-graph.md#0422))
...
### `@backstage/plugin-catalog-import` (0.13.3 → [0.13.4](../../changelogs/@backstage/plugin-catalog-import.md#0134))
...
### `@backstage/plugin-catalog-unprocessed-entities` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#0220))
...
### `@backstage/plugin-devtools` (0.1.29 → [0.1.30](../../changelogs/@backstage/plugin-devtools.md#0130))
...
### `@backstage/plugin-events-backend-module-kafka` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-events-backend-module-kafka.md#012))
...
### `@backstage/plugin-kubernetes` (0.12.9 → [0.12.10](../../changelogs/@backstage/plugin-kubernetes.md#01210))
...
### `@backstage/plugin-kubernetes-node` (0.3.2 → [0.3.3](../../changelogs/@backstage/plugin-kubernetes-node.md#033))
...
### `@backstage/plugin-notifications` (0.5.7 → [0.5.8](../../changelogs/@backstage/plugin-notifications.md#058))
...
### `@backstage/plugin-notifications-backend` (0.5.8 → [0.5.9](../../changelogs/@backstage/plugin-notifications-backend.md#059))
...
### `@backstage/plugin-org` (0.6.41 → [0.6.42](../../changelogs/@backstage/plugin-org.md#0642))
...
### `@backstage/plugin-proxy-backend` (0.6.4 → [0.6.5](../../changelogs/@backstage/plugin-proxy-backend.md#065))
...
### `@backstage/plugin-scaffolder-backend-module-github` (0.8.1 → [0.8.2](../../changelogs/@backstage/plugin-scaffolder-backend-module-github.md#082))
...
### `@backstage/plugin-scaffolder-backend-module-gitlab` (0.9.3 → [0.9.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitlab.md#094))
...
### `@backstage/plugin-scaffolder-node-test-utils` (0.3.1 → [0.3.2](../../changelogs/@backstage/plugin-scaffolder-node-test-utils.md#032))
...
### `@backstage/plugin-search-backend-module-explore` (0.3.4 → [0.3.5](../../changelogs/@backstage/plugin-search-backend-module-explore.md#035))
...
### `@backstage/repo-tools` (0.15.0 → [0.15.1](../../changelogs/@backstage/repo-tools.md#0151))
...
### `@backstage/theme` (0.6.7 → [0.6.8](../../changelogs/@backstage/theme.md#068))
...
- `@backstage/app-defaults` (1.6.4 → [1.6.5](../../changelogs/@backstage/app-defaults.md#165))
- `@backstage/backend-app-api` (1.2.5 → [1.2.6](../../changelogs/@backstage/backend-app-api.md#126))
- `@backstage/backend-dynamic-feature-service` (0.7.2 → [0.7.3](../../changelogs/@backstage/backend-dynamic-feature-service.md#073))
- `@backstage/backend-plugin-api` (1.4.1 → [1.4.2](../../changelogs/@backstage/backend-plugin-api.md#142))
- `@backstage/dev-utils` (1.1.12 → [1.1.13](../../changelogs/@backstage/dev-utils.md#1113))
- `@backstage/frontend-dynamic-feature-loader` (0.1.3 → [0.1.4](../../changelogs/@backstage/frontend-dynamic-feature-loader.md#014))
- `@backstage/plugin-app-backend` (0.5.4 → [0.5.5](../../changelogs/@backstage/plugin-app-backend.md#055))
- `@backstage/plugin-app-node` (0.1.35 → [0.1.36](../../changelogs/@backstage/plugin-app-node.md#0136))
- `@backstage/plugin-auth-backend` (0.25.2 → [0.25.3](../../changelogs/@backstage/plugin-auth-backend.md#0253))
- `@backstage/plugin-auth-backend-module-atlassian-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#046))
- `@backstage/plugin-auth-backend-module-auth0-provider` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-auth-backend-module-auth0-provider.md#026))
- `@backstage/plugin-auth-backend-module-aws-alb-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#046))
- `@backstage/plugin-auth-backend-module-azure-easyauth-provider` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-auth-backend-module-azure-easyauth-provider.md#0211))
- `@backstage/plugin-auth-backend-module-bitbucket-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-provider.md#036))
- `@backstage/plugin-auth-backend-module-bitbucket-server-provider` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-server-provider.md#026))
- `@backstage/plugin-auth-backend-module-cloudflare-access-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-cloudflare-access-provider.md#046))
- `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#046))
- `@backstage/plugin-auth-backend-module-github-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#036))
- `@backstage/plugin-auth-backend-module-gitlab-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#036))
- `@backstage/plugin-auth-backend-module-google-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#036))
- `@backstage/plugin-auth-backend-module-guest-provider` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-auth-backend-module-guest-provider.md#0211))
- `@backstage/plugin-auth-backend-module-microsoft-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-microsoft-provider.md#036))
- `@backstage/plugin-auth-backend-module-oauth2-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-provider.md#046))
- `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#0211))
- `@backstage/plugin-auth-backend-module-oidc-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-oidc-provider.md#046))
- `@backstage/plugin-auth-backend-module-onelogin-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-onelogin-provider.md#036))
- `@backstage/plugin-auth-backend-module-pinniped-provider` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#036))
- `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.5.5 → [0.5.6](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#056))
- `@backstage/plugin-auth-node` (0.6.5 → [0.6.6](../../changelogs/@backstage/plugin-auth-node.md#066))
- `@backstage/plugin-auth-react` (0.1.17 → [0.1.18](../../changelogs/@backstage/plugin-auth-react.md#0118))
- `@backstage/plugin-catalog-backend-module-aws` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#0414))
- `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.5.4 → [0.5.5](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#055))
- `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.5.1 → [0.5.2](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#052))
- `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.5.1 → [0.5.2](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#052))
- `@backstage/plugin-catalog-backend-module-gerrit` (0.3.4 → [0.3.5](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#035))
- `@backstage/plugin-catalog-backend-module-gitea` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-catalog-backend-module-gitea.md#013))
- `@backstage/plugin-catalog-backend-module-github-org` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#0313))
- `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.7.2 → [0.7.3](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#073))
- `@backstage/plugin-catalog-backend-module-ldap` (0.11.7 → [0.11.8](../../changelogs/@backstage/plugin-catalog-backend-module-ldap.md#0118))
- `@backstage/plugin-catalog-backend-module-logs` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-catalog-backend-module-logs.md#0113))
- `@backstage/plugin-catalog-backend-module-msgraph` (0.7.2 → [0.7.3](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph.md#073))
- `@backstage/plugin-catalog-backend-module-openapi` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#0213))
- `@backstage/plugin-catalog-backend-module-puppetdb` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#0213))
- `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#0211))
- `@backstage/plugin-catalog-backend-module-unprocessed` (0.6.2 → [0.6.3](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#063))
- `@backstage/plugin-config-schema` (0.1.70 → [0.1.71](../../changelogs/@backstage/plugin-config-schema.md#0171))
- `@backstage/plugin-devtools-backend` (0.5.7 → [0.5.8](../../changelogs/@backstage/plugin-devtools-backend.md#058))
- `@backstage/plugin-events-backend` (0.5.4 → [0.5.5](../../changelogs/@backstage/plugin-events-backend.md#055))
- `@backstage/plugin-events-backend-module-aws-sqs` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#0414))
- `@backstage/plugin-events-backend-module-azure` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-events-backend-module-azure.md#0223))
- `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#0223))
- `@backstage/plugin-events-backend-module-bitbucket-server` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-server.md#014))
- `@backstage/plugin-events-backend-module-gerrit` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#0223))
- `@backstage/plugin-events-backend-module-github` (0.4.2 → [0.4.3](../../changelogs/@backstage/plugin-events-backend-module-github.md#043))
- `@backstage/plugin-events-backend-module-gitlab` (0.3.3 → [0.3.4](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#034))
- `@backstage/plugin-events-backend-module-google-pubsub` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-events-backend-module-google-pubsub.md#013))
- `@backstage/plugin-events-backend-test-utils` (0.1.46 → [0.1.47](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0147))
- `@backstage/plugin-events-node` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-events-node.md#0414))
- `@backstage/plugin-gateway-backend` (1.0.3 → [1.0.4](../../changelogs/@backstage/plugin-gateway-backend.md#104))
- `@backstage/plugin-home-react` (0.1.28 → [0.1.29](../../changelogs/@backstage/plugin-home-react.md#0129))
- `@backstage/plugin-kubernetes-cluster` (0.0.27 → [0.0.28](../../changelogs/@backstage/plugin-kubernetes-cluster.md#0028))
- `@backstage/plugin-kubernetes-react` (0.5.9 → [0.5.10](../../changelogs/@backstage/plugin-kubernetes-react.md#0510))
- `@backstage/plugin-mcp-actions-backend` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-mcp-actions-backend.md#012))
- `@backstage/plugin-notifications-backend-module-email` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-notifications-backend-module-email.md#0312))
- `@backstage/plugin-notifications-backend-module-slack` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-notifications-backend-module-slack.md#014))
- `@backstage/plugin-notifications-node` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-notifications-node.md#0218))
- `@backstage/plugin-org-react` (0.1.40 → [0.1.41](../../changelogs/@backstage/plugin-org-react.md#0141))
- `@backstage/plugin-permission-backend` (0.7.2 → [0.7.3](../../changelogs/@backstage/plugin-permission-backend.md#073))
- `@backstage/plugin-permission-backend-module-allow-all-policy` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#0211))
- `@backstage/plugin-permission-node` (0.10.2 → [0.10.3](../../changelogs/@backstage/plugin-permission-node.md#0103))
- `@backstage/plugin-proxy-node` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-proxy-node.md#017))
- `@backstage/plugin-scaffolder-backend-module-azure` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-azure.md#0212))
- `@backstage/plugin-scaffolder-backend-module-bitbucket` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket.md#0313))
- `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-cloud.md#0212))
- `@backstage/plugin-scaffolder-backend-module-bitbucket-server` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-server.md#0212))
- `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-confluence-to-markdown.md#0312))
- `@backstage/plugin-scaffolder-backend-module-cookiecutter` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-scaffolder-backend-module-cookiecutter.md#0314))
- `@backstage/plugin-scaffolder-backend-module-gcp` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-gcp.md#0212))
- `@backstage/plugin-scaffolder-backend-module-gerrit` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-gerrit.md#0212))
- `@backstage/plugin-scaffolder-backend-module-gitea` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitea.md#0212))
- `@backstage/plugin-scaffolder-backend-module-notifications` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-scaffolder-backend-module-notifications.md#0113))
- `@backstage/plugin-scaffolder-backend-module-rails` (0.5.11 → [0.5.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-rails.md#0512))
- `@backstage/plugin-scaffolder-backend-module-sentry` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#0212))
- `@backstage/plugin-scaffolder-backend-module-yeoman` (0.4.12 → [0.4.13](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#0413))
- `@backstage/plugin-search-backend` (2.0.4 → [2.0.5](../../changelogs/@backstage/plugin-search-backend.md#205))
- `@backstage/plugin-search-backend-module-elasticsearch` (1.7.4 → [1.7.5](../../changelogs/@backstage/plugin-search-backend-module-elasticsearch.md#175))
- `@backstage/plugin-search-backend-module-pg` (0.5.46 → [0.5.47](../../changelogs/@backstage/plugin-search-backend-module-pg.md#0547))
- `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#0312))
- `@backstage/plugin-search-backend-module-techdocs` (0.4.4 → [0.4.5](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#045))
- `@backstage/plugin-search-backend-node` (1.3.13 → [1.3.14](../../changelogs/@backstage/plugin-search-backend-node.md#1314))
- `@backstage/plugin-signals-backend` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-signals-backend.md#037))
- `@backstage/plugin-signals-node` (0.1.22 → [0.1.23](../../changelogs/@backstage/plugin-signals-node.md#0123))
- `@backstage/plugin-techdocs-addons-test-utils` (1.0.51 → [1.0.52](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#1052))
- `@backstage/plugin-techdocs-module-addons-contrib` (1.1.26 → [1.1.27](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#1127))
- `@backstage/plugin-techdocs-node` (1.13.5 → [1.13.6](../../changelogs/@backstage/plugin-techdocs-node.md#1136))
- `@backstage/plugin-techdocs-react` (1.3.1 → [1.3.2](../../changelogs/@backstage/plugin-techdocs-react.md#132))
- `@backstage/plugin-user-settings-backend` (0.3.4 → [0.3.5](../../changelogs/@backstage/plugin-user-settings-backend.md#035))
- `@backstage/test-utils` (1.7.10 → [1.7.11](../../changelogs/@backstage/test-utils.md#1711))
- `@techdocs/cli` (1.9.5 → [1.9.6](../../changelogs/@techdocs/cli.md#196))
