# Backstage Release 1.27.6

## Compared to 1.27.5 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 169 unchanged.

### Version bumps

| Package | 1.27.5 | 1.27.6 |
| --- | --- | --- |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.16 | 0.3.17 |

## Compared to 1.26.5 (previous minor release)

0 major bumps, 3 added, 103 removed, 146 upgraded, 21 unchanged.
...
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.15 | 0.3.17 |
...
| `@backstage/plugin-scaffolder` | 1.19.3 | 1.20.1 |
...
| `@backstage/plugin-scaffolder-react` | 1.8.4 | 1.8.6 |
