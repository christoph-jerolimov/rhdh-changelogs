# Backstage Release 1.27.7

## Compared to 1.27.6 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 169 unchanged.

### Version bumps

| Package | 1.27.6 | 1.27.7 |
| --- | --- | --- |
...
| `@backstage/plugin-scaffolder-backend` | 1.22.5 | 1.22.8 |
