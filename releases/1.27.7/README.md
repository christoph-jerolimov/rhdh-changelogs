...
| Package | 1.27.6 | 1.27.7 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-scaffolder-backend` | 1.22.7 | 1.22.8 | Patch |
...
| Package | 1.27.0 | 1.27.7 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-app-api` | 0.7.3 | 0.7.5 | Patch |
| `@backstage/cli` | 0.26.5 | 0.26.6 | Patch |
| `@backstage/plugin-app-backend` | 0.3.66 | 0.3.67 | Patch |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.16 | 0.3.17 | Patch |
| `@backstage/plugin-scaffolder` | 1.20.0 | 1.20.1 | Patch |
| `@backstage/plugin-scaffolder-backend` | 1.22.6 | 1.22.8 | Patch |
...
3 added, 103 removed, 146 upgraded, 21 unchanged.

⚠️ Need extra attention: 5 0.x minor, 3 0.0.x patch.
...
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.15 | 0.3.17 | Patch |
...
| `@backstage/plugin-scaffolder-backend` | 1.22.5 | 1.22.8 | Patch |
