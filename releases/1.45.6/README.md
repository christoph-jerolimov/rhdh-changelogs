# Backstage Release 1.45.6

## Compared to 1.45.5 (previous patch release)

0 major bumps, 0 added, 0 removed, 2 upgraded, 188 unchanged.

### Version bumps

| Package | 1.45.5 | 1.45.6 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-app-visualizer` | 0.1.24 | 0.1.26 | Patch |
...
| `@backstage/ui` | 0.8.2 | 0.9.2 | Minor ⚠️ |
