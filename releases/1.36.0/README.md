...
| `@backstage/backend-defaults` | 0.7.0 | 0.8.0 | Minor ⚠️ |
...
| `@backstage/plugin-events-backend` | 0.4.1 | 0.4.2 | Patch |
...
| `@backstage/plugin-notifications-backend` | 0.5.1 | 0.5.2 | Patch |
