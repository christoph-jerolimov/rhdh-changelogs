...
| Package | 1.19.1 | 1.19.2 |
| --- | --- | --- |
| `@backstage/backend-app-api` | 0.5.6 | 0.5.7 |
| `@backstage/plugin-bazaar-backend` | 0.3.3 | 0.3.4 |
| `@backstage/plugin-kafka-backend` | 0.3.3 | 0.3.4 |
| `@backstage/plugin-periskop-backend` | 0.2.3 | 0.2.4 |
| `@backstage/plugin-proxy-backend` | 0.4.3 | 0.4.4 |
| `@backstage/plugin-scaffolder-backend` | 1.18.0 | 1.18.1 |
| `@backstage/plugin-scaffolder-node` | 0.2.6 | 0.2.7 |
| `@backstage/plugin-sonarqube` | 0.7.6 | 0.7.7 |
| `@backstage/plugin-todo` | 0.2.28 | 0.2.29 |
