...
1 added, 0 removed, 90 upgraded, 120 unchanged.
...
| Package | 1.54.6 | 1.55.0-next.0 | Type |
| --- | --- | --- | --- |
| `@backstage/app-defaults` | 1.7.11 | 1.7.12-next.0 | Patch |
| `@backstage/backend-defaults` | 0.17.8 | 0.17.7 | Patch |
...
| `@backstage/integration` | 2.1.1 | 2.1.0 | Patch |
...
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.4.20 | 0.4.20-next.0 | Patch |
| `@backstage/plugin-auth-react` | 0.1.30 | 0.1.31-next.0 | Patch |
| `@backstage/plugin-catalog` | 2.0.8 | 2.0.9-next.0 | Patch |
| `@backstage/plugin-catalog-backend` | 3.9.1 | 3.9.0 | Patch |
| `@backstage/plugin-catalog-backend-module-aws` | 0.4.27 | 0.4.27-next.0 | Patch |
| `@backstage/plugin-catalog-backend-module-azure` | 0.3.21 | 0.3.20 | Patch |
| `@backstage/plugin-catalog-backend-module-gcp` | 0.3.22 | 0.3.23-next.0 | Patch |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.8.7 | 0.8.7-next.0 | Patch |
...
| `@backstage/plugin-kubernetes-backend` | 0.21.10 | 0.21.10-next.0 | Patch |
...
| `@backstage/plugin-proxy-backend` | 0.6.17 | 0.6.16 | Patch |
| `@backstage/plugin-scaffolder` | 1.38.2 | 1.39.0-next.0 | Minor |
| `@backstage/plugin-scaffolder-backend` | 4.1.0 | 4.1.0-next.0 | Minor |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.2.25 | 0.2.25-next.0 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.3.10 | 0.3.10-next.0 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-server` | 0.2.25 | 0.2.25-next.0 | Patch |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.3.25 | 0.3.25-next.0 | Patch |
...
| `@backstage/plugin-scaffolder-backend-module-github` | 0.9.13 | 0.9.13-next.0 | Patch |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.11.10 | 0.11.10-next.0 | Patch |
...
| `@backstage/plugin-scaffolder-common` | 2.2.3 | 2.3.0-next.0 | Minor |
...
| `@backstage/plugin-techdocs-backend` | 2.2.4 | 2.2.3 | Patch |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.39 | 1.1.40-next.0 | Patch |
| `@backstage/plugin-techdocs-node` | 1.15.4 | 1.15.3 | Patch |
...
| `@techdocs/cli` | 1.11.4 | 1.11.4-next.0 | Patch |
