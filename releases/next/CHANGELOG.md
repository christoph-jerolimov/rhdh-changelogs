...
- [0.x patch version bumps](#0x-patch-version-bumps)
  ...
  - [`@backstage/frontend-dynamic-feature-loader` (0.1.14 → 0.1.15-next.0)](#backstagefrontend-dynamic-feature-loader-0114--0115-next0)
...
- [Minor version bumps](#minor-version-bumps)
  ...
  - [`@backstage/plugin-techdocs` (1.17.8 → 1.18.0-next.1)](#backstageplugin-techdocs-1178--1180-next1)
- [Other patch version bumps](#other-patch-version-bumps)
  ...
  - [`@backstage/plugin-scaffolder-backend` (4.0.2 → 4.0.3-next.1)](#backstageplugin-scaffolder-backend-402--403-next1)
...
### `@backstage/plugin-kubernetes-backend` (0.21.6 → [0.22.0-next.1](../../changelogs/@backstage/plugin-kubernetes-backend.md#0220-next1))
...
### `@backstage/create-app` (0.9.0 → [0.9.1-next.1](../../changelogs/@backstage/create-app.md#091-next1))
...
### `@backstage/frontend-dynamic-feature-loader` (0.1.14 → [0.1.15-next.0](../../changelogs/@backstage/frontend-dynamic-feature-loader.md#0115-next0))
...
### `@backstage/plugin-techdocs` (1.17.8 → [1.18.0-next.1](../../changelogs/@backstage/plugin-techdocs.md#1180-next1))
...
### `@backstage/plugin-catalog-backend` (3.8.1 → [3.8.2-next.1](../../changelogs/@backstage/plugin-catalog-backend.md#382-next1))
...
### `@backstage/plugin-catalog-react` (3.2.0 → [3.2.1-next.1](../../changelogs/@backstage/plugin-catalog-react.md#321-next1))
...
### `@backstage/plugin-scaffolder-backend` (4.0.2 → [4.0.3-next.1](../../changelogs/@backstage/plugin-scaffolder-backend.md#403-next1))
...
- `@backstage/dev-utils` (1.1.25 → [1.1.26-next.1](../../changelogs/@backstage/dev-utils.md#1126-next1))
...
- `@backstage/integration-react` (1.2.20 → [1.2.21-next.0](../../changelogs/@backstage/integration-react.md#1221-next0))
- `@backstage/plugin-api-docs` (0.14.3 → [0.14.4-next.0](../../changelogs/@backstage/plugin-api-docs.md#0144-next0))
- `@backstage/plugin-app` (0.5.1 → [0.5.2-next.1](../../changelogs/@backstage/plugin-app.md#052-next1))
...
- `@backstage/plugin-catalog-import` (0.13.15 → [0.13.16-next.1](../../changelogs/@backstage/plugin-catalog-import.md#01316-next1))
...
- `@backstage/plugin-scaffolder` (1.38.1 → [1.38.2-next.1](../../changelogs/@backstage/plugin-scaffolder.md#1382-next1))
...
- `@backstage/plugin-scaffolder-node` (0.13.5 → [0.13.6-next.1](../../changelogs/@backstage/plugin-scaffolder-node.md#0136-next1))
...
- `@backstage/plugin-scaffolder-react` (2.0.2 → [2.0.3-next.1](../../changelogs/@backstage/plugin-scaffolder-react.md#203-next1))
...
- `@backstage/plugin-techdocs-addons-test-utils` (2.0.7 → [2.0.8-next.1](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#208-next1))
- `@backstage/plugin-techdocs-backend` (2.2.2 → [2.2.3-next.1](../../changelogs/@backstage/plugin-techdocs-backend.md#223-next1))
- `@backstage/plugin-techdocs-module-addons-contrib` (1.1.38 → [1.1.39-next.1](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#1139-next1))
