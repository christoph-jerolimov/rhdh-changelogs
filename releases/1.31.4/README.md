...
| Package | 1.31.3 | 1.31.4 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-dynamic-feature-service` | 0.4.1 | 0.4.2 | Patch |
...
3 major bumps, 4 added, 1 removed, 158 upgraded, 16 unchanged.
...
| `@backstage/backend-dynamic-feature-service` | 0.3.2 | 0.4.2 | Minor ⚠️ |
...
| `@backstage/plugin-app-backend` | 0.3.73 | 0.3.75 | Patch |
...
| `@backstage/plugin-scaffolder-backend` | 1.24.1 | 1.25.1 | Minor |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.1.16 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.2.14 | 0.3.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.1.14 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-server` | 0.1.14 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.25 | 0.3.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.48 | 0.3.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-gcp` | 0.1.2 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-gerrit` | 0.1.16 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-gitea` | 0.1.14 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-github` | 0.4.2 | 0.5.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.4.6 | 0.5.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-notifications` | 0.0.7 | 0.1.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.41 | 0.5.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.32 | 0.2.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.3.8 | 0.4.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-common` | 1.5.5 | 1.5.6 | Patch |
| `@backstage/plugin-scaffolder-node` | 0.4.10 | 0.4.12 | Patch |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.11 | 0.1.13 | Patch |
