# Backstage Release 1.31.4

## Compared to 1.31.3 (previous patch release)

0 major bumps, 0 added, 0 removed, 19 upgraded, 159 unchanged.

### Version bumps

| Package | 1.31.3 | 1.31.4 |
| --- | --- | --- |
...
| `@backstage/backend-dynamic-feature-service` | 0.3.2 | 0.4.2 |
...
| `@backstage/plugin-scaffolder-backend` | 1.24.1 | 1.25.1 |
...
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.25 | 0.3.1 |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.48 | 0.3.1 |
| `@backstage/plugin-scaffolder-backend-module-gcp` | 0.1.2 | 0.2.1 |
...
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.4.6 | 0.5.1 |
| `@backstage/plugin-scaffolder-backend-module-notifications` | 0.0.7 | 0.1.1 |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.41 | 0.5.1 |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.32 | 0.2.1 |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.3.8 | 0.4.1 |
| `@backstage/plugin-scaffolder-common` | 1.5.5 | 1.5.6 |
| `@backstage/plugin-scaffolder-node` | 0.4.10 | 0.4.12 |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.11 | 0.1.13 |
