...
0 major bumps, 0 added, 0 removed, 26 upgraded, 152 unchanged.

### Version bumps

| Package | 1.31.1 | 1.31.2 |
| --- | --- | --- |
| `@backstage/backend-dynamic-feature-service` | 0.4.0 | 0.4.1 |
| `@backstage/dev-utils` | 1.1.0 | 1.1.1 |
| `@backstage/integration-react` | 1.1.31 | 1.1.32 |
| `@backstage/plugin-api-docs` | 0.11.9 | 0.11.10 |
| `@backstage/plugin-catalog` | 1.23.0 | 1.23.1 |
| `@backstage/plugin-catalog-backend` | 1.26.0 | 1.26.1 |
| `@backstage/plugin-catalog-backend-module-github` | 0.7.3 | 0.7.4 |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.3.0 | 0.3.1 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.5.3 | 0.5.4 |
| `@backstage/plugin-catalog-backend-module-logs` | 0.1.0 | 0.1.1 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.2.0 | 0.2.1 |
| `@backstage/plugin-catalog-graph` | 0.4.9 | 0.4.10 |
| `@backstage/plugin-catalog-import` | 0.12.3 | 0.12.4 |
| `@backstage/plugin-catalog-react` | 1.13.0 | 1.13.1 |
| `@backstage/plugin-home` | 0.7.10 | 0.7.11 |
| `@backstage/plugin-kubernetes` | 0.11.14 | 0.11.15 |
| `@backstage/plugin-kubernetes-cluster` | 0.0.15 | 0.0.16 |
| `@backstage/plugin-org` | 0.6.29 | 0.6.30 |
| `@backstage/plugin-org-react` | 0.1.28 | 0.1.29 |
| `@backstage/plugin-scaffolder` | 1.25.0 | 1.25.1 |
| `@backstage/plugin-scaffolder-react` | 1.12.0 | 1.12.1 |
| `@backstage/plugin-search` | 1.4.16 | 1.4.17 |
| `@backstage/plugin-techdocs` | 1.10.9 | 1.10.10 |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.38 | 1.0.39 |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.14 | 1.1.15 |
| `@backstage/plugin-user-settings` | 0.8.12 | 0.8.13 |

## Compared to 1.30.4 (previous minor release)

3 major bumps, 4 added, 1 removed, 155 upgraded, 16 unchanged.
...
| `@backstage/backend-dynamic-feature-service` | 0.3.2 | 0.4.1 |
...
| `@backstage/create-app` | 0.5.18 | 0.5.20 |
| `@backstage/dev-utils` | 1.0.37 | 1.1.1 |
...
| `@backstage/plugin-api-docs` | 0.11.8 | 0.11.10 |
...
| `@backstage/plugin-catalog` | 1.22.0 | 1.23.1 |
| `@backstage/plugin-catalog-backend` | 1.25.2 | 1.26.1 |
...
| `@backstage/plugin-catalog-backend-module-github` | 0.7.2 | 0.7.4 |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.2.2 | 0.3.1 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.4.1 | 0.4.2 |
| `@backstage/plugin-catalog-backend-module-gitlab-org` | 0.1.1 | 0.2.0 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.5.2 | 0.5.4 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.8.1 | 0.9.0 |
| `@backstage/plugin-catalog-backend-module-logs` | 0.0.4 | 0.1.1 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.6.1 | 0.6.2 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.43 | 0.2.1 |
...
| `@backstage/plugin-catalog-graph` | 0.4.8 | 0.4.10 |
| `@backstage/plugin-catalog-import` | 0.12.2 | 0.12.4 |
...
| `@backstage/plugin-home` | 0.7.9 | 0.7.11 |
| `@backstage/plugin-home-react` | 0.1.16 | 0.1.17 |
| `@backstage/plugin-kubernetes` | 0.11.13 | 0.11.15 |
| `@backstage/plugin-kubernetes-backend` | 0.18.5 | 0.18.6 |
| `@backstage/plugin-kubernetes-cluster` | 0.0.14 | 0.0.16 |
...
| `@backstage/plugin-org` | 0.6.28 | 0.6.30 |
| `@backstage/plugin-org-react` | 0.1.27 | 0.1.29 |
...
| `@backstage/plugin-scaffolder` | 1.24.0 | 1.25.1 |
...
| `@backstage/plugin-scaffolder-react` | 1.11.0 | 1.12.1 |
| `@backstage/plugin-search` | 1.4.15 | 1.4.17 |
...
| `@backstage/plugin-techdocs` | 1.10.8 | 1.10.10 |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.37 | 1.0.39 |
| `@backstage/plugin-techdocs-backend` | 1.10.12 | 1.10.13 |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.13 | 1.1.15 |
| `@backstage/plugin-techdocs-node` | 1.12.10 | 1.12.11 |
| `@backstage/plugin-techdocs-react` | 1.2.7 | 1.2.8 |
| `@backstage/plugin-user-settings` | 0.8.11 | 0.8.13 |
