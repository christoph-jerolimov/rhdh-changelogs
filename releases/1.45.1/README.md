# Backstage Release 1.45.1

## Compared to 1.45.0 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 189 unchanged.

### Version bumps

| Package | 1.45.0 | 1.45.1 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-scaffolder-backend` | 3.0.0 | 3.0.1 | Patch |
...
| `@backstage/ui` | 0.8.2 | 0.9.0 | Minor ⚠️ |
