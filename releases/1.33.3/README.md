# Backstage Release 1.33.3

## Compared to 1.33.2 (previous patch release)

0 added, 0 removed, 48 upgraded (⚠️ need extra attention: 2 0.0.x patch), 129 unchanged.
...
| `@backstage/cli` | 0.29.1 | 0.29.2 | Patch |
