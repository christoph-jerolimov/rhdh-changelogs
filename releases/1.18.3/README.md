...
| Package | 1.17.5 | 1.18.3 |
| --- | --- | --- |
| `@backstage/app-defaults` | 1.4.2 | 1.4.3 |
| `@backstage/backend-app-api` | 0.5.2 | 0.5.4 |
| `@backstage/backend-common` | 0.19.4 | 0.19.6 |
| `@backstage/backend-defaults` | 0.2.2 | 0.2.4 |
| `@backstage/backend-openapi-utils` | 0.0.3 | 0.0.4 |
| `@backstage/backend-plugin-api` | 0.6.2 | 0.6.4 |
| `@backstage/backend-tasks` | 0.5.7 | 0.5.9 |
| `@backstage/backend-test-utils` | 0.2.2 | 0.2.5 |
...
| `@backstage/plugin-adr-backend` | 0.3.8 | 0.4.1 |
| `@backstage/plugin-adr-common` | 0.2.14 | 0.2.15 |
| `@backstage/plugin-airbrake` | 0.3.23 | 0.3.24 |
| `@backstage/plugin-airbrake-backend` | 0.2.23 | 0.3.1 |
...
| `@backstage/plugin-app-backend` | 0.3.50 | 0.3.52 |
| `@backstage/plugin-app-node` | 0.1.2 | 0.1.4 |
| `@backstage/plugin-auth-backend` | 0.18.8 | 0.19.1 |
| `@backstage/plugin-auth-node` | 0.2.19 | 0.3.1 |
| `@backstage/plugin-azure-devops` | 0.3.5 | 0.3.6 |
| `@backstage/plugin-azure-devops-backend` | 0.3.29 | 0.4.1 |
| `@backstage/plugin-azure-devops-common` | 0.3.0 | 0.3.1 |
| `@backstage/plugin-azure-sites` | 0.1.12 | 0.1.13 |
| `@backstage/plugin-azure-sites-backend` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-azure-sites-common` | 0.1.0 | 0.1.1 |
| `@backstage/plugin-badges` | 0.2.47 | 0.2.48 |
| `@backstage/plugin-badges-backend` | 0.2.5 | 0.3.1 |
| `@backstage/plugin-bazaar` | 0.2.15 | 0.2.16 |
| `@backstage/plugin-bazaar-backend` | 0.2.13 | 0.3.1 |
...
| `@backstage/plugin-catalog-backend` | 1.12.4 | 1.13.2 |
| `@backstage/plugin-catalog-backend-module-aws` | 0.2.5 | 0.2.7 |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.21 | 0.1.23 |
| `@backstage/plugin-catalog-backend-module-bitbucket` | 0.2.17 | 0.2.19 |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.1.17 | 0.1.19 |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.15 | 0.1.17 |
| `@backstage/plugin-catalog-backend-module-gcp` | 0.1.2 | 0.1.4 |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.18 | 0.1.20 |
| `@backstage/plugin-catalog-backend-module-github` | 0.3.7 | 0.4.2 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.2.6 | 0.3.1 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.5 | 0.4.8 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.17 | 0.5.19 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.9 | 0.5.11 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.18 | 0.1.21 |
| `@backstage/plugin-catalog-backend-module-puppetdb` | 0.1.7 | 0.1.9 |
| `@backstage/plugin-catalog-backend-module-unprocessed` | 0.2.2 | 0.3.1 |
...
| `@backstage/plugin-catalog-node` | 1.4.3 | 1.4.5 |
...
| `@backstage/plugin-code-coverage-backend` | 0.2.16 | 0.2.18 |
...
| `@backstage/plugin-devtools-backend` | 0.1.5 | 0.2.1 |
...
| `@backstage/plugin-entity-feedback-backend` | 0.1.8 | 0.2.1 |
| `@backstage/plugin-entity-feedback-common` | 0.1.2 | 0.1.3 |
| `@backstage/plugin-entity-validation` | 0.1.8 | 0.1.9 |
| `@backstage/plugin-events-backend` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.2.5 | 0.2.7 |
| `@backstage/plugin-events-backend-module-azure` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-events-backend-module-gerrit` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-events-backend-module-github` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-events-backend-module-gitlab` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-events-backend-test-utils` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-events-node` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-explore` | 0.4.9 | 0.4.10 |
| `@backstage/plugin-explore-backend` | 0.0.12 | 0.0.14 |
...
| `@backstage/plugin-graphql-backend` | 0.1.40 | 0.1.42 |
...
| `@backstage/plugin-nomad-backend` | 0.1.4 | 0.1.6 |
...
| `@backstage/plugin-periskop-backend` | 0.1.21 | 0.2.1 |
| `@backstage/plugin-permission-backend` | 0.5.25 | 0.5.27 |
| `@backstage/plugin-permission-common` | 0.7.7 | 0.7.8 |
| `@backstage/plugin-permission-node` | 0.7.13 | 0.7.15 |
| `@backstage/plugin-permission-react` | 0.4.14 | 0.4.15 |
| `@backstage/plugin-playlist` | 0.1.15 | 0.1.16 |
| `@backstage/plugin-playlist-backend` | 0.3.6 | 0.3.8 |
| `@backstage/plugin-playlist-common` | 0.1.9 | 0.1.10 |
| `@backstage/plugin-proxy-backend` | 0.3.2 | 0.4.1 |
| `@backstage/plugin-puppetdb` | 0.1.6 | 0.1.7 |
| `@backstage/plugin-rollbar` | 0.4.23 | 0.4.24 |
| `@backstage/plugin-rollbar-backend` | 0.1.47 | 0.1.49 |
| `@backstage/plugin-scaffolder` | 1.14.4 | 1.15.0 |
| `@backstage/plugin-scaffolder-backend` | 1.16.5 | 1.17.2 |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.26 | 0.2.28 |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.2.5 | 0.2.7 |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.19 | 0.4.21 |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.10 | 0.1.12 |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.2.23 | 0.2.25 |
| `@backstage/plugin-scaffolder-common` | 1.4.0 | 1.4.1 |
| `@backstage/plugin-scaffolder-node` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-scaffolder-react` | 1.5.4 | 1.5.5 |
| `@backstage/plugin-search` | 1.3.6 | 1.4.0 |
| `@backstage/plugin-search-backend` | 1.4.2 | 1.4.4 |
| `@backstage/plugin-search-backend-module-catalog` | 0.1.6 | 0.1.8 |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.3.5 | 1.3.7 |
| `@backstage/plugin-search-backend-module-explore` | 0.1.6 | 0.1.8 |
| `@backstage/plugin-search-backend-module-pg` | 0.5.11 | 0.5.13 |
| `@backstage/plugin-search-backend-module-techdocs` | 0.1.6 | 0.1.8 |
| `@backstage/plugin-search-backend-node` | 1.2.6 | 1.2.8 |
...
| `@backstage/plugin-sonarqube-backend` | 0.2.4 | 0.2.6 |
...
| `@backstage/plugin-stack-overflow-backend` | 0.2.6 | 0.2.8 |
| `@backstage/plugin-stackstorm` | 0.1.5 | 0.1.6 |
| `@backstage/plugin-tech-insights` | 0.3.15 | 0.3.16 |
| `@backstage/plugin-tech-insights-backend` | 0.5.16 | 0.5.18 |
| `@backstage/plugin-tech-insights-backend-module-jsonfc` | 0.1.34 | 0.1.36 |
| `@backstage/plugin-tech-insights-common` | 0.2.11 | 0.2.12 |
| `@backstage/plugin-tech-insights-node` | 0.4.8 | 0.4.10 |
...
| `@backstage/plugin-techdocs-backend` | 1.6.7 | 1.7.1 |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.0.18 | 1.1.0 |
| `@backstage/plugin-techdocs-node` | 1.7.6 | 1.8.1 |
| `@backstage/plugin-techdocs-react` | 1.1.9 | 1.1.11 |
| `@backstage/plugin-todo` | 0.2.25 | 0.2.27 |
| `@backstage/plugin-todo-backend` | 0.2.2 | 0.3.2 |
| `@backstage/plugin-user-settings` | 0.7.8 | 0.7.10 |
| `@backstage/plugin-user-settings-backend` | 0.1.14 | 0.2.2 |
| `@backstage/plugin-vault` | 0.1.17 | 0.1.19 |
| `@backstage/plugin-vault-backend` | 0.3.6 | 0.3.9 |
