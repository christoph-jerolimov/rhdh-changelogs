# Backstage Release 1.33.5

## Compared to 1.33.4 (previous patch release)

0 major bumps, 0 added, 0 removed, 19 upgraded, 158 unchanged.

### Version bumps

| Package | 1.33.4 | 1.33.5 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-dynamic-feature-service` | 0.5.0 | 0.5.1 | Patch |
| `@backstage/plugin-scaffolder-backend` | 1.27.1 | 1.27.2 | Patch |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.2.2 | 0.2.3 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.3.3 | 0.3.4 | Patch |
...
0 major bumps, 0 added, 0 removed, 169 upgraded, 8 unchanged.

### Version bumps

| Package | 1.32.6 | 1.33.5 | Type |
| --- | --- | --- | --- |
...
| `@backstage/backend-dynamic-feature-service` | 0.4.4 | 0.5.1 | Minor ⚠️ |
...
| `@backstage/plugin-scaffolder-backend` | 1.26.3 | 1.27.2 | Minor |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.2.2 | 0.2.3 | Patch |
...
| `@backstage/plugin-scaffolder-node` | 0.5.1 | 0.6.1 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.15 | 0.1.16 | Patch |
