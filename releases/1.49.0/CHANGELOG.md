...
### `@backstage/cli-module-new` (new, [0.1.0](../../changelogs/@backstage/cli-module-new.md#010))
...
### `@backstage/backend-defaults` (0.15.2 → [0.16.0](../../changelogs/@backstage/backend-defaults.md#0160))
...
### `@backstage/cli` (0.35.4 → [0.36.0](../../changelogs/@backstage/cli.md#0360))
...
### `@backstage/create-app` (0.7.9 → [0.8.0](../../changelogs/@backstage/create-app.md#080))
...
### `@backstage/frontend-app-api` (0.15.0 → [0.16.0](../../changelogs/@backstage/frontend-app-api.md#0160))
...
### `@backstage/frontend-defaults` (0.4.0 → [0.5.0](../../changelogs/@backstage/frontend-defaults.md#050))
...
### `@backstage/frontend-plugin-api` (0.14.1 → [0.15.0](../../changelogs/@backstage/frontend-plugin-api.md#0150))
...
### `@backstage/integration` (1.20.1 → [2.0.0](../../changelogs/@backstage/integration.md#200))
...
### `@backstage/plugin-catalog` (1.33.1 → [2.0.0](../../changelogs/@backstage/plugin-catalog.md#200))
...
### `@backstage/plugin-catalog-backend` (3.4.0 → [3.5.0](../../changelogs/@backstage/plugin-catalog-backend.md#350))
...
### `@backstage/plugin-catalog-graph` (0.5.7 → [0.6.0](../../changelogs/@backstage/plugin-catalog-graph.md#060))
...
### `@backstage/plugin-notifications-backend-module-slack` (0.3.1 → [0.4.0](../../changelogs/@backstage/plugin-notifications-backend-module-slack.md#040))
...
### `@backstage/plugin-org` (0.6.49 → [0.7.0](../../changelogs/@backstage/plugin-org.md#070))
...
### `@backstage/plugin-scaffolder-common` (1.7.6 → [2.0.0](../../changelogs/@backstage/plugin-scaffolder-common.md#200))
...
### `@backstage/plugin-scaffolder-node` (0.12.5 → [0.13.0](../../changelogs/@backstage/plugin-scaffolder-node.md#0130))
...
### `@backstage/ui` (0.12.1 → [0.13.0](../../changelogs/@backstage/ui.md#0130))
...
### `@backstage/backend-dynamic-feature-service` (0.7.9 → [0.8.0](../../changelogs/@backstage/backend-dynamic-feature-service.md#080))
...
### `@backstage/cli-common` (0.1.18 → [0.2.0](../../changelogs/@backstage/cli-common.md#020))
...
### `@backstage/cli-node` (0.2.18 → [0.3.0](../../changelogs/@backstage/cli-node.md#030))
...
### `@backstage/plugin-catalog-backend-module-github` (0.12.2 → [0.13.0](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#0130))
...
### `@backstage/plugin-devtools-react` (0.1.1 → [0.2.0](../../changelogs/@backstage/plugin-devtools-react.md#020))
...
### `@backstage/plugin-events-backend` (0.5.11 → [0.6.0](../../changelogs/@backstage/plugin-events-backend.md#060))
...
### `@backstage/repo-tools` (0.16.5 → [0.17.0](../../changelogs/@backstage/repo-tools.md#0170))
...
### `@backstage/plugin-kubernetes-cluster` (0.0.34 → [0.0.35](../../changelogs/@backstage/plugin-kubernetes-cluster.md#0035))
...
### `@backstage/core-components` (0.18.7 → [0.18.8](../../changelogs/@backstage/core-components.md#0188))
...
### `@backstage/filter-predicates` (0.1.0 → [0.1.1](../../changelogs/@backstage/filter-predicates.md#011))
...
### `@backstage/frontend-dynamic-feature-loader` (0.1.9 → [0.1.10](../../changelogs/@backstage/frontend-dynamic-feature-loader.md#0110))
...
### `@backstage/frontend-test-utils` (0.5.0 → [0.5.1](../../changelogs/@backstage/frontend-test-utils.md#051))
...
### `@backstage/module-federation-common` (0.1.1 → [0.1.2](../../changelogs/@backstage/module-federation-common.md#012))
...
### `@backstage/plugin-api-docs` (0.13.4 → [0.13.5](../../changelogs/@backstage/plugin-api-docs.md#0135))
...
### `@backstage/plugin-app` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-app.md#041))
...
### `@backstage/plugin-app-react` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-app-react.md#021))
...
### `@backstage/plugin-app-visualizer` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-app-visualizer.md#021))
...
### `@backstage/plugin-auth` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-auth.md#016))
...
### `@backstage/plugin-auth-backend` (0.27.1 → [0.27.2](../../changelogs/@backstage/plugin-auth-backend.md#0272))
...
### `@backstage/plugin-auth-backend-module-atlassian-provider` (0.4.12 → [0.4.13](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#0413))
...
### `@backstage/plugin-auth-backend-module-aws-alb-provider` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#0414))
...
### `@backstage/plugin-auth-backend-module-azure-easyauth-provider` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-auth-backend-module-azure-easyauth-provider.md#0218))
...
### `@backstage/plugin-auth-backend-module-bitbucket-provider` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-provider.md#0313))
...
### `@backstage/plugin-auth-backend-module-bitbucket-server-provider` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-server-provider.md#0213))
...
### `@backstage/plugin-auth-backend-module-cloudflare-access-provider` (0.4.12 → [0.4.13](../../changelogs/@backstage/plugin-auth-backend-module-cloudflare-access-provider.md#0413))
...
### `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.4.12 → [0.4.13](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#0413))
...
### `@backstage/plugin-auth-backend-module-github-provider` (0.5.0 → [0.5.1](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#051))
...
### `@backstage/plugin-auth-backend-module-gitlab-provider` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#041))
...
### `@backstage/plugin-auth-backend-module-google-provider` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#0313))
...
### `@backstage/plugin-auth-backend-module-microsoft-provider` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-auth-backend-module-microsoft-provider.md#0313))
...
### `@backstage/plugin-auth-backend-module-oauth2-provider` (0.4.12 → [0.4.13](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-provider.md#0413))
...
### `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#0218))
...
### `@backstage/plugin-auth-backend-module-oidc-provider` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-auth-backend-module-oidc-provider.md#0414))
...
### `@backstage/plugin-auth-backend-module-okta-provider` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-auth-backend-module-okta-provider.md#0213))
...
### `@backstage/plugin-auth-backend-module-onelogin-provider` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-auth-backend-module-onelogin-provider.md#0313))
...
### `@backstage/plugin-auth-backend-module-openshift-provider` (0.1.4 → [0.1.5](../../changelogs/@backstage/plugin-auth-backend-module-openshift-provider.md#015))
...
### `@backstage/plugin-auth-node` (0.6.13 → [0.6.14](../../changelogs/@backstage/plugin-auth-node.md#0614))
...
### `@backstage/plugin-catalog-backend-module-github-org` (0.3.19 → [0.3.20](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#0320))
...
### `@backstage/plugin-catalog-backend-module-gitlab` (0.8.0 → [0.8.1](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#081))
...
### `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.7.9 → [0.7.10](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#0710))
...
### `@backstage/plugin-catalog-backend-module-msgraph` (0.9.0 → [0.9.1](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph.md#091))
...
### `@backstage/plugin-catalog-import` (0.13.10 → [0.13.11](../../changelogs/@backstage/plugin-catalog-import.md#01311))
...
### `@backstage/plugin-catalog-unprocessed-entities` (0.2.26 → [0.2.27](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#0227))
...
### `@backstage/plugin-devtools` (0.1.36 → [0.1.37](../../changelogs/@backstage/plugin-devtools.md#0137))
...
### `@backstage/plugin-devtools-common` (0.1.22 → [0.1.23](../../changelogs/@backstage/plugin-devtools-common.md#0123))
...
### `@backstage/plugin-home` (0.9.2 → [0.9.3](../../changelogs/@backstage/plugin-home.md#093))
...
### `@backstage/plugin-home-react` (0.1.35 → [0.1.36](../../changelogs/@backstage/plugin-home-react.md#0136))
...
### `@backstage/plugin-kubernetes` (0.12.16 → [0.12.17](../../changelogs/@backstage/plugin-kubernetes.md#01217))
...
### `@backstage/plugin-kubernetes-backend` (0.21.1 → [0.21.2](../../changelogs/@backstage/plugin-kubernetes-backend.md#0212))
...
### `@backstage/plugin-kubernetes-react` (0.5.16 → [0.5.17](../../changelogs/@backstage/plugin-kubernetes-react.md#0517))
...
### `@backstage/plugin-mcp-actions-backend` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-mcp-actions-backend.md#0110))
...
### `@backstage/plugin-mui-to-bui` (0.2.4 → [0.2.5](../../changelogs/@backstage/plugin-mui-to-bui.md#025))
...
### `@backstage/plugin-notifications` (0.5.14 → [0.5.15](../../changelogs/@backstage/plugin-notifications.md#0515))
...
### `@backstage/plugin-permission-backend` (0.7.9 → [0.7.10](../../changelogs/@backstage/plugin-permission-backend.md#0710))
...
### `@backstage/plugin-permission-common` (0.9.6 → [0.9.7](../../changelogs/@backstage/plugin-permission-common.md#097))
...
### `@backstage/plugin-permission-node` (0.10.10 → [0.10.11](../../changelogs/@backstage/plugin-permission-node.md#01011))
...
### `@backstage/plugin-permission-react` (0.4.40 → [0.4.41](../../changelogs/@backstage/plugin-permission-react.md#0441))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (0.3.3 → [0.3.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-cloud.md#034))
...
### `@backstage/plugin-scaffolder-backend-module-github` (0.9.6 → [0.9.7](../../changelogs/@backstage/plugin-scaffolder-backend-module-github.md#097))
...
### `@backstage/plugin-scaffolder-backend-module-gitlab` (0.11.3 → [0.11.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitlab.md#0114))
...
### `@backstage/plugin-techdocs-backend` (2.1.5 → [2.1.6](../../changelogs/@backstage/plugin-techdocs-backend.md#216))
...
### `@backstage/plugin-techdocs-module-addons-contrib` (1.1.33 → [1.1.34](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#1134))
...
### `@backstage/plugin-techdocs-node` (1.14.3 → [1.14.4](../../changelogs/@backstage/plugin-techdocs-node.md#1144))
...
- `@backstage/app-defaults` (1.7.5 → [1.7.6](../../changelogs/@backstage/app-defaults.md#176))
- `@backstage/backend-openapi-utils` (0.6.6 → [0.6.7](../../changelogs/@backstage/backend-openapi-utils.md#067))
- `@backstage/dev-utils` (1.1.20 → [1.1.21](../../changelogs/@backstage/dev-utils.md#1121))
- `@backstage/integration-react` (1.2.15 → [1.2.16](../../changelogs/@backstage/integration-react.md#1216))
- `@backstage/plugin-app-backend` (0.5.11 → [0.5.12](../../changelogs/@backstage/plugin-app-backend.md#0512))
- `@backstage/plugin-app-node` (0.1.42 → [0.1.43](../../changelogs/@backstage/plugin-app-node.md#0143))
- `@backstage/plugin-auth-backend-module-auth0-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-auth0-provider.md#031))
- `@backstage/plugin-auth-backend-module-guest-provider` (0.2.16 → [0.2.17](../../changelogs/@backstage/plugin-auth-backend-module-guest-provider.md#0217))
- `@backstage/plugin-auth-backend-module-pinniped-provider` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#0312))
- `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.5.11 → [0.5.12](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#0512))
- `@backstage/plugin-auth-react` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-auth-react.md#0125))
- `@backstage/plugin-bitbucket-cloud-common` (0.3.7 → [0.3.8](../../changelogs/@backstage/plugin-bitbucket-cloud-common.md#038))
- `@backstage/plugin-catalog-backend-module-aws` (0.4.20 → [0.4.21](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#0421))
- `@backstage/plugin-catalog-backend-module-azure` (0.3.14 → [0.3.15](../../changelogs/@backstage/plugin-catalog-backend-module-azure.md#0315))
- `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.5.11 → [0.5.12](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#0512))
- `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.5.8 → [0.5.9](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#059))
- `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.5.8 → [0.5.9](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#059))
- `@backstage/plugin-catalog-backend-module-gcp` (0.3.16 → [0.3.17](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#0317))
- `@backstage/plugin-catalog-backend-module-gerrit` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#0312))
- `@backstage/plugin-catalog-backend-module-gitea` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-catalog-backend-module-gitea.md#0110))
- `@backstage/plugin-catalog-backend-module-gitlab-org` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab-org.md#0219))
- `@backstage/plugin-catalog-backend-module-ldap` (0.12.2 → [0.12.3](../../changelogs/@backstage/plugin-catalog-backend-module-ldap.md#0123))
- `@backstage/plugin-catalog-backend-module-logs` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-catalog-backend-module-logs.md#0120))
- `@backstage/plugin-catalog-backend-module-openapi` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#0220))
- `@backstage/plugin-catalog-backend-module-puppetdb` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#0220))
- `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#0218))
- `@backstage/plugin-catalog-backend-module-unprocessed` (0.6.8 → [0.6.9](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#069))
- `@backstage/plugin-config-schema` (0.1.77 → [0.1.78](../../changelogs/@backstage/plugin-config-schema.md#0178))
- `@backstage/plugin-devtools-backend` (0.5.14 → [0.5.15](../../changelogs/@backstage/plugin-devtools-backend.md#0515))
- `@backstage/plugin-events-backend-module-aws-sqs` (0.4.19 → [0.4.20](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#0420))
- `@backstage/plugin-events-backend-module-azure` (0.2.28 → [0.2.29](../../changelogs/@backstage/plugin-events-backend-module-azure.md#0229))
- `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.2.28 → [0.2.29](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#0229))
- `@backstage/plugin-events-backend-module-bitbucket-server` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-server.md#0110))
- `@backstage/plugin-events-backend-module-gerrit` (0.2.28 → [0.2.29](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#0229))
- `@backstage/plugin-events-backend-module-github` (0.4.9 → [0.4.10](../../changelogs/@backstage/plugin-events-backend-module-github.md#0410))
- `@backstage/plugin-events-backend-module-gitlab` (0.3.9 → [0.3.10](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#0310))
- `@backstage/plugin-events-backend-module-google-pubsub` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-events-backend-module-google-pubsub.md#021))
- `@backstage/plugin-events-backend-module-kafka` (0.3.1 → [0.3.2](../../changelogs/@backstage/plugin-events-backend-module-kafka.md#032))
- `@backstage/plugin-events-backend-test-utils` (0.1.52 → [0.1.53](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0153))
- `@backstage/plugin-events-node` (0.4.19 → [0.4.20](../../changelogs/@backstage/plugin-events-node.md#0420))
- `@backstage/plugin-gateway-backend` (1.1.2 → [1.1.3](../../changelogs/@backstage/plugin-gateway-backend.md#113))
- `@backstage/plugin-kubernetes-node` (0.4.1 → [0.4.2](../../changelogs/@backstage/plugin-kubernetes-node.md#042))
- `@backstage/plugin-notifications-backend` (0.6.2 → [0.6.3](../../changelogs/@backstage/plugin-notifications-backend.md#063))
- `@backstage/plugin-notifications-backend-module-email` (0.3.18 → [0.3.19](../../changelogs/@backstage/plugin-notifications-backend-module-email.md#0319))
- `@backstage/plugin-notifications-node` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-notifications-node.md#0224))
- `@backstage/plugin-org-react` (0.1.47 → [0.1.48](../../changelogs/@backstage/plugin-org-react.md#0148))
- `@backstage/plugin-permission-backend-module-allow-all-policy` (0.2.16 → [0.2.17](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#0217))
- `@backstage/plugin-proxy-backend` (0.6.10 → [0.6.11](../../changelogs/@backstage/plugin-proxy-backend.md#0611))
- `@backstage/plugin-proxy-node` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-proxy-node.md#0113))
- `@backstage/plugin-scaffolder-backend-module-azure` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-azure.md#0219))
- `@backstage/plugin-scaffolder-backend-module-bitbucket-server` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-server.md#0219))
- `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.3.18 → [0.3.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-confluence-to-markdown.md#0319))
- `@backstage/plugin-scaffolder-backend-module-cookiecutter` (0.3.20 → [0.3.21](../../changelogs/@backstage/plugin-scaffolder-backend-module-cookiecutter.md#0321))
- `@backstage/plugin-scaffolder-backend-module-gcp` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-gcp.md#0219))
- `@backstage/plugin-scaffolder-backend-module-gerrit` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-gerrit.md#0219))
- `@backstage/plugin-scaffolder-backend-module-gitea` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitea.md#0219))
- `@backstage/plugin-scaffolder-backend-module-notifications` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-notifications.md#0120))
- `@backstage/plugin-scaffolder-backend-module-rails` (0.5.18 → [0.5.19](../../changelogs/@backstage/plugin-scaffolder-backend-module-rails.md#0519))
- `@backstage/plugin-scaffolder-backend-module-sentry` (0.3.1 → [0.3.2](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#032))
- `@backstage/plugin-scaffolder-backend-module-yeoman` (0.4.19 → [0.4.20](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#0420))
- `@backstage/plugin-scaffolder-node-test-utils` (0.3.8 → [0.3.9](../../changelogs/@backstage/plugin-scaffolder-node-test-utils.md#039))
- `@backstage/plugin-search-backend-module-catalog` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-search-backend-module-catalog.md#0313))
- `@backstage/plugin-search-backend-module-elasticsearch` (1.8.0 → [1.8.1](../../changelogs/@backstage/plugin-search-backend-module-elasticsearch.md#181))
- `@backstage/plugin-search-backend-module-explore` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-search-backend-module-explore.md#0312))
- `@backstage/plugin-search-backend-module-pg` (0.5.52 → [0.5.53](../../changelogs/@backstage/plugin-search-backend-module-pg.md#0553))
- `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#0318))
- `@backstage/plugin-search-backend-module-techdocs` (0.4.11 → [0.4.12](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#0412))
- `@backstage/plugin-search-backend-node` (1.4.1 → [1.4.2](../../changelogs/@backstage/plugin-search-backend-node.md#142))
- `@backstage/plugin-signals` (0.0.28 → [0.0.29](../../changelogs/@backstage/plugin-signals.md#0029))
- `@backstage/plugin-signals-backend` (0.3.12 → [0.3.13](../../changelogs/@backstage/plugin-signals-backend.md#0313))
- `@backstage/plugin-signals-node` (0.1.28 → [0.1.29](../../changelogs/@backstage/plugin-signals-node.md#0129))
- `@backstage/plugin-signals-react` (0.0.19 → [0.0.20](../../changelogs/@backstage/plugin-signals-react.md#0020))
- `@backstage/plugin-techdocs-addons-test-utils` (2.0.2 → [2.0.3](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#203))
- `@backstage/plugin-techdocs-react` (1.3.8 → [1.3.9](../../changelogs/@backstage/plugin-techdocs-react.md#139))
- `@backstage/test-utils` (1.7.15 → [1.7.16](../../changelogs/@backstage/test-utils.md#1716))
