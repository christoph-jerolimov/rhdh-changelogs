# Backstage Release 1.33.4

## Compared to 1.33.3 (previous patch release)

0 added, 0 removed, 1 upgraded, 176 unchanged.

### Version bumps

| Package | 1.33.3 | 1.33.4 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-app-backend` | 0.4.1 | 0.4.2 | Patch |

## Compared to 1.33.0 (first release of this minor)

0 added, 0 removed, 49 upgraded, 128 unchanged.

⚠️ Need extra attention: 2 0.0.x patch.

### Version bumps

| Package | 1.33.0 | 1.33.4 | Type |
| --- | --- | --- | --- |
| `@backstage/app-defaults` | 1.5.13 | 1.5.14 | Patch |
| `@backstage/cli` | 0.29.0 | 0.29.2 | Patch |
...
| `@backstage/plugin-scaffolder-backend` | 1.27.0 | 1.27.1 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.3.2 | 0.3.3 | Patch |
...
0 added, 0 removed, 154 upgraded, 23 unchanged.

⚠️ Need extra attention: 19 0.x minor, 5 0.0.x patch.

### Version bumps

| Package | 1.32.6 | 1.33.4 | Type |
| --- | --- | --- | --- |
| `@backstage/app-defaults` | 1.5.12 | 1.5.14 | Patch |
...
| `@backstage/cli` | 0.28.2 | 0.29.2 | Minor ⚠️ |
...
| `@backstage/core-compat-api` | 0.3.1 | 0.3.3 | Patch |
| `@backstage/core-components` | 0.15.1 | 0.16.1 | Minor ⚠️ |
| `@backstage/core-plugin-api` | 1.10.0 | 1.10.1 | Patch |
| `@backstage/create-app` | 0.5.21 | 0.5.22 | Patch |
| `@backstage/dev-utils` | 1.1.2 | 1.1.4 | Patch |
| `@backstage/errors` | 1.2.4 | 1.2.5 | Patch |
| `@backstage/frontend-app-api` | 0.10.0 | 0.10.2 | Patch |
| `@backstage/frontend-defaults` | 0.1.1 | 0.1.3 | Patch |
| `@backstage/frontend-plugin-api` | 0.9.0 | 0.9.2 | Patch |
| `@backstage/frontend-test-utils` | 0.2.1 | 0.2.3 | Patch |
...
| `@backstage/plugin-api-docs` | 0.11.11 | 0.12.1 | Minor ⚠️ |
| `@backstage/plugin-app` | 0.1.1 | 0.1.3 | Patch |
| `@backstage/plugin-app-backend` | 0.3.76 | 0.4.2 | Minor ⚠️ |
| `@backstage/plugin-app-node` | 0.1.26 | 0.1.27 | Patch |
| `@backstage/plugin-app-visualizer` | 0.1.11 | 0.1.13 | Patch |
...
| `@backstage/plugin-auth-react` | 0.1.7 | 0.1.9 | Patch |
| `@backstage/plugin-bitbucket-cloud-common` | 0.2.24 | 0.2.25 | Patch |
| `@backstage/plugin-catalog` | 1.24.0 | 1.25.1 | Minor |
...
| `@backstage/plugin-catalog-backend-module-ldap` | 0.9.1 | 0.10.1 | Minor ⚠️ |
...
| `@backstage/plugin-catalog-graph` | 0.4.11 | 0.4.13 | Patch |
| `@backstage/plugin-catalog-import` | 0.12.5 | 0.12.7 | Patch |
| `@backstage/plugin-catalog-node` | 1.13.1 | 1.14.0 | Minor |
| `@backstage/plugin-catalog-react` | 1.14.0 | 1.14.2 | Patch |
| `@backstage/plugin-catalog-unprocessed-entities` | 0.2.9 | 0.2.11 | Patch |
| `@backstage/plugin-catalog-unprocessed-entities-common` | 0.0.4 | 0.0.5 | Patch ⚠️ |
| `@backstage/plugin-config-schema` | 0.1.60 | 0.1.62 | Patch |
| `@backstage/plugin-devtools` | 0.1.19 | 0.1.21 | Patch |
...
| `@backstage/plugin-home` | 0.8.0 | 0.8.2 | Patch |
| `@backstage/plugin-home-react` | 0.1.18 | 0.1.20 | Patch |
| `@backstage/plugin-kubernetes` | 0.11.16 | 0.12.1 | Minor ⚠️ |
| `@backstage/plugin-kubernetes-backend` | 0.18.7 | 0.19.0 | Minor ⚠️ |
| `@backstage/plugin-kubernetes-cluster` | 0.0.17 | 0.0.19 | Patch ⚠️ |
| `@backstage/plugin-kubernetes-common` | 0.8.3 | 0.9.0 | Minor ⚠️ |
| `@backstage/plugin-kubernetes-node` | 0.1.20 | 0.2.0 | Minor ⚠️ |
| `@backstage/plugin-kubernetes-react` | 0.4.4 | 0.5.1 | Minor ⚠️ |
| `@backstage/plugin-notifications` | 0.3.2 | 0.4.1 | Minor ⚠️ |
...
| `@backstage/plugin-org` | 0.6.31 | 0.6.33 | Patch |
| `@backstage/plugin-org-react` | 0.1.30 | 0.1.32 | Patch |
...
| `@backstage/plugin-scaffolder` | 1.26.2 | 1.27.1 | Minor |
| `@backstage/plugin-scaffolder-backend` | 1.26.3 | 1.27.1 | Minor |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.3.2 | 0.3.3 | Patch |
| `@backstage/plugin-scaffolder-common` | 1.5.6 | 1.5.7 | Patch |
| `@backstage/plugin-scaffolder-node` | 0.5.1 | 0.6.0 | Minor ⚠️ |
| `@backstage/plugin-scaffolder-react` | 1.13.2 | 1.14.1 | Minor |
| `@backstage/plugin-search` | 1.4.18 | 1.4.20 | Patch |
...
| `@backstage/plugin-search-backend-module-techdocs` | 0.3.1 | 0.3.3 | Patch |
| `@backstage/plugin-search-backend-node` | 1.3.4 | 1.3.5 | Patch |
| `@backstage/plugin-search-common` | 1.2.14 | 1.2.15 | Patch |
| `@backstage/plugin-search-react` | 1.8.1 | 1.8.3 | Patch |
| `@backstage/plugin-signals` | 0.0.11 | 0.0.13 | Patch ⚠️ |
...
| `@backstage/plugin-techdocs` | 1.11.0 | 1.11.2 | Patch |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.40 | 1.0.42 | Patch |
| `@backstage/plugin-techdocs-backend` | 1.11.1 | 1.11.3 | Patch |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.16 | 1.1.18 | Patch |
| `@backstage/plugin-techdocs-node` | 1.12.12 | 1.12.14 | Patch |
| `@backstage/plugin-techdocs-react` | 1.2.9 | 1.2.11 | Patch |
| `@backstage/plugin-user-settings` | 0.8.14 | 0.8.16 | Patch |
| `@backstage/plugin-user-settings-backend` | 0.2.26 | 0.2.27 | Patch |
| `@backstage/repo-tools` | 0.10.0 | 0.11.1 | Minor ⚠️ |
| `@backstage/test-utils` | 1.7.0 | 1.7.2 | Patch |
| `@backstage/theme` | 0.6.0 | 0.6.2 | Patch |
| `@backstage/types` | 1.1.1 | 1.2.0 | Minor |
| `@techdocs/cli` | 1.8.21 | 1.8.23 | Patch |
