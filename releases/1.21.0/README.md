...
| `@backstage/catalog-client` | 1.4.6 | 1.5.0 | Minor |
...
| `@backstage/plugin-auth-backend` | 0.20.0 | 0.20.1 | Patch |
...
| `@backstage/repo-tools` | 0.4.0 | 0.5.0 | Minor ⚠️ |
