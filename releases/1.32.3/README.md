...
| Package | 1.32.2 | 1.32.3 |
| --- | --- | --- |
| `@backstage/cli` | 0.28.0 | 0.28.1 |
| `@backstage/plugin-events-backend` | 0.3.14 | 0.3.15 |
| `@backstage/plugin-events-node` | 0.4.2 | 0.4.3 |
| `@backstage/plugin-scaffolder` | 1.26.1 | 1.26.2 |
| `@backstage/plugin-scaffolder-react` | 1.13.1 | 1.13.2 |
...
| Package | 1.31.4 | 1.32.3 |
| --- | --- | --- |
| `@backstage/app-defaults` | 1.5.11 | 1.5.12 |
...
| `@backstage/backend-test-utils` | 1.0.0 | 1.0.2 |
| `@backstage/catalog-client` | 1.7.0 | 1.7.1 |
| `@backstage/cli` | 0.27.1 | 0.28.1 |
...
| `@backstage/frontend-app-api` | 0.9.0 | 0.10.0 |
...
| `@backstage/plugin-app` | 0.1.0 | 0.1.1 |
...
| `@backstage/plugin-catalog-backend` | 1.26.1 | 1.27.1 |
| `@backstage/plugin-catalog-backend-module-aws` | 0.4.2 | 0.4.4 |
...
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.3.2 | 0.4.1 |
...
| `@backstage/plugin-catalog-backend-module-github` | 0.7.4 | 0.7.6 |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.3.1 | 0.3.3 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.4.2 | 0.4.4 |
| `@backstage/plugin-catalog-backend-module-gitlab-org` | 0.2.0 | 0.2.2 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.5.4 | 0.5.6 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.9.0 | 0.9.1 |
| `@backstage/plugin-catalog-backend-module-logs` | 0.1.1 | 0.1.3 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.6.2 | 0.6.3 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.2.1 | 0.2.3 |
...
| `@backstage/plugin-events-backend` | 0.3.12 | 0.3.15 |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.4.2 | 0.4.4 |
| `@backstage/plugin-events-backend-module-azure` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-events-backend-module-gerrit` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-events-backend-module-github` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-events-backend-module-gitlab` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-events-backend-test-utils` | 0.1.35 | 0.1.37 |
| `@backstage/plugin-events-node` | 0.4.0 | 0.4.3 |
...
| `@backstage/plugin-notifications-backend` | 0.4.0 | 0.4.2 |
| `@backstage/plugin-notifications-backend-module-email` | 0.3.0 | 0.3.2 |
| `@backstage/plugin-notifications-node` | 0.2.6 | 0.2.8 |
...
| `@backstage/plugin-scaffolder` | 1.25.1 | 1.26.2 |
| `@backstage/plugin-scaffolder-backend` | 1.25.1 | 1.26.2 |
...
| `@backstage/plugin-scaffolder-react` | 1.12.1 | 1.13.2 |
| `@backstage/plugin-search` | 1.4.17 | 1.4.18 |
| `@backstage/plugin-search-backend` | 1.5.17 | 1.6.1 |
| `@backstage/plugin-search-backend-module-catalog` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.5.6 | 1.6.1 |
| `@backstage/plugin-search-backend-module-explore` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-search-backend-module-pg` | 0.5.35 | 0.5.37 |
| `@backstage/plugin-search-backend-module-stack-overflow-collator` | 0.3.0 | 0.3.2 |
| `@backstage/plugin-search-backend-module-techdocs` | 0.2.2 | 0.3.1 |
| `@backstage/plugin-search-backend-node` | 1.3.2 | 1.3.4 |
| `@backstage/plugin-search-react` | 1.8.0 | 1.8.1 |
| `@backstage/plugin-signals` | 0.0.10 | 0.0.11 |
| `@backstage/plugin-signals-backend` | 0.2.0 | 0.2.2 |
| `@backstage/plugin-signals-node` | 0.1.11 | 0.1.13 |
...
| `@backstage/plugin-techdocs-backend` | 1.10.13 | 1.11.1 |
...
| `@backstage/plugin-user-settings-backend` | 0.2.24 | 0.2.26 |
| `@backstage/repo-tools` | 0.9.7 | 0.10.0 |
| `@backstage/test-utils` | 1.6.0 | 1.7.0 |
| `@backstage/theme` | 0.5.7 | 0.6.0 |
| `@backstage/version-bridge` | 1.0.9 | 1.0.10 |
| `@techdocs/cli` | 1.8.19 | 1.8.21 |
