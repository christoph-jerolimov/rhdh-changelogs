...
| `@backstage/backend-dynamic-feature-service` | 0.2.3 | 0.2.5 |
...
| `@backstage/plugin-auth-backend` | 0.21.3 | 0.22.1 |
| `@backstage/plugin-auth-backend-module-atlassian-provider` | 0.1.5 | 0.1.6 |
| `@backstage/plugin-auth-backend-module-aws-alb-provider` | 0.1.4 | 0.1.6 |
...
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.1.3 | 0.1.5 |
...
| `@backstage/plugin-azure-devops-backend` | 0.5.5 | 0.6.1 |
| `@backstage/plugin-azure-devops-common` | 0.3.2 | 0.4.0 |
| `@backstage/plugin-azure-sites` | 0.1.19 | 0.1.20 |
| `@backstage/plugin-azure-sites-backend` | 0.2.3 | 0.3.1 |
...
| `@backstage/plugin-catalog-backend` | 1.17.3 | 1.19.0 |
| `@backstage/plugin-catalog-backend-module-aws` | 0.3.7 | 0.3.9 |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.32 | 0.1.34 |
| `@backstage/plugin-catalog-backend-module-backstage-openapi` | 0.1.6 | 0.1.8 |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.1.28 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.26 | 0.1.28 |
| `@backstage/plugin-catalog-backend-module-gcp` | 0.1.13 | 0.1.15 |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.29 | 0.1.31 |
| `@backstage/plugin-catalog-backend-module-github` | 0.5.3 | 0.5.5 |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.1.7 | 0.1.9 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.10 | 0.3.12 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.17 | 0.4.19 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.28 | 0.5.30 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.20 | 0.5.22 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.30 | 0.1.32 |
| `@backstage/plugin-catalog-backend-module-puppetdb` | 0.1.18 | 0.1.20 |
| `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` | 0.1.10 | 0.1.12 |
| `@backstage/plugin-catalog-backend-module-unprocessed` | 0.3.10 | 0.4.1 |
...
| `@backstage/plugin-catalog-node` | 1.7.3 | 1.9.0 |
...
| `@backstage/plugin-jenkins-backend` | 0.3.7 | 0.4.1 |
...
| `@backstage/plugin-kubernetes-backend` | 0.15.3 | 0.16.1 |
...
| `@backstage/plugin-lighthouse-backend` | 0.4.5 | 0.4.7 |
| `@backstage/plugin-lighthouse-common` | 0.1.4 | 0.1.5 |
| `@backstage/plugin-linguist` | 0.1.15 | 0.1.16 |
| `@backstage/plugin-linguist-backend` | 0.5.10 | 0.5.12 |
...
| `@backstage/plugin-permission-backend` | 0.5.36 | 0.5.38 |
...
| `@backstage/plugin-scaffolder-backend` | 1.21.3 | 1.22.1 |
...
| `@backstage/plugin-search-backend-module-catalog` | 0.1.17 | 0.1.19 |
...
| `@backstage/plugin-search-backend-module-techdocs` | 0.1.17 | 0.1.19 |
...
| `@backstage/plugin-techdocs-backend` | 1.9.6 | 1.10.1 |
...
| `@backstage/plugin-todo-backend` | 0.3.11 | 0.3.13 |
