...
0 added, 0 removed, 10 upgraded, 165 unchanged.
...
| `@backstage/backend-dynamic-feature-service` | 0.2.15 | 0.3.1 | Minor ⚠️ |
...
| `@backstage/plugin-auth-backend` | 0.22.9 | 0.22.11 | Patch |
| `@backstage/plugin-auth-backend-module-atlassian-provider` | 0.2.3 | 0.2.4 | Patch |
| `@backstage/plugin-auth-backend-module-aws-alb-provider` | 0.1.14 | 0.1.16 | Patch |
...
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.2.3 | 0.2.5 | Patch |
...
| `@backstage/plugin-catalog-backend` | 1.24.0 | 1.25.1 | Minor |
...
| `@backstage/plugin-catalog-backend-module-github` | 0.6.5 | 0.7.1 | Minor ⚠️ |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.1.17 | 0.2.1 | Minor ⚠️ |
...
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.27 | 0.5.1 | Minor ⚠️ |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.7.0 | 0.8.0 | Minor ⚠️ |
| `@backstage/plugin-catalog-backend-module-logs` | 0.0.1 | 0.0.3 | Patch ⚠️ |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.30 | 0.6.0 | Minor ⚠️ |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.40 | 0.1.42 | Patch |
