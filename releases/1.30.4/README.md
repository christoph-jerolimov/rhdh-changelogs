...
| Package | 1.29.2 | 1.30.4 |
| --- | --- | --- |
| `@backstage/app-defaults` | 1.5.9 | 1.5.10 |
| `@backstage/backend-app-api` | 0.8.0 | 0.9.3 |
| `@backstage/backend-common` | 0.23.3 | 0.24.1 |
| `@backstage/backend-defaults` | 0.4.1 | 0.4.4 |
| `@backstage/backend-dev-utils` | 0.1.4 | 0.1.5 |
| `@backstage/backend-dynamic-feature-service` | 0.2.15 | 0.3.2 |
| `@backstage/backend-openapi-utils` | 0.1.15 | 0.1.17 |
| `@backstage/backend-plugin-api` | 0.7.0 | 0.8.1 |
| `@backstage/backend-tasks` | 0.5.27 | 0.6.1 |
| `@backstage/backend-test-utils` | 0.4.4 | 0.5.1 |
...
| `@backstage/plugin-app-backend` | 0.3.71 | 0.3.73 |
| `@backstage/plugin-app-node` | 0.1.22 | 0.1.24 |
| `@backstage/plugin-app-visualizer` | 0.1.8 | 0.1.9 |
| `@backstage/plugin-auth-backend` | 0.22.9 | 0.22.12 |
| `@backstage/plugin-auth-backend-module-atlassian-provider` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-auth-backend-module-aws-alb-provider` | 0.1.14 | 0.1.17 |
| `@backstage/plugin-auth-backend-module-azure-easyauth-provider` | 0.1.5 | 0.1.7 |
| `@backstage/plugin-auth-backend-module-bitbucket-provider` | 0.1.5 | 0.1.7 |
| `@backstage/plugin-auth-backend-module-cloudflare-access-provider` | 0.1.5 | 0.2.1 |
| `@backstage/plugin-auth-backend-module-gcp-iap-provider` | 0.2.17 | 0.2.19 |
| `@backstage/plugin-auth-backend-module-github-provider` | 0.1.19 | 0.1.21 |
| `@backstage/plugin-auth-backend-module-gitlab-provider` | 0.1.19 | 0.1.21 |
| `@backstage/plugin-auth-backend-module-google-provider` | 0.1.19 | 0.1.21 |
| `@backstage/plugin-auth-backend-module-guest-provider` | 0.1.8 | 0.1.10 |
| `@backstage/plugin-auth-backend-module-microsoft-provider` | 0.1.17 | 0.1.19 |
| `@backstage/plugin-auth-backend-module-oauth2-provider` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` | 0.1.15 | 0.1.17 |
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.2.3 | 0.2.6 |
| `@backstage/plugin-auth-backend-module-okta-provider` | 0.0.15 | 0.0.17 |
| `@backstage/plugin-auth-backend-module-onelogin-provider` | 0.1.3 | 0.1.5 |
| `@backstage/plugin-auth-backend-module-pinniped-provider` | 0.1.16 | 0.1.18 |
| `@backstage/plugin-auth-backend-module-vmware-cloud-provider` | 0.2.3 | 0.2.5 |
...
| `@backstage/plugin-catalog-backend-module-aws` | 0.3.17 | 0.4.1 |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.42 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-backstage-openapi` | 0.2.5 | 0.3.1 |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.2.9 | 0.3.1 |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.36 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-gcp` | 0.1.23 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.39 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-github` | 0.6.5 | 0.7.2 |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.1.17 | 0.2.2 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.21 | 0.4.1 |
| `@backstage/plugin-catalog-backend-module-gitlab-org` | 0.0.5 | 0.1.1 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.27 | 0.5.2 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.7.0 | 0.8.1 |
| `@backstage/plugin-catalog-backend-module-logs` | 0.0.1 | 0.0.4 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.30 | 0.6.1 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.40 | 0.1.43 |
| `@backstage/plugin-catalog-backend-module-puppetdb` | 0.1.28 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` | 0.1.20 | 0.1.22 |
| `@backstage/plugin-catalog-backend-module-unprocessed` | 0.4.9 | 0.4.11 |
...
| `@backstage/plugin-catalog-node` | 1.12.4 | 1.12.6 |
...
| `@backstage/plugin-devtools-backend` | 0.3.8 | 0.3.10 |
| `@backstage/plugin-devtools-common` | 0.1.11 | 0.1.12 |
| `@backstage/plugin-events-backend` | 0.3.9 | 0.3.11 |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.3.8 | 0.4.1 |
| `@backstage/plugin-events-backend-module-azure` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-events-backend-module-gerrit` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-events-backend-module-github` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-events-backend-module-gitlab` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-events-backend-test-utils` | 0.1.32 | 0.1.34 |
| `@backstage/plugin-events-node` | 0.3.8 | 0.3.10 |
| `@backstage/plugin-home` | 0.7.8 | 0.7.9 |
| `@backstage/plugin-home-react` | 0.1.15 | 0.1.16 |
| `@backstage/plugin-kubernetes` | 0.11.12 | 0.11.13 |
| `@backstage/plugin-kubernetes-backend` | 0.18.3 | 0.18.5 |
| `@backstage/plugin-kubernetes-cluster` | 0.0.13 | 0.0.14 |
| `@backstage/plugin-kubernetes-common` | 0.8.1 | 0.8.2 |
| `@backstage/plugin-kubernetes-node` | 0.1.16 | 0.1.18 |
| `@backstage/plugin-kubernetes-react` | 0.4.1 | 0.4.2 |
| `@backstage/plugin-notifications` | 0.2.3 | 0.3.0 |
| `@backstage/plugin-notifications-backend` | 0.3.3 | 0.3.5 |
| `@backstage/plugin-notifications-backend-module-email` | 0.1.3 | 0.2.1 |
| `@backstage/plugin-notifications-node` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-org` | 0.6.27 | 0.6.28 |
| `@backstage/plugin-org-react` | 0.1.26 | 0.1.27 |
| `@backstage/plugin-permission-backend` | 0.5.46 | 0.5.48 |
| `@backstage/plugin-permission-backend-module-allow-all-policy` | 0.1.19 | 0.1.21 |
...
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.1.14 | 0.1.16 |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.2.12 | 0.2.14 |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-server` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.23 | 0.2.25 |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.46 | 0.2.48 |
| `@backstage/plugin-scaffolder-backend-module-gcp` | 0.1.0 | 0.1.2 |
| `@backstage/plugin-scaffolder-backend-module-gerrit` | 0.1.14 | 0.1.16 |
| `@backstage/plugin-scaffolder-backend-module-gitea` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-scaffolder-backend-module-github` | 0.4.0 | 0.4.2 |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.4.4 | 0.4.6 |
| `@backstage/plugin-scaffolder-backend-module-notifications` | 0.0.5 | 0.0.7 |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.39 | 0.4.41 |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.30 | 0.1.32 |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.3.6 | 0.3.8 |
| `@backstage/plugin-scaffolder-common` | 1.5.4 | 1.5.5 |
| `@backstage/plugin-scaffolder-node` | 0.4.8 | 0.4.10 |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.9 | 0.1.11 |
...
| `@backstage/plugin-search-backend-module-catalog` | 0.1.28 | 0.2.1 |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.5.3 | 1.5.5 |
| `@backstage/plugin-search-backend-module-explore` | 0.1.28 | 0.2.1 |
| `@backstage/plugin-search-backend-module-pg` | 0.5.32 | 0.5.34 |
| `@backstage/plugin-search-backend-module-stack-overflow-collator` | 0.1.15 | 0.2.1 |
| `@backstage/plugin-search-backend-module-techdocs` | 0.1.27 | 0.2.1 |
...
| `@backstage/plugin-signals-backend` | 0.1.8 | 0.1.10 |
| `@backstage/plugin-signals-node` | 0.1.8 | 0.1.10 |
...
| `@backstage/plugin-techdocs-node` | 1.12.8 | 1.12.10 |
| `@backstage/plugin-techdocs-react` | 1.2.6 | 1.2.7 |
| `@backstage/plugin-user-settings` | 0.8.10 | 0.8.11 |
| `@backstage/plugin-user-settings-backend` | 0.2.21 | 0.2.23 |
| `@backstage/repo-tools` | 0.9.4 | 0.9.6 |
| `@backstage/test-utils` | 1.5.9 | 1.5.10 |
| `@techdocs/cli` | 1.8.16 | 1.8.18 |
