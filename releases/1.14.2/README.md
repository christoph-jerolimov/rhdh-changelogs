...
1 major bumps, 4 added, 0 removed, 178 upgraded, 31 unchanged.
...
| `@backstage/plugin-adr` | 0.5.0 | 0.6.1 | Minor ⚠️ |
...
| `@backstage/plugin-api-docs` | 0.9.2 | 0.9.4 | Patch |
...
| `@backstage/plugin-bazaar` | 0.2.7 | 0.2.9 | Patch |
...
| `@backstage/plugin-catalog` | 1.10.0 | 1.11.1 | Minor |
...
| `@backstage/plugin-explore` | 0.4.2 | 0.4.4 | Patch |
...
| `@backstage/plugin-kubernetes` | 0.8.0 | 0.9.1 | Minor ⚠️ |
...
| `@backstage/plugin-playlist` | 0.1.8 | 0.1.10 | Patch |
...
| `@backstage/plugin-search` | 1.2.0 | 1.3.1 | Minor |
...
| `@backstage/plugin-search-react` | 1.5.2 | 1.6.1 | Minor |
...
| `@backstage/plugin-stack-overflow` | 0.1.14 | 0.1.16 | Patch |
...
| `@backstage/plugin-techdocs` | 1.6.1 | 1.6.3 | Patch |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.12 | 1.0.14 | Patch |
