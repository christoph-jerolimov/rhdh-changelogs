...
| Package | 1.19.5 | 1.19.6 | Type |
| --- | --- | --- | --- |
| `@backstage/core-components` | 0.13.6 | 0.13.7 | Patch |

## Compared to 1.19.0 (first release of this minor)

0 added, 0 removed, 15 upgraded, 223 unchanged.

### Version bumps

| Package | 1.19.0 | 1.19.6 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-app-api` | 0.5.6 | 0.5.7 | Patch |
| `@backstage/cli` | 0.23.0 | 0.23.1 | Patch |
| `@backstage/config-loader` | 1.5.1 | 1.5.2 | Patch |
| `@backstage/core-components` | 0.13.6 | 0.13.7 | Patch |
| `@backstage/plugin-auth-backend` | 0.19.3 | 0.19.4 | Patch |
...
| `@backstage/core-components` | 0.13.5 | 0.13.7 | Patch |
