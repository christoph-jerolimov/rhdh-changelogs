# Backstage Release 1.19.6

## Compared to 1.19.5 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 237 unchanged.

### Version bumps

| Package | 1.19.5 | 1.19.6 |
| --- | --- | --- |
...
| Package | 1.18.5 | 1.19.6 |
| --- | --- | --- |
| `@backstage/app-defaults` | 1.4.3 | 1.4.4 |
| `@backstage/backend-app-api` | 0.5.5 | 0.5.7 |
...
| `@backstage/config-loader` | 1.5.0 | 1.5.2 |
...
| `@backstage/plugin-auth-backend` | 0.19.2 | 0.19.4 |
...
| `@backstage/plugin-bazaar-backend` | 0.3.2 | 0.3.4 |
...
| `@backstage/plugin-kafka-backend` | 0.3.2 | 0.3.4 |
...
| `@backstage/plugin-periskop-backend` | 0.2.2 | 0.2.4 |
...
| `@backstage/plugin-proxy-backend` | 0.4.2 | 0.4.4 |
...
| `@backstage/plugin-scaffolder-backend` | 1.17.3 | 1.18.1 |
...
| `@backstage/plugin-scaffolder-node` | 0.2.5 | 0.2.7 |
...
| `@backstage/plugin-sonarqube` | 0.7.5 | 0.7.7 |
...
| `@backstage/plugin-todo` | 0.2.27 | 0.2.29 |
| `@backstage/plugin-todo-backend` | 0.3.3 | 0.3.4 |
| `@backstage/plugin-user-settings` | 0.7.10 | 0.7.11 |
| `@backstage/plugin-user-settings-backend` | 0.2.3 | 0.2.5 |
