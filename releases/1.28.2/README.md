...
0 added, 0 removed, 10 upgraded, 162 unchanged.

### Version bumps

| Package | 1.28.1 | 1.28.2 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-app-api` | 0.7.7 | 0.7.8 | Patch |
| `@backstage/backend-defaults` | 0.3.1 | 0.3.2 | Patch |
| `@backstage/backend-dynamic-feature-service` | 0.2.12 | 0.2.13 | Patch |
| `@backstage/backend-test-utils` | 0.4.1 | 0.4.2 | Patch |
| `@backstage/cli` | 0.26.8 | 0.26.9 | Patch |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.3.3 | 0.3.4 | Patch |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.6 | 0.1.7 | Patch |
| `@backstage/plugin-search-backend` | 1.5.11 | 1.5.12 | Patch |
| `@backstage/plugin-search-backend-module-pg` | 0.5.29 | 0.5.30 | Patch |
| `@techdocs/cli` | 1.8.13 | 1.8.14 | Patch |

## Compared to 1.28.0 (first release of this minor)

0 added, 0 removed, 102 upgraded, 70 unchanged.

⚠️ Need extra attention: 3 0.0.x patch.

### Version bumps

| Package | 1.28.0 | 1.28.2 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-app-api` | 0.7.6 | 0.7.8 | Patch |
| `@backstage/backend-common` | 0.23.0 | 0.23.1 | Patch |
| `@backstage/backend-defaults` | 0.3.0 | 0.3.2 | Patch |
| `@backstage/backend-dynamic-feature-service` | 0.2.11 | 0.2.13 | Patch |
...
| `@backstage/backend-test-utils` | 0.4.0 | 0.4.2 | Patch |
| `@backstage/cli` | 0.26.7 | 0.26.9 | Patch |
...
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.3.2 | 0.3.4 | Patch |
| `@backstage/plugin-scaffolder-node` | 0.4.5 | 0.4.6 | Patch |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.5 | 0.1.7 | Patch |
| `@backstage/plugin-search-backend` | 1.5.10 | 1.5.12 | Patch |
...
| `@backstage/plugin-search-backend-module-pg` | 0.5.28 | 0.5.30 | Patch |
...
| `@techdocs/cli` | 1.8.12 | 1.8.14 | Patch |
...
| Package | 1.27.7 | 1.28.2 | Type |
| --- | --- | --- | --- |
| `@backstage/app-defaults` | 1.5.5 | 1.5.6 | Patch |
| `@backstage/backend-app-api` | 0.7.5 | 0.7.8 | Patch |
| `@backstage/backend-common` | 0.22.0 | 0.23.1 | Minor ⚠️ |
| `@backstage/backend-defaults` | 0.2.18 | 0.3.2 | Minor ⚠️ |
| `@backstage/backend-dynamic-feature-service` | 0.2.10 | 0.2.13 | Patch |
...
| `@backstage/backend-test-utils` | 0.3.8 | 0.4.2 | Minor ⚠️ |
| `@backstage/cli` | 0.26.6 | 0.26.9 | Patch |
...
| `@backstage/plugin-search-backend-module-pg` | 0.5.27 | 0.5.30 | Patch |
...
| `@techdocs/cli` | 1.8.11 | 1.8.14 | Patch |
