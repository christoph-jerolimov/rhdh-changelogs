# Backstage Release 1.19.1

## Compared to 1.19.0 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 237 unchanged.
...
| `@backstage/backend-app-api` | 0.5.5 | 0.5.6 | Patch |
...
| `@backstage/cli` | 0.22.14 | 0.23.0 | Minor ⚠️ |
...
| `@backstage/config-loader` | 1.5.0 | 1.5.1 | Patch |
...
| `@backstage/plugin-auth-backend` | 0.19.2 | 0.19.3 | Patch |
...
| `@backstage/plugin-bazaar-backend` | 0.3.2 | 0.3.3 | Patch |
...
| `@backstage/plugin-kafka-backend` | 0.3.2 | 0.3.3 | Patch |
...
| `@backstage/plugin-periskop-backend` | 0.2.2 | 0.2.3 | Patch |
...
| `@backstage/plugin-proxy-backend` | 0.4.2 | 0.4.3 | Patch |
...
| `@backstage/plugin-scaffolder-backend` | 1.17.3 | 1.18.0 | Minor |
...
| `@backstage/plugin-scaffolder-node` | 0.2.5 | 0.2.6 | Patch |
...
| `@backstage/plugin-sonarqube` | 0.7.5 | 0.7.6 | Patch |
...
| `@backstage/plugin-todo` | 0.2.27 | 0.2.28 | Patch |
| `@backstage/plugin-todo-backend` | 0.3.3 | 0.3.4 | Patch |
| `@backstage/plugin-user-settings` | 0.7.10 | 0.7.11 | Patch |
| `@backstage/plugin-user-settings-backend` | 0.2.3 | 0.2.4 | Patch |
