...
| `@backstage/backend-app-api` | 0.2.4 | 0.3.0 | Minor ⚠️ |
| `@backstage/backend-common` | 0.17.0 | 0.18.0 | Minor ⚠️ |
| `@backstage/backend-defaults` | 0.1.4 | 0.1.5 | Patch |
| `@backstage/backend-plugin-api` | 0.2.0 | 0.3.0 | Minor ⚠️ |
| `@backstage/backend-tasks` | 0.4.0 | 0.4.1 | Patch |
| `@backstage/backend-test-utils` | 0.1.31 | 0.1.32 | Patch |
...
| `@backstage/plugin-adr-backend` | 0.2.4 | 0.2.5 | Patch |
| `@backstage/plugin-adr-common` | 0.2.4 | 0.2.5 | Patch |
| `@backstage/plugin-airbrake` | 0.3.13 | 0.3.14 | Patch |
| `@backstage/plugin-airbrake-backend` | 0.2.12 | 0.2.13 | Patch |
...
| `@backstage/plugin-app-backend` | 0.3.39 | 0.3.40 | Patch |
| `@backstage/plugin-auth-backend` | 0.17.2 | 0.17.3 | Patch |
| `@backstage/plugin-auth-node` | 0.2.8 | 0.2.9 | Patch |
| `@backstage/plugin-azure-devops` | 0.2.4 | 0.2.5 | Patch |
| `@backstage/plugin-azure-devops-backend` | 0.3.18 | 0.3.19 | Patch |
| `@backstage/plugin-azure-sites` | 0.1.2 | 0.1.3 | Patch |
| `@backstage/plugin-azure-sites-backend` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-badges` | 0.2.37 | 0.2.38 | Patch |
| `@backstage/plugin-badges-backend` | 0.1.33 | 0.1.34 | Patch |
| `@backstage/plugin-bazaar` | 0.2.2 | 0.2.3 | Patch |
| `@backstage/plugin-bazaar-backend` | 0.2.2 | 0.2.3 | Patch |
...
| `@backstage/plugin-catalog-backend` | 1.6.0 | 1.7.0 | Minor |
| `@backstage/plugin-catalog-backend-module-aws` | 0.1.12 | 0.1.13 | Patch |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.10 | 0.1.11 | Patch |
| `@backstage/plugin-catalog-backend-module-bitbucket` | 0.2.6 | 0.2.7 | Patch |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.1.6 | 0.1.7 | Patch |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.4 | 0.1.5 | Patch |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.7 | 0.1.8 | Patch |
| `@backstage/plugin-catalog-backend-module-github` | 0.2.2 | 0.2.3 | Patch |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.1.10 | 0.1.11 | Patch |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.1.0 | 0.1.1 | Patch |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.6 | 0.5.7 | Patch |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.4.5 | 0.4.6 | Patch |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.5 | 0.1.6 | Patch |
...
| `@backstage/plugin-catalog-node` | 1.3.0 | 1.3.1 | Patch |
...
| `@backstage/plugin-code-coverage-backend` | 0.2.5 | 0.2.6 | Patch |
...
| `@backstage/plugin-events-backend` | 0.2.0 | 0.2.1 | Patch |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-backend-module-azure` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-backend-module-gerrit` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-backend-module-github` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-backend-module-gitlab` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-backend-test-utils` | 0.1.1 | 0.1.2 | Patch |
| `@backstage/plugin-events-node` | 0.2.0 | 0.2.1 | Patch |
| `@backstage/plugin-explore` | 0.3.44 | 0.3.45 | Patch |
| `@backstage/plugin-explore-backend` | 0.0.1 | 0.0.2 | Patch ⚠️ |
...
| `@backstage/plugin-graphql-backend` | 0.1.29 | 0.1.30 | Patch |
...
| `@backstage/plugin-jenkins-backend` | 0.1.29 | 0.1.30 | Patch |
| `@backstage/plugin-jenkins-common` | 0.1.11 | 0.1.12 | Patch |
| `@backstage/plugin-kafka` | 0.3.13 | 0.3.14 | Patch |
| `@backstage/plugin-kafka-backend` | 0.2.32 | 0.2.33 | Patch |
| `@backstage/plugin-kubernetes` | 0.7.6 | 0.7.7 | Patch |
| `@backstage/plugin-kubernetes-backend` | 0.9.0 | 0.9.1 | Patch |
...
| `@backstage/plugin-periskop-backend` | 0.1.10 | 0.1.11 | Patch |
| `@backstage/plugin-permission-backend` | 0.5.14 | 0.5.15 | Patch |
| `@backstage/plugin-permission-common` | 0.7.2 | 0.7.3 | Patch |
| `@backstage/plugin-permission-node` | 0.7.2 | 0.7.3 | Patch |
| `@backstage/plugin-permission-react` | 0.4.8 | 0.4.9 | Patch |
| `@backstage/plugin-playlist` | 0.1.4 | 0.1.5 | Patch |
| `@backstage/plugin-playlist-backend` | 0.2.2 | 0.2.3 | Patch |
| `@backstage/plugin-playlist-common` | 0.1.3 | 0.1.4 | Patch |
| `@backstage/plugin-proxy-backend` | 0.2.33 | 0.2.34 | Patch |
| `@backstage/plugin-rollbar` | 0.4.13 | 0.4.14 | Patch |
| `@backstage/plugin-rollbar-backend` | 0.1.36 | 0.1.37 | Patch |
| `@backstage/plugin-scaffolder` | 1.9.1 | 1.10.0 | Minor |
| `@backstage/plugin-scaffolder-backend` | 1.9.0 | 1.10.0 | Minor |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.14 | 0.2.15 | Patch |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.7 | 0.4.8 | Patch |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.2.12 | 0.2.13 | Patch |
| `@backstage/plugin-scaffolder-common` | 1.2.3 | 1.2.4 | Patch |
| `@backstage/plugin-search` | 1.0.6 | 1.0.7 | Patch |
| `@backstage/plugin-search-backend` | 1.2.0 | 1.2.1 | Patch |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.1.0 | 1.1.1 | Patch |
| `@backstage/plugin-search-backend-module-pg` | 0.5.0 | 0.5.1 | Patch |
| `@backstage/plugin-search-backend-node` | 1.1.0 | 1.1.1 | Patch |
...
| `@backstage/plugin-sonarqube-backend` | 0.1.4 | 0.1.5 | Patch |
...
| `@backstage/plugin-stack-overflow-backend` | 0.1.8 | 0.1.9 | Patch |
| `@backstage/plugin-tech-insights` | 0.3.5 | 0.3.6 | Patch |
| `@backstage/plugin-tech-insights-backend` | 0.5.5 | 0.5.6 | Patch |
| `@backstage/plugin-tech-insights-backend-module-jsonfc` | 0.1.23 | 0.1.24 | Patch |
| `@backstage/plugin-tech-insights-node` | 0.3.7 | 0.3.8 | Patch |
...
| `@backstage/plugin-techdocs-backend` | 1.5.0 | 1.5.1 | Patch |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.0.8 | 1.0.9 | Patch |
| `@backstage/plugin-techdocs-node` | 1.4.3 | 1.4.4 | Patch |
| `@backstage/plugin-techdocs-react` | 1.1.1 | 1.1.2 | Patch |
| `@backstage/plugin-todo` | 0.2.15 | 0.2.16 | Patch |
| `@backstage/plugin-todo-backend` | 0.1.36 | 0.1.37 | Patch |
| `@backstage/plugin-user-settings` | 0.6.1 | 0.6.2 | Patch |
| `@backstage/plugin-user-settings-backend` | 0.1.3 | 0.1.4 | Patch |
| `@backstage/plugin-vault` | 0.1.7 | 0.1.8 | Patch |
| `@backstage/plugin-vault-backend` | 0.2.5 | 0.2.6 | Patch |
...
| `@techdocs/cli` | 1.2.4 | 1.3.0 | Minor |
