...
### `@backstage/plugin-auth-backend-module-aws-alb-provider` (new, [0.1.0](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#010))
...
### `@backstage/plugin-auth-backend-module-oidc-provider` (new, [0.1.0](../../changelogs/@backstage/plugin-auth-backend-module-oidc-provider.md#010))
...
### `@backstage/plugin-notifications-backend` (new, [0.0.1](../../changelogs/@backstage/plugin-notifications-backend.md#001))
...
### `@backstage/plugin-notifications-node` (new, [0.0.1](../../changelogs/@backstage/plugin-notifications-node.md#001))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (new, [0.1.0](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-cloud.md#010))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-server` (new, [0.1.0](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-server.md#010))
...
### `@backstage/plugin-scaffolder-backend-module-gitea` (new, [0.1.0](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitea.md#010))
...
### `@backstage/plugin-signals-backend` (new, [0.0.1](../../changelogs/@backstage/plugin-signals-backend.md#001))
...
### `@backstage/plugin-signals-node` (new, [0.0.1](../../changelogs/@backstage/plugin-signals-node.md#001))
...
### `@backstage/backend-common` (0.20.2 → [0.21.0](../../changelogs/@backstage/backend-common.md#0210))
...
### `@backstage/core-components` (0.13.10 → [0.14.0](../../changelogs/@backstage/core-components.md#0140))
...
### `@backstage/frontend-app-api` (0.5.0 → [0.6.0](../../changelogs/@backstage/frontend-app-api.md#060))
...
### `@backstage/frontend-plugin-api` (0.5.0 → [0.6.0](../../changelogs/@backstage/frontend-plugin-api.md#060))
...
### `@backstage/plugin-auth-backend` (0.20.3 → [0.21.0](../../changelogs/@backstage/plugin-auth-backend.md#0210))
...
### `@backstage/plugin-azure-sites-backend` (0.1.19 → [0.2.0](../../changelogs/@backstage/plugin-azure-sites-backend.md#020))
...
### `@backstage/plugin-kubernetes-backend` (0.14.1 → [0.15.0](../../changelogs/@backstage/plugin-kubernetes-backend.md#0150))
...
### `@backstage/plugin-kubernetes-react` (0.2.1 → [0.3.0](../../changelogs/@backstage/plugin-kubernetes-react.md#030))
...
### `@backstage/repo-tools` (0.5.2 → [0.6.0](../../changelogs/@backstage/repo-tools.md#060))
...
### `@backstage/plugin-dynatrace` (8.0.3 → [9.0.0](../../changelogs/@backstage/plugin-dynatrace.md#900))
...
### `@backstage/backend-dynamic-feature-service` (0.1.0 → [0.2.0](../../changelogs/@backstage/backend-dynamic-feature-service.md#020))
...
### `@backstage/backend-test-utils` (0.2.10 → [0.3.0](../../changelogs/@backstage/backend-test-utils.md#030))
...
### `@backstage/core-compat-api` (0.1.1 → [0.2.0](../../changelogs/@backstage/core-compat-api.md#020))
...
### `@backstage/plugin-analytics-module-ga` (0.1.37 → [0.2.0](../../changelogs/@backstage/plugin-analytics-module-ga.md#020))
...
### `@backstage/plugin-analytics-module-ga4` (0.1.8 → [0.2.0](../../changelogs/@backstage/plugin-analytics-module-ga4.md#020))
...
### `@backstage/plugin-analytics-module-newrelic-browser` (0.0.6 → [0.1.0](../../changelogs/@backstage/plugin-analytics-module-newrelic-browser.md#010))
...
### `@backstage/plugin-api-docs` (0.10.3 → [0.11.0](../../changelogs/@backstage/plugin-api-docs.md#0110))
...
### `@backstage/plugin-catalog-backend-module-github` (0.4.7 → [0.5.0](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#050))
...
### `@backstage/plugin-catalog-graph` (0.3.3 → [0.4.0](../../changelogs/@backstage/plugin-catalog-graph.md#040))
...
### `@backstage/plugin-cloudbuild` (0.3.29 → [0.4.0](../../changelogs/@backstage/plugin-cloudbuild.md#040))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket` (0.1.1 → [0.2.0](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket.md#020))
...
### `@backstage/plugin-scaffolder-backend-module-github` (0.1.1 → [0.2.0](../../changelogs/@backstage/plugin-scaffolder-backend-module-github.md#020))
...
### `@backstage/plugin-scaffolder-node` (0.2.10 → [0.3.0](../../changelogs/@backstage/plugin-scaffolder-node.md#030))
...
### `@backstage/plugin-auth-backend-module-okta-provider` (0.0.2 → [0.0.3](../../changelogs/@backstage/plugin-auth-backend-module-okta-provider.md#003))
...
### `@backstage/plugin-explore-backend` (0.0.19 → [0.0.20](../../changelogs/@backstage/plugin-explore-backend.md#0020))
...
### `@backstage/plugin-kubernetes-cluster` (0.0.5 → [0.0.6](../../changelogs/@backstage/plugin-kubernetes-cluster.md#006))
...
### `@backstage/app-defaults` (1.4.7 → [1.5.0](../../changelogs/@backstage/app-defaults.md#150))
...
### `@backstage/catalog-client` (1.5.2 → [1.6.0](../../changelogs/@backstage/catalog-client.md#160))
...
### `@backstage/core-app-api` (1.11.3 → [1.12.0](../../changelogs/@backstage/core-app-api.md#1120))
...
### `@backstage/core-plugin-api` (1.8.2 → [1.9.0](../../changelogs/@backstage/core-plugin-api.md#190))
...
### `@backstage/integration` (1.8.0 → [1.9.0](../../changelogs/@backstage/integration.md#190))
...
### `@backstage/plugin-catalog` (1.16.1 → [1.17.0](../../changelogs/@backstage/plugin-catalog.md#1170))
...
### `@backstage/plugin-catalog-backend` (1.16.2 → [1.17.0](../../changelogs/@backstage/plugin-catalog-backend.md#1170))
...
### `@backstage/plugin-catalog-node` (1.6.1 → [1.7.0](../../changelogs/@backstage/plugin-catalog-node.md#170))
...
### `@backstage/plugin-catalog-react` (1.9.3 → [1.10.0](../../changelogs/@backstage/plugin-catalog-react.md#1100))
...
### `@backstage/plugin-scaffolder` (1.17.1 → [1.18.0](../../changelogs/@backstage/plugin-scaffolder.md#1180))
...
### `@backstage/plugin-scaffolder-backend` (1.20.0 → [1.21.0](../../changelogs/@backstage/plugin-scaffolder-backend.md#1210))
...
### `@backstage/plugin-scaffolder-common` (1.4.5 → [1.5.0](../../changelogs/@backstage/plugin-scaffolder-common.md#150))
...
### `@backstage/plugin-scaffolder-react` (1.7.1 → [1.8.0](../../changelogs/@backstage/plugin-scaffolder-react.md#180))
...
### `@backstage/plugin-search-backend` (1.4.9 → [1.5.0](../../changelogs/@backstage/plugin-search-backend.md#150))
...
### `@backstage/plugin-techdocs` (1.9.3 → [1.10.0](../../changelogs/@backstage/plugin-techdocs.md#1100))
...
### `@backstage/test-utils` (1.4.7 → [1.5.0](../../changelogs/@backstage/test-utils.md#150))
...
### `@backstage/backend-app-api` (0.5.10 → [0.5.11](../../changelogs/@backstage/backend-app-api.md#0511))
...
### `@backstage/backend-defaults` (0.2.9 → [0.2.10](../../changelogs/@backstage/backend-defaults.md#0210))
...
### `@backstage/backend-dev-utils` (0.1.3 → [0.1.4](../../changelogs/@backstage/backend-dev-utils.md#014))
...
### `@backstage/backend-openapi-utils` (0.1.2 → [0.1.3](../../changelogs/@backstage/backend-openapi-utils.md#013))
...
### `@backstage/backend-plugin-api` (0.6.9 → [0.6.10](../../changelogs/@backstage/backend-plugin-api.md#0610))
...
### `@backstage/backend-tasks` (0.5.14 → [0.5.15](../../changelogs/@backstage/backend-tasks.md#0515))
...
### `@backstage/cli` (0.25.1 → [0.25.2](../../changelogs/@backstage/cli.md#0252))
...
### `@backstage/cli-node` (0.2.2 → [0.2.3](../../changelogs/@backstage/cli-node.md#023))
...
### `@backstage/config-loader` (1.6.1 → [1.6.2](../../changelogs/@backstage/config-loader.md#162))
...
### `@backstage/create-app` (0.5.10 → [0.5.11](../../changelogs/@backstage/create-app.md#0511))
...
### `@backstage/dev-utils` (1.0.26 → [1.0.27](../../changelogs/@backstage/dev-utils.md#1027))
...
### `@backstage/eslint-plugin` (0.1.4 → [0.1.5](../../changelogs/@backstage/eslint-plugin.md#015))
...
### `@backstage/frontend-test-utils` (0.1.1 → [0.1.2](../../changelogs/@backstage/frontend-test-utils.md#012))
...
### `@backstage/integration-aws-node` (0.1.8 → [0.1.9](../../changelogs/@backstage/integration-aws-node.md#019))
...
### `@backstage/plugin-adr` (0.6.12 → [0.6.13](../../changelogs/@backstage/plugin-adr.md#0613))
...
### `@backstage/plugin-adr-backend` (0.4.6 → [0.4.7](../../changelogs/@backstage/plugin-adr-backend.md#047))
...
### `@backstage/plugin-airbrake` (0.3.29 → [0.3.30](../../changelogs/@backstage/plugin-airbrake.md#0330))
...
### `@backstage/plugin-allure` (0.1.45 → [0.1.46](../../changelogs/@backstage/plugin-allure.md#0146))
...
### `@backstage/plugin-apache-airflow` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-apache-airflow.md#0220))
...
### `@backstage/plugin-api-docs-module-protoc-gen-doc` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-api-docs-module-protoc-gen-doc.md#016))
...
### `@backstage/plugin-apollo-explorer` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-apollo-explorer.md#0120))
...
### `@backstage/plugin-app-backend` (0.3.57 → [0.3.58](../../changelogs/@backstage/plugin-app-backend.md#0358))
...
### `@backstage/plugin-app-node` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-app-node.md#0110))
...
### `@backstage/plugin-app-visualizer` (0.1.0 → [0.1.1](../../changelogs/@backstage/plugin-app-visualizer.md#011))
...
### `@backstage/plugin-auth-backend-module-atlassian-provider` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#012))
...
### `@backstage/plugin-auth-backend-module-github-provider` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#017))
...
### `@backstage/plugin-auth-backend-module-gitlab-provider` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#017))
...
### `@backstage/plugin-auth-backend-module-microsoft-provider` (0.1.4 → [0.1.5](../../changelogs/@backstage/plugin-auth-backend-module-microsoft-provider.md#015))
...
### `@backstage/plugin-auth-backend-module-oauth2-provider` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-provider.md#017))
...
### `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#012))
...
### `@backstage/plugin-auth-backend-module-pinniped-provider` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#014))
...
### `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#012))
...
### `@backstage/plugin-auth-node` (0.4.3 → [0.4.4](../../changelogs/@backstage/plugin-auth-node.md#044))
...
### `@backstage/plugin-azure-devops` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-azure-devops.md#0312))
...
### `@backstage/plugin-azure-devops-backend` (0.5.1 → [0.5.2](../../changelogs/@backstage/plugin-azure-devops-backend.md#052))
...
### `@backstage/plugin-azure-sites` (0.1.18 → [0.1.19](../../changelogs/@backstage/plugin-azure-sites.md#0119))
...
### `@backstage/plugin-badges` (0.2.53 → [0.2.54](../../changelogs/@backstage/plugin-badges.md#0254))
...
### `@backstage/plugin-badges-backend` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-badges-backend.md#037))
...
### `@backstage/plugin-bazaar` (0.2.21 → [0.2.22](../../changelogs/@backstage/plugin-bazaar.md#0222))
...
### `@backstage/plugin-bazaar-backend` (0.3.7 → [0.3.8](../../changelogs/@backstage/plugin-bazaar-backend.md#038))
...
### `@backstage/plugin-bitbucket-cloud-common` (0.2.15 → [0.2.16](../../changelogs/@backstage/plugin-bitbucket-cloud-common.md#0216))
...
### `@backstage/plugin-bitrise` (0.1.56 → [0.1.57](../../changelogs/@backstage/plugin-bitrise.md#0157))
...
### `@backstage/plugin-catalog-backend-module-aws` (0.3.3 → [0.3.4](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#034))
...
### `@backstage/plugin-catalog-backend-module-azure` (0.1.28 → [0.1.29](../../changelogs/@backstage/plugin-catalog-backend-module-azure.md#0129))
...
### `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#013))
...
### `@backstage/plugin-catalog-backend-module-gerrit` (0.1.25 → [0.1.26](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#0126))
...
### `@backstage/plugin-catalog-backend-module-github-org` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#014))
...
### `@backstage/plugin-catalog-backend-module-gitlab` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#037))
...
### `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.4.13 → [0.4.14](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#0414))
...
### `@backstage/plugin-catalog-backend-module-msgraph` (0.5.16 → [0.5.17](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph.md#0517))
...
### `@backstage/plugin-catalog-backend-module-openapi` (0.1.26 → [0.1.27](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#0127))
...
### `@backstage/plugin-catalog-backend-module-puppetdb` (0.1.14 → [0.1.15](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#0115))
...
### `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#017))
...
### `@backstage/plugin-catalog-backend-module-unprocessed` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#037))
...
### `@backstage/plugin-catalog-import` (0.10.5 → [0.10.6](../../changelogs/@backstage/plugin-catalog-import.md#0106))
...
### `@backstage/plugin-catalog-unprocessed-entities` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#018))
...
### `@backstage/plugin-circleci` (0.3.29 → [0.3.30](../../changelogs/@backstage/plugin-circleci.md#0330))
...
### `@backstage/plugin-code-climate` (0.1.29 → [0.1.30](../../changelogs/@backstage/plugin-code-climate.md#0130))
...
### `@backstage/plugin-code-coverage` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-code-coverage.md#0223))
...
### `@backstage/plugin-code-coverage-backend` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-code-coverage-backend.md#0224))
...
### `@backstage/plugin-codescene` (0.1.21 → [0.1.22](../../changelogs/@backstage/plugin-codescene.md#0122))
...
### `@backstage/plugin-config-schema` (0.1.49 → [0.1.50](../../changelogs/@backstage/plugin-config-schema.md#0150))
...
### `@backstage/plugin-cost-insights` (0.12.18 → [0.12.19](../../changelogs/@backstage/plugin-cost-insights.md#01219))
...
### `@backstage/plugin-devtools` (0.1.8 → [0.1.9](../../changelogs/@backstage/plugin-devtools.md#019))
...
### `@backstage/plugin-devtools-backend` (0.2.6 → [0.2.7](../../changelogs/@backstage/plugin-devtools-backend.md#027))
...
### `@backstage/plugin-entity-feedback` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-entity-feedback.md#0213))
...
### `@backstage/plugin-entity-feedback-backend` (0.2.6 → [0.2.7](../../changelogs/@backstage/plugin-entity-feedback-backend.md#027))
...
### `@backstage/plugin-entity-validation` (0.1.14 → [0.1.15](../../changelogs/@backstage/plugin-entity-validation.md#0115))
...
### `@backstage/plugin-events-backend` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-events-backend.md#0219))
...
### `@backstage/plugin-events-backend-module-aws-sqs` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#0213))
...
### `@backstage/plugin-events-backend-module-azure` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-events-backend-module-azure.md#0120))
...
### `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#0120))
...
### `@backstage/plugin-events-backend-module-gerrit` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#0120))
...
### `@backstage/plugin-events-backend-module-github` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-events-backend-module-github.md#0120))
...
### `@backstage/plugin-events-backend-module-gitlab` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#0120))
...
### `@backstage/plugin-explore` (0.4.15 → [0.4.16](../../changelogs/@backstage/plugin-explore.md#0416))
...
### `@backstage/plugin-firehydrant` (0.2.13 → [0.2.14](../../changelogs/@backstage/plugin-firehydrant.md#0214))
...
### `@backstage/plugin-fossa` (0.2.61 → [0.2.62](../../changelogs/@backstage/plugin-fossa.md#0262))
...
### `@backstage/plugin-gcalendar` (0.3.22 → [0.3.23](../../changelogs/@backstage/plugin-gcalendar.md#0323))
...
### `@backstage/plugin-gcp-projects` (0.3.45 → [0.3.46](../../changelogs/@backstage/plugin-gcp-projects.md#0346))
...
### `@backstage/plugin-git-release-manager` (0.3.41 → [0.3.42](../../changelogs/@backstage/plugin-git-release-manager.md#0342))
...
### `@backstage/plugin-github-actions` (0.6.10 → [0.6.11](../../changelogs/@backstage/plugin-github-actions.md#0611))
...
### `@backstage/plugin-github-deployments` (0.1.60 → [0.1.61](../../changelogs/@backstage/plugin-github-deployments.md#0161))
...
### `@backstage/plugin-github-issues` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-github-issues.md#0219))
...
### `@backstage/plugin-github-pull-requests-board` (0.1.23 → [0.1.24](../../changelogs/@backstage/plugin-github-pull-requests-board.md#0124))
...
### `@backstage/plugin-gitops-profiles` (0.3.44 → [0.3.45](../../changelogs/@backstage/plugin-gitops-profiles.md#0345))
...
### `@backstage/plugin-graphiql` (0.3.2 → [0.3.3](../../changelogs/@backstage/plugin-graphiql.md#033))
...
### `@backstage/plugin-graphql-voyager` (0.1.11 → [0.1.12](../../changelogs/@backstage/plugin-graphql-voyager.md#0112))
...
### `@backstage/plugin-home` (0.6.1 → [0.6.2](../../changelogs/@backstage/plugin-home.md#062))
...
### `@backstage/plugin-home-react` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-home-react.md#018))
...
### `@backstage/plugin-ilert` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-ilert.md#0219))
...
### `@backstage/plugin-jenkins` (0.9.4 → [0.9.5](../../changelogs/@backstage/plugin-jenkins.md#095))
...
### `@backstage/plugin-jenkins-backend` (0.3.3 → [0.3.4](../../changelogs/@backstage/plugin-jenkins-backend.md#034))
...
### `@backstage/plugin-kafka` (0.3.29 → [0.3.30](../../changelogs/@backstage/plugin-kafka.md#0330))
...
### `@backstage/plugin-kubernetes` (0.11.4 → [0.11.5](../../changelogs/@backstage/plugin-kubernetes.md#0115))
...
### `@backstage/plugin-kubernetes-common` (0.7.3 → [0.7.4](../../changelogs/@backstage/plugin-kubernetes-common.md#074))
...
### `@backstage/plugin-kubernetes-node` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-kubernetes-node.md#014))
...
### `@backstage/plugin-lighthouse` (0.4.14 → [0.4.15](../../changelogs/@backstage/plugin-lighthouse.md#0415))
...
### `@backstage/plugin-lighthouse-backend` (0.4.1 → [0.4.2](../../changelogs/@backstage/plugin-lighthouse-backend.md#042))
...
### `@backstage/plugin-linguist` (0.1.14 → [0.1.15](../../changelogs/@backstage/plugin-linguist.md#0115))
...
### `@backstage/plugin-linguist-backend` (0.5.6 → [0.5.7](../../changelogs/@backstage/plugin-linguist-backend.md#057))
...
### `@backstage/plugin-microsoft-calendar` (0.1.11 → [0.1.12](../../changelogs/@backstage/plugin-microsoft-calendar.md#0112))
...
### `@backstage/plugin-newrelic` (0.3.44 → [0.3.45](../../changelogs/@backstage/plugin-newrelic.md#0345))
...
### `@backstage/plugin-newrelic-dashboard` (0.3.4 → [0.3.5](../../changelogs/@backstage/plugin-newrelic-dashboard.md#035))
...
### `@backstage/plugin-nomad` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-nomad.md#0111))
...
### `@backstage/plugin-nomad-backend` (0.1.11 → [0.1.12](../../changelogs/@backstage/plugin-nomad-backend.md#0112))
...
### `@backstage/plugin-octopus-deploy` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-octopus-deploy.md#0212))
...
### `@backstage/plugin-opencost` (0.2.4 → [0.2.5](../../changelogs/@backstage/plugin-opencost.md#025))
...
### `@backstage/plugin-org` (0.6.19 → [0.6.20](../../changelogs/@backstage/plugin-org.md#0620))
...
### `@backstage/plugin-org-react` (0.1.18 → [0.1.19](../../changelogs/@backstage/plugin-org-react.md#0119))
...
### `@backstage/plugin-pagerduty` (0.7.1 → [0.7.2](../../changelogs/@backstage/plugin-pagerduty.md#072))
...
### `@backstage/plugin-periskop` (0.1.27 → [0.1.28](../../changelogs/@backstage/plugin-periskop.md#0128))
...
### `@backstage/plugin-permission-backend-module-allow-all-policy` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#017))
...
### `@backstage/plugin-permission-react` (0.4.19 → [0.4.20](../../changelogs/@backstage/plugin-permission-react.md#0420))
...
### `@backstage/plugin-playlist` (0.2.3 → [0.2.4](../../changelogs/@backstage/plugin-playlist.md#024))
...
### `@backstage/plugin-playlist-backend` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-playlist-backend.md#0314))
...
### `@backstage/plugin-puppetdb` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-puppetdb.md#0113))
...
### `@backstage/plugin-rollbar` (0.4.29 → [0.4.30](../../changelogs/@backstage/plugin-rollbar.md#0430))
...
### `@backstage/plugin-rollbar-backend` (0.1.54 → [0.1.55](../../changelogs/@backstage/plugin-rollbar-backend.md#0155))
...
### `@backstage/plugin-scaffolder-backend-module-azure` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-scaffolder-backend-module-azure.md#012))
...
### `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-scaffolder-backend-module-confluence-to-markdown.md#0211))
...
### `@backstage/plugin-scaffolder-backend-module-cookiecutter` (0.2.33 → [0.2.34](../../changelogs/@backstage/plugin-scaffolder-backend-module-cookiecutter.md#0234))
...
### `@backstage/plugin-scaffolder-backend-module-gerrit` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-scaffolder-backend-module-gerrit.md#012))
...
### `@backstage/plugin-scaffolder-backend-module-gitlab` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitlab.md#0213))
...
### `@backstage/plugin-scaffolder-backend-module-rails` (0.4.26 → [0.4.27](../../changelogs/@backstage/plugin-scaffolder-backend-module-rails.md#0427))
...
### `@backstage/plugin-scaffolder-backend-module-sentry` (0.1.17 → [0.1.18](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#0118))
...
### `@backstage/plugin-scaffolder-backend-module-yeoman` (0.2.30 → [0.2.31](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#0231))
...
### `@backstage/plugin-search` (1.4.5 → [1.4.6](../../changelogs/@backstage/plugin-search.md#146))
...
### `@backstage/plugin-search-backend-module-catalog` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-search-backend-module-catalog.md#0114))
...
### `@backstage/plugin-search-backend-module-explore` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-search-backend-module-explore.md#0114))
...
### `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#013))
...
### `@backstage/plugin-search-backend-module-techdocs` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#0114))
...
### `@backstage/plugin-search-react` (1.7.5 → [1.7.6](../../changelogs/@backstage/plugin-search-react.md#176))
...
### `@backstage/plugin-sentry` (0.5.14 → [0.5.15](../../changelogs/@backstage/plugin-sentry.md#0515))
...
### `@backstage/plugin-shortcuts` (0.3.18 → [0.3.19](../../changelogs/@backstage/plugin-shortcuts.md#0319))
...
### `@backstage/plugin-sonarqube` (0.7.11 → [0.7.12](../../changelogs/@backstage/plugin-sonarqube.md#0712))
...
### `@backstage/plugin-sonarqube-backend` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-sonarqube-backend.md#0212))
...
### `@backstage/plugin-splunk-on-call` (0.4.18 → [0.4.19](../../changelogs/@backstage/plugin-splunk-on-call.md#0419))
...
### `@backstage/plugin-stack-overflow` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-stack-overflow.md#0125))
...
### `@backstage/plugin-stackstorm` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-stackstorm.md#0111))
...
### `@backstage/plugin-tech-insights` (0.3.21 → [0.3.22](../../changelogs/@backstage/plugin-tech-insights.md#0322))
...
### `@backstage/plugin-tech-insights-backend` (0.5.23 → [0.5.24](../../changelogs/@backstage/plugin-tech-insights-backend.md#0524))
...
### `@backstage/plugin-tech-insights-backend-module-jsonfc` (0.1.41 → [0.1.42](../../changelogs/@backstage/plugin-tech-insights-backend-module-jsonfc.md#0142))
...
### `@backstage/plugin-tech-insights-node` (0.4.15 → [0.4.16](../../changelogs/@backstage/plugin-tech-insights-node.md#0416))
...
### `@backstage/plugin-tech-radar` (0.6.12 → [0.6.13](../../changelogs/@backstage/plugin-tech-radar.md#0613))
...
### `@backstage/plugin-techdocs-addons-test-utils` (1.0.26 → [1.0.27](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#1027))
...
### `@backstage/plugin-techdocs-backend` (1.9.2 → [1.9.3](../../changelogs/@backstage/plugin-techdocs-backend.md#193))
...
### `@backstage/plugin-techdocs-module-addons-contrib` (1.1.4 → [1.1.5](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#115))
...
### `@backstage/plugin-techdocs-node` (1.11.1 → [1.11.2](../../changelogs/@backstage/plugin-techdocs-node.md#1112))
...
### `@backstage/plugin-techdocs-react` (1.1.15 → [1.1.16](../../changelogs/@backstage/plugin-techdocs-react.md#1116))
...
### `@backstage/plugin-todo-backend` (0.3.7 → [0.3.8](../../changelogs/@backstage/plugin-todo-backend.md#038))
...
### `@backstage/plugin-user-settings` (0.8.0 → [0.8.1](../../changelogs/@backstage/plugin-user-settings.md#081))
...
### `@backstage/plugin-vault` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-vault.md#0125))
...
### `@backstage/plugin-vault-backend` (0.4.2 → [0.4.3](../../changelogs/@backstage/plugin-vault-backend.md#043))
...
### `@backstage/plugin-vault-node` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-vault-node.md#013))
...
### `@backstage/plugin-xcmetrics` (0.2.47 → [0.2.48](../../changelogs/@backstage/plugin-xcmetrics.md#0248))
...
### `@backstage/theme` (0.5.0 → [0.5.1](../../changelogs/@backstage/theme.md#051))
...
### `@techdocs/cli` (1.8.1 → [1.8.2](../../changelogs/@techdocs/cli.md#182))
...
- `@backstage/integration-react` (1.1.23 → [1.1.24](../../changelogs/@backstage/integration-react.md#1124))
- `@backstage/plugin-adr-common` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-adr-common.md#0220))
- `@backstage/plugin-airbrake-backend` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-airbrake-backend.md#037))
- `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.2.3 → [0.2.4](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#024))
- `@backstage/plugin-auth-backend-module-google-provider` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#017))
- `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#0125))
- `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.1.22 → [0.1.23](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#0123))
- `@backstage/plugin-catalog-backend-module-gcp` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#0110))
- `@backstage/plugin-catalog-backend-module-ldap` (0.5.24 → [0.5.25](../../changelogs/@backstage/plugin-catalog-backend-module-ldap.md#0525))
- `@backstage/plugin-catalog-common` (1.0.20 → [1.0.21](../../changelogs/@backstage/plugin-catalog-common.md#1021))
- `@backstage/plugin-cicd-statistics` (0.1.31 → [0.1.32](../../changelogs/@backstage/plugin-cicd-statistics.md#0132))
- `@backstage/plugin-cicd-statistics-module-gitlab` (0.1.25 → [0.1.26](../../changelogs/@backstage/plugin-cicd-statistics-module-gitlab.md#0126))
- `@backstage/plugin-events-backend-test-utils` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0120))
- `@backstage/plugin-events-node` (0.2.18 → [0.2.19](../../changelogs/@backstage/plugin-events-node.md#0219))
- `@backstage/plugin-explore-react` (0.0.35 → [0.0.36](../../changelogs/@backstage/plugin-explore-react.md#0036))
- `@backstage/plugin-gocd` (0.1.35 → [0.1.36](../../changelogs/@backstage/plugin-gocd.md#0136))
- `@backstage/plugin-jenkins-common` (0.1.23 → [0.1.24](../../changelogs/@backstage/plugin-jenkins-common.md#0124))
- `@backstage/plugin-kafka-backend` (0.3.7 → [0.3.8](../../changelogs/@backstage/plugin-kafka-backend.md#038))
- `@backstage/plugin-periskop-backend` (0.2.7 → [0.2.8](../../changelogs/@backstage/plugin-periskop-backend.md#028))
- `@backstage/plugin-permission-backend` (0.5.32 → [0.5.33](../../changelogs/@backstage/plugin-permission-backend.md#0533))
- `@backstage/plugin-permission-node` (0.7.20 → [0.7.21](../../changelogs/@backstage/plugin-permission-node.md#0721))
- `@backstage/plugin-proxy-backend` (0.4.7 → [0.4.8](../../changelogs/@backstage/plugin-proxy-backend.md#048))
- `@backstage/plugin-search-backend-module-elasticsearch` (1.3.12 → [1.3.13](../../changelogs/@backstage/plugin-search-backend-module-elasticsearch.md#1313))
- `@backstage/plugin-search-backend-module-pg` (0.5.18 → [0.5.19](../../changelogs/@backstage/plugin-search-backend-module-pg.md#0519))
- `@backstage/plugin-search-backend-node` (1.2.13 → [1.2.14](../../changelogs/@backstage/plugin-search-backend-node.md#1214))
- `@backstage/plugin-sonarqube-react` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-sonarqube-react.md#0113))
- `@backstage/plugin-stack-overflow-backend` (0.2.13 → [0.2.14](../../changelogs/@backstage/plugin-stack-overflow-backend.md#0214))
- `@backstage/plugin-todo` (0.2.33 → [0.2.34](../../changelogs/@backstage/plugin-todo.md#0234))
- `@backstage/plugin-user-settings-backend` (0.2.8 → [0.2.9](../../changelogs/@backstage/plugin-user-settings-backend.md#029))
