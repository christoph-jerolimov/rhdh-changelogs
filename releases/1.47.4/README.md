...
| Package | 1.47.3 | 1.47.4 |
| --- | --- | --- |
| `@backstage/plugin-app-visualizer` | 0.1.27 | 0.1.28 |
| `@backstage/ui` | 0.11.2 | 0.11.3 |
...
| `@backstage/plugin-auth-backend-module-aws-alb-provider` | 0.4.10 | 0.4.12 |
...
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.4.10 | 0.4.12 |
...
| `@backstage/plugin-auth-node` | 0.6.10 | 0.6.12 |
...
| `@backstage/plugin-catalog-backend` | 3.3.0 | 3.3.2 |
...
| `@backstage/plugin-catalog-react` | 1.21.4 | 1.21.6 |
...
| `@backstage/plugin-home` | 0.8.15 | 0.9.1 |
...
| `@backstage/plugin-permission-common` | 0.9.3 | 0.9.5 |
| `@backstage/plugin-permission-node` | 0.10.7 | 0.10.9 |
| `@backstage/plugin-scaffolder` | 1.35.0 | 1.35.2 |
| `@backstage/plugin-scaffolder-backend` | 3.1.0 | 3.1.2 |
...
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.3.0 | 0.3.2 |
...
| `@backstage/plugin-scaffolder-backend-module-github` | 0.9.3 | 0.9.5 |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.11.0 | 0.11.2 |
...
| `@backstage/plugin-scaffolder-node` | 0.12.2 | 0.12.4 |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.3.6 | 0.3.7 |
| `@backstage/plugin-scaffolder-react` | 1.19.4 | 1.19.6 |
...
| `@backstage/plugin-techdocs-node` | 1.13.11 | 1.14.1 |
...
| `@backstage/repo-tools` | 0.16.1 | 0.16.3 |
| `@backstage/ui` | 0.10.1 | 0.11.3 |
