...
| `@backstage/backend-dynamic-feature-service` | 0.2.6 | 0.2.8 |
...
| `@backstage/plugin-events-backend` | 0.3.1 | 0.3.3 |
...
| `@backstage/plugin-kubernetes-backend` | 0.16.2 | 0.16.4 |
