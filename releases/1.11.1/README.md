...
1 major bumps, 14 added, 0 removed, 166 upgraded, 17 unchanged.
...
| `@backstage/plugin-bazaar` | 0.2.3 | 0.2.5 |
...
| `@backstage/plugin-catalog-backend-module-aws` | 0.1.14 | 0.1.16 |
...
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.1.2 | 0.2.1 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.8 | 0.5.9 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.4.7 | 0.5.1 |
...
| `@backstage/plugin-sonarqube` | 0.6.2 | 0.6.4 |
| `@backstage/plugin-sonarqube-backend` | 0.1.6 | 0.1.7 |
| `@backstage/plugin-sonarqube-react` | 0.1.1 | 0.1.3 |
...
| `@backstage/plugin-vault-backend` | 0.2.7 | 0.2.9 |
