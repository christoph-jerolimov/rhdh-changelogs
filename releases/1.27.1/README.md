...
| Package | 1.27.0 | 1.27.1 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-app-api` | 0.7.3 | 0.7.4 | Patch |
...
| Package | 1.26.5 | 1.27.1 | Type |
| --- | --- | --- | --- |
| `@backstage/app-defaults` | 1.5.4 | 1.5.5 | Patch |
| `@backstage/backend-app-api` | 0.7.2 | 0.7.4 | Patch |
...
| `@backstage/cli` | 0.26.4 | 0.26.5 | Patch |
...
| `@backstage/plugin-app-backend` | 0.3.65 | 0.3.66 | Patch |
...
| `@backstage/plugin-scaffolder` | 1.19.3 | 1.20.0 | Minor |
| `@backstage/plugin-scaffolder-backend` | 1.22.5 | 1.22.6 | Patch |
...
| `@backstage/plugin-scaffolder-react` | 1.8.4 | 1.8.5 | Patch |
| `@backstage/plugin-search` | 1.4.10 | 1.4.11 | Patch |
| `@backstage/plugin-search-backend` | 1.5.7 | 1.5.8 | Patch |
...
| `@backstage/plugin-search-backend-node` | 1.2.21 | 1.2.22 | Patch |
...
| `@backstage/theme` | 0.5.3 | 0.5.4 | Patch |
