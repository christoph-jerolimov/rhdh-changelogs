...
### `@backstage/app-defaults` (1.5.17 → [1.6.0](../../changelogs/@backstage/app-defaults.md#160))
...
### `@backstage/cli` (0.30.0 → [0.31.0](../../changelogs/@backstage/cli.md#0310))
...
### `@backstage/core-compat-api` (0.3.6 → [0.4.0](../../changelogs/@backstage/core-compat-api.md#040))
...
### `@backstage/frontend-app-api` (0.10.5 → [0.11.0](../../changelogs/@backstage/frontend-app-api.md#0110))
...
### `@backstage/frontend-defaults` (0.1.6 → [0.2.0](../../changelogs/@backstage/frontend-defaults.md#020))
...
### `@backstage/frontend-plugin-api` (0.9.5 → [0.10.0](../../changelogs/@backstage/frontend-plugin-api.md#0100))
...
### `@backstage/frontend-test-utils` (0.2.6 → [0.3.0](../../changelogs/@backstage/frontend-test-utils.md#030))
...
### `@backstage/plugin-app-backend` (0.4.5 → [0.5.0](../../changelogs/@backstage/plugin-app-backend.md#050))
...
### `@backstage/plugin-catalog-backend-module-gerrit` (0.2.7 → [0.3.0](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#030))
...
### `@backstage/plugin-events-backend` (0.4.3 → [0.5.0](../../changelogs/@backstage/plugin-events-backend.md#050))
...
### `@backstage/plugin-permission-node` (0.8.8 → [0.9.0](../../changelogs/@backstage/plugin-permission-node.md#090))
...
### `@backstage/plugin-proxy-backend` (0.5.11 → [0.6.0](../../changelogs/@backstage/plugin-proxy-backend.md#060))
...
### `@backstage/plugin-search-backend` (1.8.2 → [2.0.0](../../changelogs/@backstage/plugin-search-backend.md#200))
...
### `@backstage/plugin-search-backend-module-explore` (0.2.8 → [0.3.0](../../changelogs/@backstage/plugin-search-backend-module-explore.md#030))
...
### `@backstage/plugin-search-backend-module-techdocs` (0.3.6 → [0.4.0](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#040))
...
### `@backstage/plugin-techdocs-backend` (1.11.6 → [2.0.0](../../changelogs/@backstage/plugin-techdocs-backend.md#200))
...
### `@backstage/plugin-user-settings-backend` (0.2.30 → [0.3.0](../../changelogs/@backstage/plugin-user-settings-backend.md#030))
...
### `@backstage/canon` (0.1.0 → [0.2.0](../../changelogs/@backstage/canon.md#020))
...
### `@backstage/core-components` (0.16.4 → [0.17.0](../../changelogs/@backstage/core-components.md#0170))
...
### `@backstage/create-app` (0.5.25 → [0.6.0](../../changelogs/@backstage/create-app.md#060))
...
### `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.4.5 → [0.5.0](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#050))
...
### `@backstage/plugin-scaffolder-node` (0.7.0 → [0.8.0](../../changelogs/@backstage/plugin-scaffolder-node.md#080))
...
### `@backstage/plugin-scaffolder-node-test-utils` (0.1.19 → [0.2.0](../../changelogs/@backstage/plugin-scaffolder-node-test-utils.md#020))
...
### `@backstage/plugin-signals` (0.0.16 → [0.0.17](../../changelogs/@backstage/plugin-signals.md#0017))
...
### `@backstage/core-app-api` (1.15.5 → [1.16.0](../../changelogs/@backstage/core-app-api.md#1160))
...
### `@backstage/plugin-catalog` (1.27.0 → [1.28.0](../../changelogs/@backstage/plugin-catalog.md#1280))
...
### `@backstage/plugin-catalog-backend` (1.31.0 → [1.32.0](../../changelogs/@backstage/plugin-catalog-backend.md#1320))
...
### `@backstage/plugin-catalog-react` (1.15.2 → [1.16.0](../../changelogs/@backstage/plugin-catalog-react.md#1160))
...
### `@backstage/plugin-scaffolder` (1.28.0 → [1.29.0](../../changelogs/@backstage/plugin-scaffolder.md#1290))
...
### `@backstage/plugin-scaffolder-backend` (1.30.0 → [1.31.0](../../changelogs/@backstage/plugin-scaffolder-backend.md#1310))
...
### `@backstage/plugin-search-backend-module-elasticsearch` (1.6.5 → [1.7.0](../../changelogs/@backstage/plugin-search-backend-module-elasticsearch.md#170))
...
### `@backstage/backend-app-api` (1.2.0 → [1.2.1](../../changelogs/@backstage/backend-app-api.md#121))
...
### `@backstage/core-plugin-api` (1.10.4 → [1.10.5](../../changelogs/@backstage/core-plugin-api.md#1105))
...
### `@backstage/integration` (1.16.1 → [1.16.2](../../changelogs/@backstage/integration.md#1162))
...
### `@backstage/plugin-scaffolder-react` (1.14.5 → [1.14.6](../../changelogs/@backstage/plugin-scaffolder-react.md#1146))
...
### `@backstage/plugin-search` (1.4.23 → [1.4.24](../../changelogs/@backstage/plugin-search.md#1424))
...
### `@backstage/plugin-techdocs` (1.12.3 → [1.12.4](../../changelogs/@backstage/plugin-techdocs.md#1124))
...
### `@backstage/plugin-techdocs-module-addons-contrib` (1.1.21 → [1.1.22](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#1122))
...
### `@backstage/plugin-techdocs-node` (1.13.0 → [1.13.1](../../changelogs/@backstage/plugin-techdocs-node.md#1131))
...
### `@backstage/plugin-techdocs-react` (1.2.14 → [1.2.15](../../changelogs/@backstage/plugin-techdocs-react.md#1215))
...
- `@backstage/backend-dynamic-feature-service` (0.6.0 → [0.6.1](../../changelogs/@backstage/backend-dynamic-feature-service.md#061))
- `@backstage/backend-openapi-utils` (0.5.0 → [0.5.1](../../changelogs/@backstage/backend-openapi-utils.md#051))
- `@backstage/backend-plugin-api` (1.2.0 → [1.2.1](../../changelogs/@backstage/backend-plugin-api.md#121))
- `@backstage/dev-utils` (1.1.7 → [1.1.8](../../changelogs/@backstage/dev-utils.md#118))
- `@backstage/integration-react` (1.2.4 → [1.2.5](../../changelogs/@backstage/integration-react.md#125))
- `@backstage/plugin-app-node` (0.1.30 → [0.1.31](../../changelogs/@backstage/plugin-app-node.md#0131))
- `@backstage/plugin-app-visualizer` (0.1.16 → [0.1.17](../../changelogs/@backstage/plugin-app-visualizer.md#0117))
- `@backstage/plugin-auth-backend-module-atlassian-provider` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#041))
- `@backstage/plugin-auth-backend-module-auth0-provider` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-auth-backend-module-auth0-provider.md#021))
- `@backstage/plugin-auth-backend-module-aws-alb-provider` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#041))
- `@backstage/plugin-auth-backend-module-azure-easyauth-provider` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-auth-backend-module-azure-easyauth-provider.md#026))
- `@backstage/plugin-auth-backend-module-bitbucket-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-provider.md#031))
- `@backstage/plugin-auth-backend-module-bitbucket-server-provider` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-server-provider.md#021))
- `@backstage/plugin-auth-backend-module-cloudflare-access-provider` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-auth-backend-module-cloudflare-access-provider.md#041))
- `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#041))
- `@backstage/plugin-auth-backend-module-github-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#031))
- `@backstage/plugin-auth-backend-module-gitlab-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#031))
- `@backstage/plugin-auth-backend-module-google-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#031))
- `@backstage/plugin-auth-backend-module-guest-provider` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-auth-backend-module-guest-provider.md#026))
- `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#026))
- `@backstage/plugin-auth-backend-module-onelogin-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-onelogin-provider.md#031))
- `@backstage/plugin-auth-backend-module-pinniped-provider` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#031))
- `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.5.0 → [0.5.1](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#051))
- `@backstage/plugin-auth-react` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-auth-react.md#0113))
- `@backstage/plugin-bitbucket-cloud-common` (0.2.27 → [0.2.28](../../changelogs/@backstage/plugin-bitbucket-cloud-common.md#0228))
- `@backstage/plugin-catalog-backend-module-aws` (0.4.8 → [0.4.9](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#049))
- `@backstage/plugin-catalog-backend-module-azure` (0.3.2 → [0.3.3](../../changelogs/@backstage/plugin-catalog-backend-module-azure.md#033))
- `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#046))
- `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.3.2 → [0.3.3](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#033))
- `@backstage/plugin-catalog-backend-module-gcp` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#036))
- `@backstage/plugin-catalog-backend-module-github` (0.7.10 → [0.7.11](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#0711))
- `@backstage/plugin-catalog-backend-module-github-org` (0.3.7 → [0.3.8](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#038))
- `@backstage/plugin-catalog-backend-module-gitlab` (0.6.3 → [0.6.4](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#064))
- `@backstage/plugin-catalog-backend-module-gitlab-org` (0.2.6 → [0.2.7](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab-org.md#027))
- `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.6.3 → [0.6.4](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#064))
- `@backstage/plugin-catalog-backend-module-logs` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-catalog-backend-module-logs.md#018))
- `@backstage/plugin-catalog-backend-module-openapi` (0.2.7 → [0.2.8](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#028))
- `@backstage/plugin-catalog-backend-module-puppetdb` (0.2.7 → [0.2.8](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#028))
- `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#026))
- `@backstage/plugin-catalog-backend-module-unprocessed` (0.5.5 → [0.5.6](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#056))
- `@backstage/plugin-catalog-graph` (0.4.16 → [0.4.17](../../changelogs/@backstage/plugin-catalog-graph.md#0417))
- `@backstage/plugin-catalog-import` (0.12.10 → [0.12.11](../../changelogs/@backstage/plugin-catalog-import.md#01211))
- `@backstage/plugin-catalog-node` (1.16.0 → [1.16.1](../../changelogs/@backstage/plugin-catalog-node.md#1161))
- `@backstage/plugin-catalog-unprocessed-entities` (0.2.14 → [0.2.15](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#0215))
- `@backstage/plugin-config-schema` (0.1.65 → [0.1.66](../../changelogs/@backstage/plugin-config-schema.md#0166))
- `@backstage/plugin-devtools` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-devtools.md#0125))
- `@backstage/plugin-devtools-backend` (0.5.2 → [0.5.3](../../changelogs/@backstage/plugin-devtools-backend.md#053))
- `@backstage/plugin-events-backend-module-aws-sqs` (0.4.8 → [0.4.9](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#049))
- `@backstage/plugin-events-backend-module-azure` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-events-backend-module-azure.md#0218))
- `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#0218))
- `@backstage/plugin-events-backend-module-gerrit` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#0218))
- `@backstage/plugin-events-backend-module-github` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-events-backend-module-github.md#0218))
- `@backstage/plugin-events-backend-module-gitlab` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#0218))
- `@backstage/plugin-events-backend-test-utils` (0.1.41 → [0.1.42](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0142))
- `@backstage/plugin-kubernetes-cluster` (0.0.22 → [0.0.23](../../changelogs/@backstage/plugin-kubernetes-cluster.md#0023))
- `@backstage/plugin-kubernetes-node` (0.2.3 → [0.2.4](../../changelogs/@backstage/plugin-kubernetes-node.md#024))
- `@backstage/plugin-kubernetes-react` (0.5.4 → [0.5.5](../../changelogs/@backstage/plugin-kubernetes-react.md#055))
- `@backstage/plugin-notifications` (0.5.2 → [0.5.3](../../changelogs/@backstage/plugin-notifications.md#053))
- `@backstage/plugin-notifications-backend-module-email` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-notifications-backend-module-email.md#037))
- `@backstage/plugin-notifications-node` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-notifications-node.md#0213))
- `@backstage/plugin-org` (0.6.36 → [0.6.37](../../changelogs/@backstage/plugin-org.md#0637))
- `@backstage/plugin-org-react` (0.1.35 → [0.1.36](../../changelogs/@backstage/plugin-org-react.md#0136))
- `@backstage/plugin-permission-backend` (0.5.54 → [0.5.55](../../changelogs/@backstage/plugin-permission-backend.md#0555))
- `@backstage/plugin-permission-backend-module-allow-all-policy` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#026))
- `@backstage/plugin-permission-react` (0.4.31 → [0.4.32](../../changelogs/@backstage/plugin-permission-react.md#0432))
- `@backstage/plugin-proxy-node` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-proxy-node.md#012))
- `@backstage/plugin-scaffolder-backend-module-gcp` (0.2.6 → [0.2.7](../../changelogs/@backstage/plugin-scaffolder-backend-module-gcp.md#027))
- `@backstage/plugin-scaffolder-backend-module-notifications` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-scaffolder-backend-module-notifications.md#018))
- `@backstage/plugin-scaffolder-backend-module-sentry` (0.2.6 → [0.2.7](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#027))
- `@backstage/plugin-scaffolder-backend-module-yeoman` (0.4.7 → [0.4.8](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#048))
- `@backstage/plugin-search-backend-module-catalog` (0.3.1 → [0.3.2](../../changelogs/@backstage/plugin-search-backend-module-catalog.md#032))
- `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#037))
- `@backstage/plugin-search-backend-node` (1.3.8 → [1.3.9](../../changelogs/@backstage/plugin-search-backend-node.md#139))
- `@backstage/plugin-signals-backend` (0.3.1 → [0.3.2](../../changelogs/@backstage/plugin-signals-backend.md#032))
- `@backstage/plugin-signals-node` (0.1.17 → [0.1.18](../../changelogs/@backstage/plugin-signals-node.md#0118))
- `@backstage/plugin-signals-react` (0.0.10 → [0.0.11](../../changelogs/@backstage/plugin-signals-react.md#0011))
- `@backstage/plugin-techdocs-addons-test-utils` (1.0.45 → [1.0.46](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#1046))
- `@backstage/plugin-user-settings` (0.8.19 → [0.8.20](../../changelogs/@backstage/plugin-user-settings.md#0820))
- `@techdocs/cli` (1.9.0 → [1.9.1](../../changelogs/@techdocs/cli.md#191))
