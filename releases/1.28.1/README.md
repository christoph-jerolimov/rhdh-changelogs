...
| Package | 1.27.7 | 1.28.1 |
| --- | --- | --- |
| `@backstage/app-defaults` | 1.5.5 | 1.5.6 |
| `@backstage/backend-app-api` | 0.7.5 | 0.7.7 |
| `@backstage/backend-common` | 0.22.0 | 0.23.1 |
| `@backstage/backend-defaults` | 0.2.18 | 0.3.1 |
| `@backstage/backend-dynamic-feature-service` | 0.2.10 | 0.2.12 |
...
| `@backstage/backend-test-utils` | 0.3.8 | 0.4.1 |
| `@backstage/cli` | 0.26.6 | 0.26.8 |
...
| `@backstage/plugin-search-backend-module-pg` | 0.5.27 | 0.5.29 |
