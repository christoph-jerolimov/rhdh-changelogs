...
| `@backstage/backend-test-utils` | 0.2.2 | 0.2.4 |
...
| `@backstage/plugin-catalog-backend` | 1.12.4 | 1.13.1 |
...
| `@backstage/plugin-catalog-backend-module-github` | 0.3.7 | 0.4.1 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.2.6 | 0.3.0 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.5 | 0.4.7 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.17 | 0.5.18 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.9 | 0.5.10 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.18 | 0.1.20 |
...
| `@backstage/plugin-scaffolder-backend` | 1.16.5 | 1.17.1 |
