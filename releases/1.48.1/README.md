# Backstage Release 1.48.1

## Compared to 1.48.0 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 193 unchanged.

### Version bumps

| Package | 1.48.0 | 1.48.1 | Type |
| --- | --- | --- | --- |
...
| `@backstage/integration` | 1.19.2 | 1.20.0 | Minor |
...
| `@backstage/plugin-auth-backend` | 0.26.0 | 0.27.0 | Minor ⚠️ |
...
| `@backstage/plugin-catalog` | 1.32.2 | 1.33.0 | Minor |
...
| `@backstage/plugin-scaffolder` | 1.35.2 | 1.35.3 | Patch |
| `@backstage/plugin-scaffolder-backend` | 3.1.2 | 3.1.3 | Patch |
...
| `@backstage/plugin-search` | 1.5.3 | 1.6.0 | Minor |
...
| `@backstage/plugin-search-react` | 1.10.2 | 1.10.3 | Patch |
...
| `@backstage/plugin-techdocs-node` | 1.14.1 | 1.14.2 | Patch |
...
| `@backstage/repo-tools` | 0.16.3 | 0.16.4 | Patch |
