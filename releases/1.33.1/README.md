# Backstage Release 1.33.1

## Compared to 1.33.0 (previous patch release)

0 added, 0 removed, 1 upgraded, 176 unchanged.

### Version bumps

| Package | 1.33.0 | 1.33.1 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-app-backend` | 0.3.76 | 0.4.0 | Minor ⚠️ |
