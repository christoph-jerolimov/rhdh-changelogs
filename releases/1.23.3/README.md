...
| `@backstage/backend-app-api` | 0.5.10 | 0.5.13 |
| `@backstage/backend-common` | 0.20.2 | 0.21.2 |
| `@backstage/backend-defaults` | 0.2.9 | 0.2.12 |
| `@backstage/backend-dev-utils` | 0.1.3 | 0.1.4 |
| `@backstage/backend-dynamic-feature-service` | 0.1.0 | 0.2.2 |
| `@backstage/backend-openapi-utils` | 0.1.2 | 0.1.5 |
| `@backstage/backend-plugin-api` | 0.6.9 | 0.6.12 |
| `@backstage/backend-tasks` | 0.5.14 | 0.5.17 |
| `@backstage/backend-test-utils` | 0.2.10 | 0.3.2 |
...
| `@backstage/plugin-adr-backend` | 0.4.6 | 0.4.9 |
| `@backstage/plugin-adr-common` | 0.2.19 | 0.2.20 |
| `@backstage/plugin-airbrake` | 0.3.29 | 0.3.30 |
| `@backstage/plugin-airbrake-backend` | 0.3.6 | 0.3.9 |
...
| `@backstage/plugin-app-backend` | 0.3.57 | 0.3.60 |
| `@backstage/plugin-app-node` | 0.1.9 | 0.1.12 |
| `@backstage/plugin-app-visualizer` | 0.1.0 | 0.1.1 |
| `@backstage/plugin-auth-backend` | 0.20.3 | 0.21.2 |
| `@backstage/plugin-auth-backend-module-atlassian-provider` | 0.1.1 | 0.1.4 |
| `@backstage/plugin-auth-backend-module-gcp-iap-provider` | 0.2.3 | 0.2.7 |
| `@backstage/plugin-auth-backend-module-github-provider` | 0.1.6 | 0.1.9 |
| `@backstage/plugin-auth-backend-module-gitlab-provider` | 0.1.6 | 0.1.9 |
| `@backstage/plugin-auth-backend-module-google-provider` | 0.1.6 | 0.1.9 |
| `@backstage/plugin-auth-backend-module-microsoft-provider` | 0.1.4 | 0.1.7 |
| `@backstage/plugin-auth-backend-module-oauth2-provider` | 0.1.6 | 0.1.9 |
| `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` | 0.1.1 | 0.1.5 |
| `@backstage/plugin-auth-backend-module-okta-provider` | 0.0.2 | 0.0.5 |
| `@backstage/plugin-auth-backend-module-pinniped-provider` | 0.1.3 | 0.1.6 |
| `@backstage/plugin-auth-backend-module-vmware-cloud-provider` | 0.1.1 | 0.1.4 |
| `@backstage/plugin-auth-node` | 0.4.3 | 0.4.7 |
| `@backstage/plugin-azure-devops` | 0.3.11 | 0.3.12 |
| `@backstage/plugin-azure-devops-backend` | 0.5.1 | 0.5.4 |
| `@backstage/plugin-azure-sites` | 0.1.18 | 0.1.19 |
| `@backstage/plugin-azure-sites-backend` | 0.1.19 | 0.2.2 |
| `@backstage/plugin-azure-sites-common` | 0.1.1 | 0.1.2 |
| `@backstage/plugin-badges` | 0.2.53 | 0.2.54 |
| `@backstage/plugin-badges-backend` | 0.3.6 | 0.3.9 |
| `@backstage/plugin-bazaar` | 0.2.21 | 0.2.22 |
| `@backstage/plugin-bazaar-backend` | 0.3.7 | 0.3.10 |
...
| `@backstage/plugin-catalog-backend-module-aws` | 0.3.3 | 0.3.6 |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.28 | 0.1.31 |
| `@backstage/plugin-catalog-backend-module-backstage-openapi` | 0.1.2 | 0.1.5 |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.1.24 | 0.1.27 |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.22 | 0.1.25 |
| `@backstage/plugin-catalog-backend-module-gcp` | 0.1.9 | 0.1.12 |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.25 | 0.1.28 |
| `@backstage/plugin-catalog-backend-module-github` | 0.4.7 | 0.5.2 |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.1.3 | 0.1.6 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.6 | 0.3.9 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.13 | 0.4.16 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.24 | 0.5.27 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.16 | 0.5.19 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.26 | 0.1.29 |
| `@backstage/plugin-catalog-backend-module-puppetdb` | 0.1.14 | 0.1.17 |
| `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` | 0.1.6 | 0.1.9 |
| `@backstage/plugin-catalog-backend-module-unprocessed` | 0.3.6 | 0.3.9 |
...
| `@backstage/plugin-catalog-node` | 1.6.1 | 1.7.2 |
...
| `@backstage/plugin-code-coverage-backend` | 0.2.23 | 0.2.26 |
...
| `@backstage/plugin-devtools-backend` | 0.2.6 | 0.2.9 |
| `@backstage/plugin-entity-feedback` | 0.2.12 | 0.2.13 |
| `@backstage/plugin-entity-feedback-backend` | 0.2.6 | 0.2.9 |
| `@backstage/plugin-entity-validation` | 0.1.14 | 0.1.15 |
| `@backstage/plugin-events-backend` | 0.2.18 | 0.2.21 |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.2.12 | 0.2.15 |
| `@backstage/plugin-events-backend-module-azure` | 0.1.19 | 0.1.22 |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.1.19 | 0.1.22 |
| `@backstage/plugin-events-backend-module-gerrit` | 0.1.19 | 0.1.22 |
| `@backstage/plugin-events-backend-module-github` | 0.1.19 | 0.1.22 |
| `@backstage/plugin-events-backend-module-gitlab` | 0.1.19 | 0.1.22 |
| `@backstage/plugin-events-backend-test-utils` | 0.1.19 | 0.1.22 |
| `@backstage/plugin-events-node` | 0.2.18 | 0.2.21 |
| `@backstage/plugin-explore` | 0.4.15 | 0.4.16 |
| `@backstage/plugin-explore-backend` | 0.0.19 | 0.0.22 |
...
| `@backstage/plugin-nomad-backend` | 0.1.11 | 0.1.14 |
...
| `@backstage/plugin-periskop-backend` | 0.2.7 | 0.2.10 |
| `@backstage/plugin-permission-backend` | 0.5.32 | 0.5.35 |
| `@backstage/plugin-permission-backend-module-allow-all-policy` | 0.1.6 | 0.1.9 |
...
| `@backstage/plugin-playlist-backend` | 0.3.13 | 0.3.16 |
| `@backstage/plugin-proxy-backend` | 0.4.7 | 0.4.10 |
| `@backstage/plugin-puppetdb` | 0.1.12 | 0.1.13 |
| `@backstage/plugin-rollbar` | 0.4.29 | 0.4.30 |
| `@backstage/plugin-rollbar-backend` | 0.1.54 | 0.1.57 |
| `@backstage/plugin-scaffolder` | 1.17.1 | 1.18.0 |
| `@backstage/plugin-scaffolder-backend` | 1.20.0 | 1.21.2 |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.1.1 | 0.1.4 |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.1.1 | 0.2.2 |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.10 | 0.2.13 |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.33 | 0.2.36 |
| `@backstage/plugin-scaffolder-backend-module-gerrit` | 0.1.1 | 0.1.4 |
| `@backstage/plugin-scaffolder-backend-module-github` | 0.1.1 | 0.2.2 |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.2.12 | 0.2.15 |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.26 | 0.4.29 |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.17 | 0.1.20 |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.2.30 | 0.2.33 |
| `@backstage/plugin-scaffolder-common` | 1.4.5 | 1.5.0 |
| `@backstage/plugin-scaffolder-node` | 0.2.10 | 0.3.2 |
...
| `@backstage/plugin-search-backend-module-catalog` | 0.1.13 | 0.1.16 |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.3.12 | 1.3.15 |
| `@backstage/plugin-search-backend-module-explore` | 0.1.13 | 0.1.16 |
| `@backstage/plugin-search-backend-module-pg` | 0.5.18 | 0.5.21 |
| `@backstage/plugin-search-backend-module-stack-overflow-collator` | 0.1.2 | 0.1.5 |
| `@backstage/plugin-search-backend-module-techdocs` | 0.1.13 | 0.1.16 |
...
| `@backstage/plugin-sonarqube-backend` | 0.2.11 | 0.2.14 |
...
| `@backstage/plugin-stack-overflow-backend` | 0.2.13 | 0.2.16 |
| `@backstage/plugin-stackstorm` | 0.1.10 | 0.1.11 |
| `@backstage/plugin-tech-insights` | 0.3.21 | 0.3.22 |
| `@backstage/plugin-tech-insights-backend` | 0.5.23 | 0.5.26 |
| `@backstage/plugin-tech-insights-backend-module-jsonfc` | 0.1.41 | 0.1.44 |
| `@backstage/plugin-tech-insights-node` | 0.4.15 | 0.4.18 |
...
| `@backstage/plugin-techdocs-node` | 1.11.1 | 1.11.4 |
| `@backstage/plugin-techdocs-react` | 1.1.15 | 1.1.16 |
| `@backstage/plugin-todo` | 0.2.33 | 0.2.34 |
| `@backstage/plugin-todo-backend` | 0.3.7 | 0.3.10 |
| `@backstage/plugin-user-settings` | 0.8.0 | 0.8.1 |
| `@backstage/plugin-user-settings-backend` | 0.2.8 | 0.2.11 |
| `@backstage/plugin-vault` | 0.1.24 | 0.1.25 |
| `@backstage/plugin-vault-backend` | 0.4.2 | 0.4.5 |
| `@backstage/plugin-vault-node` | 0.1.2 | 0.1.5 |
| `@backstage/plugin-xcmetrics` | 0.2.47 | 0.2.48 |
| `@backstage/repo-tools` | 0.5.2 | 0.6.2 |
| `@backstage/test-utils` | 1.4.7 | 1.5.0 |
| `@backstage/theme` | 0.5.0 | 0.5.1 |
| `@techdocs/cli` | 1.8.1 | 1.8.4 |
