# Backstage Release 1.35.1

## Compared to 1.35.0 (previous patch release)

0 major bumps, 0 added, 0 removed, 4 upgraded, 174 unchanged.

### Version bumps

| Package | 1.35.0 | 1.35.1 | Type |
| --- | --- | --- | --- |
| `@backstage/cli` | 0.29.5 | 0.29.6 | Patch |
| `@backstage/plugin-scaffolder` | 1.27.4 | 1.27.5 | Patch |
| `@backstage/plugin-scaffolder-react` | 1.14.3 | 1.14.4 | Patch |
| `@backstage/plugin-techdocs` | 1.12.1 | 1.12.2 | Patch |
...
| `@backstage/cli` | 0.29.4 | 0.29.6 | Patch |
...
| `@backstage/plugin-scaffolder` | 1.27.3 | 1.27.5 | Patch |
...
| `@backstage/plugin-scaffolder-react` | 1.14.2 | 1.14.4 | Patch |
...
| `@backstage/plugin-techdocs` | 1.12.0 | 1.12.2 | Patch |
