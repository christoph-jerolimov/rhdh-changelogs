...
0 major bumps, 0 added, 0 removed, 62 upgraded, 179 unchanged.

### Version bumps

| Package | 1.20.2 | 1.20.3 |
| --- | --- | --- |
...
1 major bumps, 3 added, 0 removed, 220 upgraded, 17 unchanged.
...
| `@backstage/dev-utils` | 1.0.22 | 1.0.24 |
...
| `@backstage/plugin-api-docs` | 0.9.12 | 0.10.1 |
...
| `@backstage/plugin-catalog-graph` | 0.2.37 | 0.3.1 |
| `@backstage/plugin-catalog-graphql` | 0.4.0 | 0.4.1 |
| `@backstage/plugin-catalog-import` | 0.10.1 | 0.10.3 |
| `@backstage/plugin-catalog-node` | 1.4.7 | 1.5.0 |
| `@backstage/plugin-catalog-react` | 1.8.5 | 1.9.1 |
| `@backstage/plugin-catalog-unprocessed-entities` | 0.1.4 | 0.1.5 |
| `@backstage/plugin-cicd-statistics` | 0.1.27 | 0.1.29 |
| `@backstage/plugin-cicd-statistics-module-gitlab` | 0.1.21 | 0.1.23 |
| `@backstage/plugin-circleci` | 0.3.25 | 0.3.27 |
| `@backstage/plugin-cloudbuild` | 0.3.25 | 0.3.27 |
| `@backstage/plugin-code-climate` | 0.1.25 | 0.1.27 |
| `@backstage/plugin-code-coverage` | 0.2.18 | 0.2.20 |
...
| `@backstage/plugin-cost-insights` | 0.12.14 | 0.12.16 |
...
| `@backstage/plugin-entity-feedback` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-entity-feedback-backend` | 0.2.3 | 0.2.4 |
| `@backstage/plugin-entity-validation` | 0.1.10 | 0.1.12 |
...
| `@backstage/plugin-explore` | 0.4.11 | 0.4.13 |
| `@backstage/plugin-explore-backend` | 0.0.16 | 0.0.17 |
| `@backstage/plugin-explore-react` | 0.0.32 | 0.0.33 |
| `@backstage/plugin-firehydrant` | 0.2.9 | 0.2.11 |
| `@backstage/plugin-fossa` | 0.2.57 | 0.2.59 |
...
| `@backstage/plugin-github-actions` | 0.6.6 | 0.6.8 |
| `@backstage/plugin-github-deployments` | 0.1.56 | 0.1.58 |
| `@backstage/plugin-github-issues` | 0.2.14 | 0.2.16 |
| `@backstage/plugin-github-pull-requests-board` | 0.1.19 | 0.1.21 |
| `@backstage/plugin-gitops-profiles` | 0.3.41 | 0.3.42 |
| `@backstage/plugin-gocd` | 0.1.31 | 0.1.33 |
...
| `@backstage/plugin-home` | 0.5.9 | 0.5.11 |
| `@backstage/plugin-home-react` | 0.1.4 | 0.1.5 |
| `@backstage/plugin-ilert` | 0.2.14 | 0.2.16 |
| `@backstage/plugin-jenkins` | 0.9.0 | 0.9.2 |
| `@backstage/plugin-jenkins-backend` | 0.3.0 | 0.3.1 |
| `@backstage/plugin-jenkins-common` | 0.1.20 | 0.1.21 |
| `@backstage/plugin-kafka` | 0.3.25 | 0.3.27 |
| `@backstage/plugin-kafka-backend` | 0.3.4 | 0.3.5 |
| `@backstage/plugin-kubernetes` | 0.11.0 | 0.11.2 |
| `@backstage/plugin-kubernetes-backend` | 0.13.0 | 0.13.1 |
| `@backstage/plugin-kubernetes-cluster` | 0.0.1 | 0.0.3 |
...
| `@backstage/plugin-lighthouse` | 0.4.10 | 0.4.12 |
| `@backstage/plugin-lighthouse-backend` | 0.3.3 | 0.3.4 |
| `@backstage/plugin-linguist` | 0.1.10 | 0.1.12 |
...
| `@backstage/plugin-newrelic-dashboard` | 0.3.0 | 0.3.2 |
| `@backstage/plugin-nomad` | 0.1.6 | 0.1.8 |
| `@backstage/plugin-nomad-backend` | 0.1.8 | 0.1.9 |
| `@backstage/plugin-octopus-deploy` | 0.2.7 | 0.2.9 |
| `@backstage/plugin-opencost` | 0.2.1 | 0.2.2 |
| `@backstage/plugin-org` | 0.6.15 | 0.6.17 |
| `@backstage/plugin-org-react` | 0.1.14 | 0.1.16 |
| `@backstage/plugin-pagerduty` | 0.6.6 | 0.6.8 |
| `@backstage/plugin-periskop` | 0.1.23 | 0.1.25 |
...
| `@backstage/plugin-playlist` | 0.1.17 | 0.2.1 |
...
| `@backstage/plugin-puppetdb` | 0.1.8 | 0.1.10 |
| `@backstage/plugin-rollbar` | 0.4.25 | 0.4.27 |
| `@backstage/plugin-rollbar-backend` | 0.1.51 | 0.1.52 |
| `@backstage/plugin-scaffolder` | 1.15.1 | 1.16.1 |
| `@backstage/plugin-scaffolder-backend` | 1.18.1 | 1.19.1 |
...
| `@backstage/plugin-scaffolder-react` | 1.5.6 | 1.6.1 |
| `@backstage/plugin-search` | 1.4.1 | 1.4.3 |
...
| `@backstage/plugin-search-react` | 1.7.1 | 1.7.3 |
| `@backstage/plugin-sentry` | 0.5.10 | 0.5.12 |
| `@backstage/plugin-shortcuts` | 0.3.15 | 0.3.16 |
| `@backstage/plugin-sonarqube` | 0.7.7 | 0.7.9 |
| `@backstage/plugin-sonarqube-backend` | 0.2.8 | 0.2.9 |
| `@backstage/plugin-sonarqube-react` | 0.1.9 | 0.1.10 |
| `@backstage/plugin-splunk-on-call` | 0.4.14 | 0.4.16 |
...
| `@backstage/plugin-tech-insights` | 0.3.17 | 0.3.19 |
...
| `@backstage/plugin-techdocs` | 1.8.0 | 1.9.1 |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.22 | 1.0.24 |
...
| `@backstage/plugin-todo` | 0.2.29 | 0.2.31 |
| `@backstage/plugin-todo-backend` | 0.3.4 | 0.3.5 |
| `@backstage/plugin-user-settings` | 0.7.11 | 0.7.13 |
| `@backstage/plugin-user-settings-backend` | 0.2.5 | 0.2.6 |
| `@backstage/plugin-vault` | 0.1.20 | 0.1.22 |
