...
| Package | 1.41.1 | 1.41.2 |
| --- | --- | --- |
| `@backstage/plugin-scaffolder-backend` | 2.1.0 | 2.1.1 |

## Compared to 1.40.2 (previous minor release)

1 major bumps, 1 added, 0 removed, 173 upgraded, 13 unchanged.
...
| `@backstage/plugin-scaffolder-backend` | 2.0.0 | 2.1.1 |
