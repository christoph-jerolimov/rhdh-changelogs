# Backstage Release 1.33.6

## Compared to 1.33.5 (previous patch release)

0 added, 0 removed, 1 upgraded, 176 unchanged.

### Version bumps

| Package | 1.33.5 | 1.33.6 | Type |
| --- | --- | --- | --- |
...
| `@backstage/cli` | 0.28.2 | 0.29.3 | Minor ⚠️ |
