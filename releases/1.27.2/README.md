...
0 added, 0 removed, 7 upgraded, 163 unchanged.

### Version bumps

| Package | 1.27.1 | 1.27.2 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-app-api` | 0.7.4 | 0.7.5 | Patch |
...
3 added, 103 removed, 145 upgraded (⚠️ need extra attention: 5 0.x minor, 3 0.0.x patch), 22 unchanged.
