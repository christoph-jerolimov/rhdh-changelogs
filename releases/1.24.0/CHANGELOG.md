...
### `@backstage/plugin-auth-backend-module-guest-provider` (new, [0.1.0](../../changelogs/@backstage/plugin-auth-backend-module-guest-provider.md#010))
...
### `@backstage/plugin-auth-react` (new, [0.0.1](../../changelogs/@backstage/plugin-auth-react.md#001))
...
### `@backstage/plugin-scaffolder-node-test-utils` (new, [0.1.0](../../changelogs/@backstage/plugin-scaffolder-node-test-utils.md#010))
...
### `@backstage/backend-app-api` (0.5.14 → [0.6.0](../../changelogs/@backstage/backend-app-api.md#060))
...
### `@backstage/cli` (0.25.2 → [0.26.0](../../changelogs/@backstage/cli.md#0260))
...
### `@backstage/plugin-auth-backend` (0.21.3 → [0.22.0](../../changelogs/@backstage/plugin-auth-backend.md#0220))
...
### `@backstage/plugin-azure-devops` (0.3.12 → [0.4.0](../../changelogs/@backstage/plugin-azure-devops.md#040))
...
### `@backstage/plugin-azure-sites-backend` (0.2.3 → [0.3.0](../../changelogs/@backstage/plugin-azure-sites-backend.md#030))
...
### `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.1.28 → [0.2.0](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#020))
...
### `@backstage/plugin-catalog-backend-module-unprocessed` (0.3.10 → [0.4.0](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#040))
...
### `@backstage/plugin-catalog-unprocessed-entities` (0.1.8 → [0.2.0](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#020))
...
### `@backstage/plugin-devtools-backend` (0.2.10 → [0.3.0](../../changelogs/@backstage/plugin-devtools-backend.md#030))
...
### `@backstage/plugin-events-backend` (0.2.22 → [0.3.0](../../changelogs/@backstage/plugin-events-backend.md#030))
...
### `@backstage/plugin-events-backend-module-aws-sqs` (0.2.16 → [0.3.0](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#030))
...
### `@backstage/plugin-events-backend-module-azure` (0.1.23 → [0.2.0](../../changelogs/@backstage/plugin-events-backend-module-azure.md#020))
...
### `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.1.23 → [0.2.0](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#020))
...
### `@backstage/plugin-events-backend-module-gerrit` (0.1.23 → [0.2.0](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#020))
...
### `@backstage/plugin-events-backend-module-github` (0.1.23 → [0.2.0](../../changelogs/@backstage/plugin-events-backend-module-github.md#020))
...
### `@backstage/plugin-events-backend-module-gitlab` (0.1.23 → [0.2.0](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#020))
...
### `@backstage/plugin-events-node` (0.2.22 → [0.3.0](../../changelogs/@backstage/plugin-events-node.md#030))
...
### `@backstage/plugin-jenkins-backend` (0.3.7 → [0.4.0](../../changelogs/@backstage/plugin-jenkins-backend.md#040))
...
### `@backstage/plugin-kubernetes-backend` (0.15.3 → [0.16.0](../../changelogs/@backstage/plugin-kubernetes-backend.md#0160))
...
### `@backstage/plugin-lighthouse-backend` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-lighthouse-backend.md#046))
...
### `@backstage/plugin-notifications-backend` (0.0.4 → [0.1.0](../../changelogs/@backstage/plugin-notifications-backend.md#010))
...
### `@backstage/plugin-signals-backend` (0.0.4 → [0.1.0](../../changelogs/@backstage/plugin-signals-backend.md#010))
...
### `@backstage/plugin-signals-node` (0.0.4 → [0.1.0](../../changelogs/@backstage/plugin-signals-node.md#010))
...
### `@backstage/plugin-tech-insights-node` (0.4.19 → [0.5.0](../../changelogs/@backstage/plugin-tech-insights-node.md#050))
...
### `@backstage/plugin-dynatrace` (9.0.0 → [10.0.0](../../changelogs/@backstage/plugin-dynatrace.md#1000))
...
### `@backstage/plugin-azure-devops-backend` (0.5.5 → [0.6.0](../../changelogs/@backstage/plugin-azure-devops-backend.md#060))
...
### `@backstage/plugin-azure-devops-common` (0.3.2 → [0.4.0](../../changelogs/@backstage/plugin-azure-devops-common.md#040))
...
### `@backstage/plugin-home` (0.6.2 → [0.7.0](../../changelogs/@backstage/plugin-home.md#070))
...
### `@backstage/plugin-notifications` (0.0.1 → [0.1.0](../../changelogs/@backstage/plugin-notifications.md#010))
...
### `@backstage/plugin-notifications-node` (0.0.4 → [0.1.0](../../changelogs/@backstage/plugin-notifications-node.md#010))
...
### `@backstage/plugin-scaffolder-backend-module-gitlab` (0.2.16 → [0.3.0](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitlab.md#030))
...
### `@backstage/plugin-scaffolder-node` (0.3.3 → [0.4.0](../../changelogs/@backstage/plugin-scaffolder-node.md#040))
...
### `@backstage/plugin-tech-radar` (0.6.13 → [0.7.0](../../changelogs/@backstage/plugin-tech-radar.md#070))
...
### `@backstage/repo-tools` (0.6.3 → [0.7.0](../../changelogs/@backstage/repo-tools.md#070))
...
### `@backstage/plugin-notifications-common` (0.0.1 → [0.0.2](../../changelogs/@backstage/plugin-notifications-common.md#002))
...
### `@backstage/plugin-signals` (0.0.1 → [0.0.2](../../changelogs/@backstage/plugin-signals.md#002))
...
### `@backstage/backend-defaults` (0.2.13 → [0.2.14](../../changelogs/@backstage/backend-defaults.md#0214))
...
### `@backstage/backend-dynamic-feature-service` (0.2.3 → [0.2.4](../../changelogs/@backstage/backend-dynamic-feature-service.md#024))
...
### `@backstage/backend-openapi-utils` (0.1.6 → [0.1.7](../../changelogs/@backstage/backend-openapi-utils.md#017))
...
### `@backstage/backend-plugin-api` (0.6.13 → [0.6.14](../../changelogs/@backstage/backend-plugin-api.md#0614))
...
### `@backstage/backend-tasks` (0.5.18 → [0.5.19](../../changelogs/@backstage/backend-tasks.md#0519))
...
### `@backstage/backend-test-utils` (0.3.3 → [0.3.4](../../changelogs/@backstage/backend-test-utils.md#034))
...
### `@backstage/core-components` (0.14.0 → [0.14.1](../../changelogs/@backstage/core-components.md#0141))
...
### `@backstage/create-app` (0.5.11 → [0.5.12](../../changelogs/@backstage/create-app.md#0512))
...
### `@backstage/frontend-app-api` (0.6.0 → [0.6.1](../../changelogs/@backstage/frontend-app-api.md#061))
...
### `@backstage/plugin-adr-backend` (0.4.10 → [0.4.11](../../changelogs/@backstage/plugin-adr-backend.md#0411))
...
### `@backstage/plugin-adr-common` (0.2.20 → [0.2.21](../../changelogs/@backstage/plugin-adr-common.md#0221))
...
### `@backstage/plugin-airbrake` (0.3.30 → [0.3.31](../../changelogs/@backstage/plugin-airbrake.md#0331))
...
### `@backstage/plugin-airbrake-backend` (0.3.10 → [0.3.11](../../changelogs/@backstage/plugin-airbrake-backend.md#0311))
...
### `@backstage/plugin-apache-airflow` (0.2.20 → [0.2.21](../../changelogs/@backstage/plugin-apache-airflow.md#0221))
...
### `@backstage/plugin-api-docs` (0.11.0 → [0.11.1](../../changelogs/@backstage/plugin-api-docs.md#0111))
...
### `@backstage/plugin-apollo-explorer` (0.1.20 → [0.1.21](../../changelogs/@backstage/plugin-apollo-explorer.md#0121))
...
### `@backstage/plugin-app-backend` (0.3.61 → [0.3.62](../../changelogs/@backstage/plugin-app-backend.md#0362))
...
### `@backstage/plugin-auth-backend-module-atlassian-provider` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#016))
...
### `@backstage/plugin-auth-backend-module-aws-alb-provider` (0.1.4 → [0.1.5](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#015))
...
### `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.2.8 → [0.2.9](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#029))
...
### `@backstage/plugin-auth-backend-module-google-provider` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#0111))
...
### `@backstage/plugin-auth-backend-module-microsoft-provider` (0.1.8 → [0.1.9](../../changelogs/@backstage/plugin-auth-backend-module-microsoft-provider.md#019))
...
### `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#017))
...
### `@backstage/plugin-auth-backend-module-oidc-provider` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-auth-backend-module-oidc-provider.md#014))
...
### `@backstage/plugin-auth-backend-module-pinniped-provider` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#018))
...
### `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#016))
...
### `@backstage/plugin-auth-node` (0.4.8 → [0.4.9](../../changelogs/@backstage/plugin-auth-node.md#049))
...
### `@backstage/plugin-azure-sites` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-azure-sites.md#0120))
...
### `@backstage/plugin-badges` (0.2.54 → [0.2.55](../../changelogs/@backstage/plugin-badges.md#0255))
...
### `@backstage/plugin-badges-backend` (0.3.10 → [0.3.11](../../changelogs/@backstage/plugin-badges-backend.md#0311))
...
### `@backstage/plugin-bazaar` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-bazaar.md#0223))
...
### `@backstage/plugin-bitrise` (0.1.57 → [0.1.58](../../changelogs/@backstage/plugin-bitrise.md#0158))
...
### `@backstage/plugin-catalog-backend-module-aws` (0.3.7 → [0.3.8](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#038))
...
### `@backstage/plugin-catalog-backend-module-azure` (0.1.32 → [0.1.33](../../changelogs/@backstage/plugin-catalog-backend-module-azure.md#0133))
...
### `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#017))
...
### `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.1.26 → [0.1.27](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#0127))
...
### `@backstage/plugin-catalog-backend-module-gerrit` (0.1.29 → [0.1.30](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#0130))
...
### `@backstage/plugin-catalog-backend-module-github` (0.5.3 → [0.5.4](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#054))
...
### `@backstage/plugin-catalog-backend-module-github-org` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#018))
...
### `@backstage/plugin-catalog-backend-module-gitlab` (0.3.10 → [0.3.11](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#0311))
...
### `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.4.17 → [0.4.18](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#0418))
...
### `@backstage/plugin-catalog-backend-module-ldap` (0.5.28 → [0.5.29](../../changelogs/@backstage/plugin-catalog-backend-module-ldap.md#0529))
...
### `@backstage/plugin-catalog-backend-module-msgraph` (0.5.20 → [0.5.21](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph.md#0521))
...
### `@backstage/plugin-catalog-backend-module-puppetdb` (0.1.18 → [0.1.19](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#0119))
...
### `@backstage/plugin-catalog-graph` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-catalog-graph.md#041))
...
### `@backstage/plugin-catalog-import` (0.10.6 → [0.10.7](../../changelogs/@backstage/plugin-catalog-import.md#0107))
...
### `@backstage/plugin-cicd-statistics-module-gitlab` (0.1.26 → [0.1.27](../../changelogs/@backstage/plugin-cicd-statistics-module-gitlab.md#0127))
...
### `@backstage/plugin-circleci` (0.3.30 → [0.3.31](../../changelogs/@backstage/plugin-circleci.md#0331))
...
### `@backstage/plugin-cloudbuild` (0.4.0 → [0.4.1](../../changelogs/@backstage/plugin-cloudbuild.md#041))
...
### `@backstage/plugin-code-climate` (0.1.30 → [0.1.31](../../changelogs/@backstage/plugin-code-climate.md#0131))
...
### `@backstage/plugin-code-coverage` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-code-coverage.md#0224))
...
### `@backstage/plugin-code-coverage-backend` (0.2.27 → [0.2.28](../../changelogs/@backstage/plugin-code-coverage-backend.md#0228))
...
### `@backstage/plugin-codescene` (0.1.22 → [0.1.23](../../changelogs/@backstage/plugin-codescene.md#0123))
...
### `@backstage/plugin-cost-insights` (0.12.19 → [0.12.20](../../changelogs/@backstage/plugin-cost-insights.md#01220))
...
### `@backstage/plugin-devtools` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-devtools.md#0110))
...
### `@backstage/plugin-entity-feedback` (0.2.13 → [0.2.14](../../changelogs/@backstage/plugin-entity-feedback.md#0214))
...
### `@backstage/plugin-entity-feedback-backend` (0.2.10 → [0.2.11](../../changelogs/@backstage/plugin-entity-feedback-backend.md#0211))
...
### `@backstage/plugin-events-backend-test-utils` (0.1.23 → [0.1.24](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0124))
...
### `@backstage/plugin-explore` (0.4.16 → [0.4.17](../../changelogs/@backstage/plugin-explore.md#0417))
...
### `@backstage/plugin-fossa` (0.2.62 → [0.2.63](../../changelogs/@backstage/plugin-fossa.md#0263))
...
### `@backstage/plugin-gcalendar` (0.3.23 → [0.3.24](../../changelogs/@backstage/plugin-gcalendar.md#0324))
...
### `@backstage/plugin-github-actions` (0.6.11 → [0.6.12](../../changelogs/@backstage/plugin-github-actions.md#0612))
...
### `@backstage/plugin-github-pull-requests-board` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-github-pull-requests-board.md#0125))
...
### `@backstage/plugin-home-react` (0.1.8 → [0.1.9](../../changelogs/@backstage/plugin-home-react.md#019))
...
### `@backstage/plugin-jenkins` (0.9.5 → [0.9.6](../../changelogs/@backstage/plugin-jenkins.md#096))
...
### `@backstage/plugin-kafka` (0.3.30 → [0.3.31](../../changelogs/@backstage/plugin-kafka.md#0331))
...
### `@backstage/plugin-kubernetes` (0.11.5 → [0.11.6](../../changelogs/@backstage/plugin-kubernetes.md#0116))
...
### `@backstage/plugin-kubernetes-node` (0.1.7 → [0.1.8](../../changelogs/@backstage/plugin-kubernetes-node.md#018))
...
### `@backstage/plugin-kubernetes-react` (0.3.0 → [0.3.1](../../changelogs/@backstage/plugin-kubernetes-react.md#031))
...
### `@backstage/plugin-lighthouse` (0.4.15 → [0.4.16](../../changelogs/@backstage/plugin-lighthouse.md#0416))
...
### `@backstage/plugin-linguist` (0.1.15 → [0.1.16](../../changelogs/@backstage/plugin-linguist.md#0116))
...
### `@backstage/plugin-linguist-backend` (0.5.10 → [0.5.11](../../changelogs/@backstage/plugin-linguist-backend.md#0511))
...
### `@backstage/plugin-nomad-backend` (0.1.15 → [0.1.16](../../changelogs/@backstage/plugin-nomad-backend.md#0116))
...
### `@backstage/plugin-octopus-deploy` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-octopus-deploy.md#0213))
...
### `@backstage/plugin-org` (0.6.20 → [0.6.21](../../changelogs/@backstage/plugin-org.md#0621))
...
### `@backstage/plugin-periskop-backend` (0.2.11 → [0.2.12](../../changelogs/@backstage/plugin-periskop-backend.md#0212))
...
### `@backstage/plugin-permission-backend` (0.5.36 → [0.5.37](../../changelogs/@backstage/plugin-permission-backend.md#0537))
...
### `@backstage/plugin-permission-node` (0.7.24 → [0.7.25](../../changelogs/@backstage/plugin-permission-node.md#0725))
...
### `@backstage/plugin-playlist` (0.2.4 → [0.2.5](../../changelogs/@backstage/plugin-playlist.md#025))
...
### `@backstage/plugin-playlist-backend` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-playlist-backend.md#0318))
...
### `@backstage/plugin-proxy-backend` (0.4.11 → [0.4.12](../../changelogs/@backstage/plugin-proxy-backend.md#0412))
...
### `@backstage/plugin-rollbar` (0.4.30 → [0.4.31](../../changelogs/@backstage/plugin-rollbar.md#0431))
...
### `@backstage/plugin-scaffolder-backend-module-azure` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-scaffolder-backend-module-azure.md#016))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket` (0.2.3 → [0.2.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket.md#024))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-cloud.md#014))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-server` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-server.md#014))
...
### `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.2.14 → [0.2.15](../../changelogs/@backstage/plugin-scaffolder-backend-module-confluence-to-markdown.md#0215))
...
### `@backstage/plugin-scaffolder-backend-module-cookiecutter` (0.2.37 → [0.2.38](../../changelogs/@backstage/plugin-scaffolder-backend-module-cookiecutter.md#0238))
...
### `@backstage/plugin-scaffolder-backend-module-gerrit` (0.1.5 → [0.1.6](../../changelogs/@backstage/plugin-scaffolder-backend-module-gerrit.md#016))
...
### `@backstage/plugin-scaffolder-backend-module-gitea` (0.1.3 → [0.1.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitea.md#014))
...
### `@backstage/plugin-scaffolder-backend-module-github` (0.2.3 → [0.2.4](../../changelogs/@backstage/plugin-scaffolder-backend-module-github.md#024))
...
### `@backstage/plugin-scaffolder-backend-module-rails` (0.4.30 → [0.4.31](../../changelogs/@backstage/plugin-scaffolder-backend-module-rails.md#0431))
...
### `@backstage/plugin-scaffolder-backend-module-sentry` (0.1.21 → [0.1.22](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#0122))
...
### `@backstage/plugin-scaffolder-backend-module-yeoman` (0.2.34 → [0.2.35](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#0235))
...
### `@backstage/plugin-search-backend-module-pg` (0.5.22 → [0.5.23](../../changelogs/@backstage/plugin-search-backend-module-pg.md#0523))
...
### `@backstage/plugin-search-backend-module-techdocs` (0.1.17 → [0.1.18](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#0118))
...
### `@backstage/plugin-shortcuts` (0.3.19 → [0.3.20](../../changelogs/@backstage/plugin-shortcuts.md#0320))
...
### `@backstage/plugin-sonarqube` (0.7.12 → [0.7.13](../../changelogs/@backstage/plugin-sonarqube.md#0713))
...
### `@backstage/plugin-splunk-on-call` (0.4.19 → [0.4.20](../../changelogs/@backstage/plugin-splunk-on-call.md#0420))
...
### `@backstage/plugin-stack-overflow` (0.1.25 → [0.1.26](../../changelogs/@backstage/plugin-stack-overflow.md#0126))
...
### `@backstage/plugin-stackstorm` (0.1.11 → [0.1.12](../../changelogs/@backstage/plugin-stackstorm.md#0112))
...
### `@backstage/plugin-tech-insights` (0.3.22 → [0.3.23](../../changelogs/@backstage/plugin-tech-insights.md#0323))
...
### `@backstage/plugin-tech-insights-backend` (0.5.27 → [0.5.28](../../changelogs/@backstage/plugin-tech-insights-backend.md#0528))
...
### `@backstage/plugin-tech-insights-backend-module-jsonfc` (0.1.45 → [0.1.46](../../changelogs/@backstage/plugin-tech-insights-backend-module-jsonfc.md#0146))
...
### `@backstage/plugin-user-settings` (0.8.1 → [0.8.2](../../changelogs/@backstage/plugin-user-settings.md#082))
...
### `@backstage/plugin-vault` (0.1.25 → [0.1.26](../../changelogs/@backstage/plugin-vault.md#0126))
...
### `@backstage/plugin-vault-backend` (0.4.6 → [0.4.7](../../changelogs/@backstage/plugin-vault-backend.md#047))
...
### `@backstage/plugin-xcmetrics` (0.2.48 → [0.2.49](../../changelogs/@backstage/plugin-xcmetrics.md#0249))
...
### `@backstage/theme` (0.5.1 → [0.5.2](../../changelogs/@backstage/theme.md#052))
...
- `@backstage/app-defaults` (1.5.0 → [1.5.1](../../changelogs/@backstage/app-defaults.md#151))
- `@backstage/catalog-model` (1.4.4 → [1.4.5](../../changelogs/@backstage/catalog-model.md#145))
- `@backstage/cli-node` (0.2.3 → [0.2.4](../../changelogs/@backstage/cli-node.md#024))
- `@backstage/core-app-api` (1.12.0 → [1.12.1](../../changelogs/@backstage/core-app-api.md#1121))
- `@backstage/core-compat-api` (0.2.0 → [0.2.1](../../changelogs/@backstage/core-compat-api.md#021))
- `@backstage/core-plugin-api` (1.9.0 → [1.9.1](../../changelogs/@backstage/core-plugin-api.md#191))
- `@backstage/dev-utils` (1.0.27 → [1.0.28](../../changelogs/@backstage/dev-utils.md#1028))
- `@backstage/frontend-plugin-api` (0.6.0 → [0.6.1](../../changelogs/@backstage/frontend-plugin-api.md#061))
- `@backstage/frontend-test-utils` (0.1.2 → [0.1.3](../../changelogs/@backstage/frontend-test-utils.md#013))
- `@backstage/integration-aws-node` (0.1.9 → [0.1.10](../../changelogs/@backstage/integration-aws-node.md#0110))
- `@backstage/plugin-allure` (0.1.46 → [0.1.47](../../changelogs/@backstage/plugin-allure.md#0147))
- `@backstage/plugin-analytics-module-ga` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-analytics-module-ga.md#021))
- `@backstage/plugin-analytics-module-ga4` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-analytics-module-ga4.md#021))
- `@backstage/plugin-analytics-module-newrelic-browser` (0.1.0 → [0.1.1](../../changelogs/@backstage/plugin-analytics-module-newrelic-browser.md#011))
- `@backstage/plugin-app-node` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-app-node.md#0114))
- `@backstage/plugin-app-visualizer` (0.1.1 → [0.1.2](../../changelogs/@backstage/plugin-app-visualizer.md#012))
- `@backstage/plugin-auth-backend-module-github-provider` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#0111))
- `@backstage/plugin-auth-backend-module-gitlab-provider` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#0111))
- `@backstage/plugin-auth-backend-module-oauth2-provider` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-provider.md#0111))
- `@backstage/plugin-auth-backend-module-okta-provider` (0.0.6 → [0.0.7](../../changelogs/@backstage/plugin-auth-backend-module-okta-provider.md#007))
- `@backstage/plugin-azure-sites-common` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-azure-sites-common.md#013))
- `@backstage/plugin-bazaar-backend` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-bazaar-backend.md#0312))
- `@backstage/plugin-bitbucket-cloud-common` (0.2.16 → [0.2.17](../../changelogs/@backstage/plugin-bitbucket-cloud-common.md#0217))
- `@backstage/plugin-catalog-backend-module-gcp` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#0114))
- `@backstage/plugin-catalog-backend-module-openapi` (0.1.30 → [0.1.31](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#0131))
- `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#0111))
- `@backstage/plugin-catalog-common` (1.0.21 → [1.0.22](../../changelogs/@backstage/plugin-catalog-common.md#1022))
- `@backstage/plugin-cicd-statistics` (0.1.32 → [0.1.33](../../changelogs/@backstage/plugin-cicd-statistics.md#0133))
- `@backstage/plugin-config-schema` (0.1.50 → [0.1.51](../../changelogs/@backstage/plugin-config-schema.md#0151))
- `@backstage/plugin-devtools-common` (0.1.8 → [0.1.9](../../changelogs/@backstage/plugin-devtools-common.md#019))
- `@backstage/plugin-entity-validation` (0.1.15 → [0.1.16](../../changelogs/@backstage/plugin-entity-validation.md#0116))
- `@backstage/plugin-explore-backend` (0.0.23 → [0.0.24](../../changelogs/@backstage/plugin-explore-backend.md#0024))
- `@backstage/plugin-explore-react` (0.0.36 → [0.0.37](../../changelogs/@backstage/plugin-explore-react.md#0037))
- `@backstage/plugin-firehydrant` (0.2.14 → [0.2.15](../../changelogs/@backstage/plugin-firehydrant.md#0215))
- `@backstage/plugin-gcp-projects` (0.3.46 → [0.3.47](../../changelogs/@backstage/plugin-gcp-projects.md#0347))
- `@backstage/plugin-git-release-manager` (0.3.42 → [0.3.43](../../changelogs/@backstage/plugin-git-release-manager.md#0343))
- `@backstage/plugin-github-deployments` (0.1.61 → [0.1.62](../../changelogs/@backstage/plugin-github-deployments.md#0162))
- `@backstage/plugin-github-issues` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-github-issues.md#0220))
- `@backstage/plugin-gitops-profiles` (0.3.45 → [0.3.46](../../changelogs/@backstage/plugin-gitops-profiles.md#0346))
- `@backstage/plugin-gocd` (0.1.36 → [0.1.37](../../changelogs/@backstage/plugin-gocd.md#0137))
- `@backstage/plugin-graphiql` (0.3.3 → [0.3.4](../../changelogs/@backstage/plugin-graphiql.md#034))
- `@backstage/plugin-graphql-voyager` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-graphql-voyager.md#0113))
- `@backstage/plugin-ilert` (0.2.19 → [0.2.20](../../changelogs/@backstage/plugin-ilert.md#0220))
- `@backstage/plugin-jenkins-common` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-jenkins-common.md#0125))
- `@backstage/plugin-kafka-backend` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-kafka-backend.md#0312))
- `@backstage/plugin-kubernetes-cluster` (0.0.6 → [0.0.7](../../changelogs/@backstage/plugin-kubernetes-cluster.md#007))
- `@backstage/plugin-lighthouse-common` (0.1.4 → [0.1.5](../../changelogs/@backstage/plugin-lighthouse-common.md#015))
- `@backstage/plugin-microsoft-calendar` (0.1.12 → [0.1.13](../../changelogs/@backstage/plugin-microsoft-calendar.md#0113))
- `@backstage/plugin-newrelic` (0.3.45 → [0.3.46](../../changelogs/@backstage/plugin-newrelic.md#0346))
- `@backstage/plugin-newrelic-dashboard` (0.3.5 → [0.3.6](../../changelogs/@backstage/plugin-newrelic-dashboard.md#036))
- `@backstage/plugin-nomad` (0.1.11 → [0.1.12](../../changelogs/@backstage/plugin-nomad.md#0112))
- `@backstage/plugin-opencost` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-opencost.md#026))
- `@backstage/plugin-org-react` (0.1.19 → [0.1.20](../../changelogs/@backstage/plugin-org-react.md#0120))
- `@backstage/plugin-pagerduty` (0.7.2 → [0.7.3](../../changelogs/@backstage/plugin-pagerduty.md#073))
- `@backstage/plugin-periskop` (0.1.28 → [0.1.29](../../changelogs/@backstage/plugin-periskop.md#0129))
- `@backstage/plugin-permission-backend-module-allow-all-policy` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#0111))
- `@backstage/plugin-permission-react` (0.4.20 → [0.4.21](../../changelogs/@backstage/plugin-permission-react.md#0421))
- `@backstage/plugin-playlist-common` (0.1.14 → [0.1.15](../../changelogs/@backstage/plugin-playlist-common.md#0115))
- `@backstage/plugin-puppetdb` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-puppetdb.md#0114))
- `@backstage/plugin-rollbar-backend` (0.1.58 → [0.1.59](../../changelogs/@backstage/plugin-rollbar-backend.md#0159))
- `@backstage/plugin-scaffolder-common` (1.5.0 → [1.5.1](../../changelogs/@backstage/plugin-scaffolder-common.md#151))
- `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#017))
- `@backstage/plugin-search-react` (1.7.6 → [1.7.7](../../changelogs/@backstage/plugin-search-react.md#177))
- `@backstage/plugin-signals-react` (0.0.1 → [0.0.2](../../changelogs/@backstage/plugin-signals-react.md#002))
- `@backstage/plugin-sonarqube-backend` (0.2.15 → [0.2.16](../../changelogs/@backstage/plugin-sonarqube-backend.md#0216))
- `@backstage/plugin-sonarqube-react` (0.1.13 → [0.1.14](../../changelogs/@backstage/plugin-sonarqube-react.md#0114))
- `@backstage/plugin-stack-overflow-backend` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-stack-overflow-backend.md#0218))
- `@backstage/plugin-techdocs-module-addons-contrib` (1.1.5 → [1.1.6](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#116))
- `@backstage/plugin-todo` (0.2.34 → [0.2.35](../../changelogs/@backstage/plugin-todo.md#0235))
- `@backstage/plugin-user-settings-backend` (0.2.12 → [0.2.13](../../changelogs/@backstage/plugin-user-settings-backend.md#0213))
- `@backstage/plugin-vault-node` (0.1.6 → [0.1.7](../../changelogs/@backstage/plugin-vault-node.md#017))
- `@backstage/test-utils` (1.5.0 → [1.5.1](../../changelogs/@backstage/test-utils.md#151))
