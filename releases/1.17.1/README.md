...
| `@backstage/plugin-api-docs` | 0.9.6 | 0.9.8 |
...
| `@backstage/plugin-bazaar` | 0.2.11 | 0.2.13 |
...
| `@backstage/plugin-catalog` | 1.12.0 | 1.12.2 |
...
| `@backstage/plugin-scaffolder-backend` | 1.15.1 | 1.16.1 |
...
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.16 | 1.0.18 |
