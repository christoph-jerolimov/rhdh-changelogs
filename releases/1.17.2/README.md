...
| Package | 1.16.0 | 1.17.2 |
| --- | --- | --- |
| `@backstage/app-defaults` | 1.4.1 | 1.4.2 |
| `@backstage/backend-app-api` | 0.4.5 | 0.5.1 |
| `@backstage/backend-common` | 0.19.1 | 0.19.3 |
| `@backstage/backend-defaults` | 0.1.12 | 0.2.1 |
| `@backstage/backend-openapi-utils` | 0.0.2 | 0.0.3 |
| `@backstage/backend-plugin-api` | 0.5.4 | 0.6.1 |
| `@backstage/backend-tasks` | 0.5.4 | 0.5.6 |
| `@backstage/backend-test-utils` | 0.1.39 | 0.2.1 |
| `@backstage/cli` | 0.22.9 | 0.22.11 |
...
| `@backstage/dev-utils` | 1.0.17 | 1.0.19 |
| `@backstage/integration` | 1.5.1 | 1.6.1 |
| `@backstage/integration-react` | 1.1.15 | 1.1.17 |
| `@backstage/plugin-adr` | 0.6.3 | 0.6.5 |
| `@backstage/plugin-adr-backend` | 0.3.5 | 0.3.7 |
| `@backstage/plugin-adr-common` | 0.2.11 | 0.2.13 |
| `@backstage/plugin-airbrake` | 0.3.20 | 0.3.22 |
| `@backstage/plugin-airbrake-backend` | 0.2.20 | 0.2.22 |
| `@backstage/plugin-allure` | 0.1.36 | 0.1.38 |
...
| `@backstage/plugin-api-docs` | 0.9.6 | 0.9.9 |
| `@backstage/plugin-apollo-explorer` | 0.1.13 | 0.1.14 |
| `@backstage/plugin-app-backend` | 0.3.47 | 0.3.49 |
| `@backstage/plugin-auth-backend` | 0.18.5 | 0.18.7 |
| `@backstage/plugin-auth-node` | 0.2.16 | 0.2.18 |
| `@backstage/plugin-azure-devops` | 0.3.2 | 0.3.4 |
| `@backstage/plugin-azure-devops-backend` | 0.3.26 | 0.3.28 |
| `@backstage/plugin-azure-sites` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-azure-sites-backend` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-badges` | 0.2.44 | 0.2.46 |
| `@backstage/plugin-badges-backend` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-bazaar` | 0.2.11 | 0.2.14 |
| `@backstage/plugin-bazaar-backend` | 0.2.10 | 0.2.12 |
| `@backstage/plugin-bitbucket-cloud-common` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-bitrise` | 0.1.47 | 0.1.49 |
| `@backstage/plugin-catalog` | 1.12.0 | 1.12.3 |
| `@backstage/plugin-catalog-backend` | 1.11.0 | 1.12.1 |
| `@backstage/plugin-catalog-backend-module-aws` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.18 | 0.1.20 |
| `@backstage/plugin-catalog-backend-module-bitbucket` | 0.2.14 | 0.2.16 |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.1.14 | 0.1.16 |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.15 | 0.1.17 |
| `@backstage/plugin-catalog-backend-module-github` | 0.3.2 | 0.3.4 |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.0 | 0.4.2 |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.5.14 | 0.5.16 |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.6 | 0.5.8 |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.13 | 0.1.15 |
| `@backstage/plugin-catalog-backend-module-puppetdb` | 0.1.4 | 0.1.6 |
| `@backstage/plugin-catalog-backend-module-unprocessed` | 0.1.1 | 0.2.1 |
| `@backstage/plugin-catalog-graph` | 0.2.32 | 0.2.34 |
| `@backstage/plugin-catalog-import` | 0.9.10 | 0.9.12 |
| `@backstage/plugin-catalog-node` | 1.4.0 | 1.4.2 |
| `@backstage/plugin-catalog-react` | 1.8.0 | 1.8.2 |
| `@backstage/plugin-catalog-unprocessed-entities` | 0.1.1 | 0.1.2 |
| `@backstage/plugin-cicd-statistics` | 0.1.22 | 0.1.24 |
| `@backstage/plugin-cicd-statistics-module-gitlab` | 0.1.16 | 0.1.18 |
| `@backstage/plugin-circleci` | 0.3.20 | 0.3.22 |
| `@backstage/plugin-cloudbuild` | 0.3.20 | 0.3.22 |
| `@backstage/plugin-code-climate` | 0.1.20 | 0.1.22 |
| `@backstage/plugin-code-coverage` | 0.2.13 | 0.2.15 |
| `@backstage/plugin-code-coverage-backend` | 0.2.13 | 0.2.15 |
| `@backstage/plugin-codescene` | 0.1.15 | 0.1.16 |
| `@backstage/plugin-config-schema` | 0.1.43 | 0.1.44 |
| `@backstage/plugin-cost-insights` | 0.12.9 | 0.12.11 |
| `@backstage/plugin-devtools` | 0.1.2 | 0.1.3 |
| `@backstage/plugin-devtools-backend` | 0.1.2 | 0.1.4 |
| `@backstage/plugin-devtools-common` | 0.1.2 | 0.1.3 |
| `@backstage/plugin-dynatrace` | 7.0.0 | 7.0.2 |
| `@backstage/plugin-entity-feedback` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-entity-feedback-backend` | 0.1.5 | 0.1.7 |
| `@backstage/plugin-entity-feedback-common` | 0.1.1 | 0.1.2 |
| `@backstage/plugin-entity-validation` | 0.1.5 | 0.1.7 |
| `@backstage/plugin-events-backend` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-events-backend-module-azure` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-events-backend-module-gerrit` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-events-backend-module-github` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-events-backend-module-gitlab` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-events-backend-test-utils` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-events-node` | 0.2.8 | 0.2.10 |
| `@backstage/plugin-explore` | 0.4.6 | 0.4.8 |
| `@backstage/plugin-explore-backend` | 0.0.9 | 0.0.11 |
| `@backstage/plugin-firehydrant` | 0.2.4 | 0.2.6 |
| `@backstage/plugin-fossa` | 0.2.52 | 0.2.54 |
| `@backstage/plugin-gcalendar` | 0.3.16 | 0.3.17 |
| `@backstage/plugin-gcp-projects` | 0.3.39 | 0.3.40 |
| `@backstage/plugin-git-release-manager` | 0.3.33 | 0.3.35 |
| `@backstage/plugin-github-actions` | 0.6.1 | 0.6.3 |
| `@backstage/plugin-github-deployments` | 0.1.51 | 0.1.53 |
| `@backstage/plugin-github-issues` | 0.2.9 | 0.2.11 |
| `@backstage/plugin-github-pull-requests-board` | 0.1.14 | 0.1.16 |
| `@backstage/plugin-gitops-profiles` | 0.3.38 | 0.3.39 |
| `@backstage/plugin-gocd` | 0.1.26 | 0.1.28 |
| `@backstage/plugin-graphiql` | 0.2.52 | 0.2.53 |
| `@backstage/plugin-graphql-backend` | 0.1.37 | 0.1.39 |
| `@backstage/plugin-graphql-voyager` | 0.1.5 | 0.1.6 |
| `@backstage/plugin-home` | 0.5.4 | 0.5.6 |
| `@backstage/plugin-home-react` | 0.1.1 | 0.1.2 |
| `@backstage/plugin-ilert` | 0.2.9 | 0.2.11 |
| `@backstage/plugin-jenkins` | 0.8.2 | 0.8.4 |
| `@backstage/plugin-jenkins-backend` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-jenkins-common` | 0.1.17 | 0.1.18 |
| `@backstage/plugin-kafka` | 0.3.20 | 0.3.22 |
| `@backstage/plugin-kafka-backend` | 0.2.40 | 0.2.42 |
| `@backstage/plugin-kubernetes` | 0.9.3 | 0.10.1 |
| `@backstage/plugin-kubernetes-backend` | 0.11.2 | 0.11.4 |
| `@backstage/plugin-lighthouse` | 0.4.5 | 0.4.7 |
| `@backstage/plugin-lighthouse-backend` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-linguist` | 0.1.5 | 0.1.7 |
| `@backstage/plugin-linguist-backend` | 0.3.1 | 0.4.1 |
...
| `@backstage/plugin-newrelic-dashboard` | 0.2.13 | 0.2.15 |
| `@backstage/plugin-nomad` | 0.1.1 | 0.1.3 |
| `@backstage/plugin-nomad-backend` | 0.1.1 | 0.1.3 |
| `@backstage/plugin-octopus-deploy` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-org` | 0.6.10 | 0.6.12 |
| `@backstage/plugin-org-react` | 0.1.9 | 0.1.11 |
| `@backstage/plugin-pagerduty` | 0.6.1 | 0.6.3 |
| `@backstage/plugin-periskop` | 0.1.18 | 0.1.20 |
| `@backstage/plugin-periskop-backend` | 0.1.18 | 0.1.20 |
| `@backstage/plugin-permission-backend` | 0.5.22 | 0.5.24 |
| `@backstage/plugin-permission-node` | 0.7.10 | 0.7.12 |
| `@backstage/plugin-playlist` | 0.1.12 | 0.1.14 |
| `@backstage/plugin-playlist-backend` | 0.3.3 | 0.3.5 |
| `@backstage/plugin-playlist-common` | 0.1.8 | 0.1.9 |
| `@backstage/plugin-proxy-backend` | 0.2.41 | 0.3.1 |
| `@backstage/plugin-puppetdb` | 0.1.3 | 0.1.5 |
| `@backstage/plugin-rollbar` | 0.4.20 | 0.4.22 |
| `@backstage/plugin-rollbar-backend` | 0.1.44 | 0.1.46 |
| `@backstage/plugin-scaffolder` | 1.14.1 | 1.14.3 |
| `@backstage/plugin-scaffolder-backend` | 1.15.1 | 1.16.2 |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.0 | 0.2.2 |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.23 | 0.2.25 |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.2.2 | 0.2.4 |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.16 | 0.4.18 |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.7 | 0.1.9 |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.2.20 | 0.2.22 |
| `@backstage/plugin-scaffolder-common` | 1.3.2 | 1.4.0 |
| `@backstage/plugin-scaffolder-node` | 0.1.5 | 0.2.1 |
| `@backstage/plugin-scaffolder-react` | 1.5.1 | 1.5.3 |
| `@backstage/plugin-search` | 1.3.3 | 1.3.5 |
| `@backstage/plugin-search-backend` | 1.3.3 | 1.4.1 |
| `@backstage/plugin-search-backend-module-catalog` | 0.1.3 | 0.1.5 |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.3.2 | 1.3.4 |
| `@backstage/plugin-search-backend-module-explore` | 0.1.3 | 0.1.5 |
| `@backstage/plugin-search-backend-module-pg` | 0.5.8 | 0.5.10 |
| `@backstage/plugin-search-backend-module-techdocs` | 0.1.3 | 0.1.5 |
| `@backstage/plugin-search-backend-node` | 1.2.3 | 1.2.5 |
| `@backstage/plugin-search-react` | 1.6.3 | 1.6.4 |
| `@backstage/plugin-sentry` | 0.5.5 | 0.5.7 |
| `@backstage/plugin-shortcuts` | 0.3.12 | 0.3.13 |
| `@backstage/plugin-sonarqube` | 0.7.1 | 0.7.3 |
| `@backstage/plugin-sonarqube-backend` | 0.2.1 | 0.2.3 |
| `@backstage/plugin-splunk-on-call` | 0.4.9 | 0.4.11 |
| `@backstage/plugin-stack-overflow` | 0.1.18 | 0.1.19 |
| `@backstage/plugin-stack-overflow-backend` | 0.2.3 | 0.2.5 |
| `@backstage/plugin-stackstorm` | 0.1.4 | 0.1.5 |
| `@backstage/plugin-tech-insights` | 0.3.12 | 0.3.14 |
| `@backstage/plugin-tech-insights-backend` | 0.5.13 | 0.5.15 |
| `@backstage/plugin-tech-insights-backend-module-jsonfc` | 0.1.31 | 0.1.33 |
| `@backstage/plugin-tech-insights-node` | 0.4.5 | 0.4.7 |
| `@backstage/plugin-tech-radar` | 0.6.6 | 0.6.7 |
| `@backstage/plugin-techdocs` | 1.6.5 | 1.6.7 |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.16 | 1.0.19 |
| `@backstage/plugin-techdocs-backend` | 1.6.4 | 1.6.6 |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.0.15 | 1.0.17 |
| `@backstage/plugin-techdocs-node` | 1.7.3 | 1.7.5 |
| `@backstage/plugin-techdocs-react` | 1.1.8 | 1.1.9 |
| `@backstage/plugin-todo` | 0.2.22 | 0.2.24 |
| `@backstage/plugin-todo-backend` | 0.1.44 | 0.2.1 |
| `@backstage/plugin-user-settings` | 0.7.5 | 0.7.7 |
| `@backstage/plugin-user-settings-backend` | 0.1.11 | 0.1.13 |
| `@backstage/plugin-vault` | 0.1.14 | 0.1.16 |
| `@backstage/plugin-vault-backend` | 0.3.3 | 0.3.5 |
| `@backstage/plugin-xcmetrics` | 0.2.40 | 0.2.41 |
| `@backstage/repo-tools` | 0.3.2 | 0.3.3 |
| `@backstage/test-utils` | 1.4.1 | 1.4.2 |
| `@techdocs/cli` | 1.4.4 | 1.4.6 |
