...
| Package | 1.48.3 | 1.48.4 | Type |
| --- | --- | --- | --- |
| `@backstage/integration` | 1.20.0 | 1.20.1 | Patch |
| `@backstage/plugin-scaffolder-backend` | 3.1.3 | 3.1.4 | Patch |
| `@backstage/plugin-techdocs-node` | 1.14.2 | 1.14.3 | Patch |

## Compared to 1.48.0 (first release of this minor)

0 added, 0 removed, 10 upgraded, 184 unchanged.

### Version bumps

| Package | 1.48.0 | 1.48.4 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-scaffolder-backend` | 3.1.2 | 3.1.4 | Patch |
