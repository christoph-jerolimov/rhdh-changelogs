...
| Package | 1.48.5 | 1.48.6 | Type |
| --- | --- | --- | --- |
| `@backstage/ui` | 0.12.0 | 0.12.1 | Patch |

## Compared to 1.48.0 (first release of this minor)

0 added, 0 removed, 12 upgraded, 182 unchanged.

### Version bumps

| Package | 1.48.0 | 1.48.6 | Type |
| --- | --- | --- | --- |
...
| `@backstage/ui` | 0.11.3 | 0.12.1 | Minor ⚠️ |
