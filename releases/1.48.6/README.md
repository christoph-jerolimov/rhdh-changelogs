# Backstage Release 1.48.6

## Compared to 1.48.5 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 193 unchanged.

### Version bumps

| Package | 1.48.5 | 1.48.6 |
| --- | --- | --- |
| `@backstage/ui` | 0.12.0 | 0.12.1 |

## Compared to 1.47.4 (previous minor release)

2 major bumps, 2 added, 0 removed, 184 upgraded, 6 unchanged.

### ⚠️ Major version bumps

| Package | 1.47.4 | 1.48.6 |
| --- | --- | --- |
...
| `@backstage/integration` | 1.19.2 | 1.20.1 |
...
| `@backstage/plugin-auth-backend` | 0.26.0 | 0.27.1 |
...
| `@backstage/plugin-catalog` | 1.32.2 | 1.33.1 |
...
| `@backstage/plugin-scaffolder` | 1.35.2 | 1.35.4 |
| `@backstage/plugin-scaffolder-backend` | 3.1.2 | 3.1.5 |
...
| `@backstage/plugin-search` | 1.5.3 | 1.6.1 |
...
| `@backstage/plugin-search-react` | 1.10.2 | 1.10.4 |
...
| `@backstage/plugin-techdocs-node` | 1.14.1 | 1.14.3 |
