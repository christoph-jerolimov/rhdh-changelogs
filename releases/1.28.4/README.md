# Backstage Release 1.28.4

## Compared to 1.28.3 (previous patch release)
...
| --- | --- | --- | --- |
| `@backstage/plugin-search` | 1.4.12 | 1.4.13 | Patch |

## Compared to 1.28.0 (first release of this minor)

0 added, 0 removed, 113 upgraded, 59 unchanged.
...
| `@backstage/backend-app-api` | 0.7.6 | 0.7.9 | Patch |
| `@backstage/backend-common` | 0.23.0 | 0.23.2 | Patch |
| `@backstage/backend-defaults` | 0.3.0 | 0.3.3 | Patch |
| `@backstage/backend-dynamic-feature-service` | 0.2.11 | 0.2.14 | Patch |
| `@backstage/backend-openapi-utils` | 0.1.12 | 0.1.14 | Patch |
| `@backstage/backend-plugin-api` | 0.6.19 | 0.6.21 | Patch |
| `@backstage/backend-tasks` | 0.5.24 | 0.5.26 | Patch |
| `@backstage/backend-test-utils` | 0.4.0 | 0.4.3 | Patch |
| `@backstage/cli` | 0.26.7 | 0.26.10 | Patch |
...
| `@backstage/plugin-app-backend` | 0.3.68 | 0.3.70 | Patch |
| `@backstage/plugin-app-node` | 0.1.19 | 0.1.21 | Patch |
| `@backstage/plugin-auth-backend` | 0.22.6 | 0.22.8 | Patch |
| `@backstage/plugin-auth-backend-module-atlassian-provider` | 0.2.0 | 0.2.2 | Patch |
| `@backstage/plugin-auth-backend-module-aws-alb-provider` | 0.1.11 | 0.1.13 | Patch |
| `@backstage/plugin-auth-backend-module-azure-easyauth-provider` | 0.1.2 | 0.1.4 | Patch |
| `@backstage/plugin-auth-backend-module-bitbucket-provider` | 0.1.2 | 0.1.4 | Patch |
| `@backstage/plugin-auth-backend-module-cloudflare-access-provider` | 0.1.2 | 0.1.4 | Patch |
| `@backstage/plugin-auth-backend-module-gcp-iap-provider` | 0.2.14 | 0.2.16 | Patch |
| `@backstage/plugin-auth-backend-module-github-provider` | 0.1.16 | 0.1.18 | Patch |
| `@backstage/plugin-auth-backend-module-gitlab-provider` | 0.1.16 | 0.1.18 | Patch |
| `@backstage/plugin-auth-backend-module-google-provider` | 0.1.16 | 0.1.18 | Patch |
| `@backstage/plugin-auth-backend-module-guest-provider` | 0.1.5 | 0.1.7 | Patch |
| `@backstage/plugin-auth-backend-module-microsoft-provider` | 0.1.14 | 0.1.16 | Patch |
| `@backstage/plugin-auth-backend-module-oauth2-provider` | 0.2.0 | 0.2.2 | Patch |
| `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` | 0.1.12 | 0.1.14 | Patch |
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.2.0 | 0.2.2 | Patch |
| `@backstage/plugin-auth-backend-module-okta-provider` | 0.0.12 | 0.0.14 | Patch ⚠️ |
| `@backstage/plugin-auth-backend-module-onelogin-provider` | 0.1.0 | 0.1.2 | Patch |
| `@backstage/plugin-auth-backend-module-pinniped-provider` | 0.1.13 | 0.1.15 | Patch |
| `@backstage/plugin-auth-backend-module-vmware-cloud-provider` | 0.2.0 | 0.2.2 | Patch |
| `@backstage/plugin-auth-node` | 0.4.14 | 0.4.16 | Patch |
| `@backstage/plugin-catalog-backend` | 1.23.0 | 1.23.2 | Patch |
| `@backstage/plugin-catalog-backend-module-aws` | 0.3.14 | 0.3.16 | Patch |
| `@backstage/plugin-catalog-backend-module-azure` | 0.1.39 | 0.1.41 | Patch |
| `@backstage/plugin-catalog-backend-module-backstage-openapi` | 0.2.2 | 0.2.4 | Patch |
| `@backstage/plugin-catalog-backend-module-bitbucket-cloud` | 0.2.6 | 0.2.8 | Patch |
| `@backstage/plugin-catalog-backend-module-bitbucket-server` | 0.1.33 | 0.1.35 | Patch |
| `@backstage/plugin-catalog-backend-module-gcp` | 0.1.20 | 0.1.22 | Patch |
| `@backstage/plugin-catalog-backend-module-gerrit` | 0.1.36 | 0.1.38 | Patch |
| `@backstage/plugin-catalog-backend-module-github` | 0.6.2 | 0.6.4 | Patch |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.1.14 | 0.1.16 | Patch |
| `@backstage/plugin-catalog-backend-module-gitlab` | 0.3.18 | 0.3.20 | Patch |
| `@backstage/plugin-catalog-backend-module-gitlab-org` | 0.0.2 | 0.0.4 | Patch ⚠️ |
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.4.24 | 0.4.26 | Patch |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.6.0 | 0.6.2 | Patch |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.5.27 | 0.5.29 | Patch |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.37 | 0.1.39 | Patch |
| `@backstage/plugin-catalog-backend-module-puppetdb` | 0.1.25 | 0.1.27 | Patch |
| `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` | 0.1.17 | 0.1.19 | Patch |
| `@backstage/plugin-catalog-backend-module-unprocessed` | 0.4.6 | 0.4.8 | Patch |
| `@backstage/plugin-catalog-node` | 1.12.1 | 1.12.3 | Patch |
| `@backstage/plugin-devtools-backend` | 0.3.5 | 0.3.7 | Patch |
| `@backstage/plugin-events-backend` | 0.3.6 | 0.3.8 | Patch |
| `@backstage/plugin-events-backend-module-aws-sqs` | 0.3.5 | 0.3.7 | Patch |
| `@backstage/plugin-events-backend-module-azure` | 0.2.5 | 0.2.7 | Patch |
| `@backstage/plugin-events-backend-module-bitbucket-cloud` | 0.2.5 | 0.2.7 | Patch |
| `@backstage/plugin-events-backend-module-gerrit` | 0.2.5 | 0.2.7 | Patch |
| `@backstage/plugin-events-backend-module-github` | 0.2.5 | 0.2.7 | Patch |
| `@backstage/plugin-events-backend-module-gitlab` | 0.2.5 | 0.2.7 | Patch |
| `@backstage/plugin-events-backend-test-utils` | 0.1.29 | 0.1.31 | Patch |
| `@backstage/plugin-events-node` | 0.3.5 | 0.3.7 | Patch |
| `@backstage/plugin-home` | 0.7.5 | 0.7.6 | Patch |
| `@backstage/plugin-kubernetes-backend` | 0.18.0 | 0.18.2 | Patch |
| `@backstage/plugin-kubernetes-node` | 0.1.13 | 0.1.15 | Patch |
| `@backstage/plugin-notifications-backend` | 0.3.0 | 0.3.2 | Patch |
| `@backstage/plugin-notifications-backend-module-email` | 0.1.0 | 0.1.2 | Patch |
| `@backstage/plugin-notifications-node` | 0.2.0 | 0.2.2 | Patch |
| `@backstage/plugin-permission-backend` | 0.5.43 | 0.5.45 | Patch |
| `@backstage/plugin-permission-backend-module-allow-all-policy` | 0.1.16 | 0.1.18 | Patch |
| `@backstage/plugin-permission-node` | 0.7.30 | 0.7.32 | Patch |
| `@backstage/plugin-proxy-backend` | 0.5.0 | 0.5.2 | Patch |
| `@backstage/plugin-scaffolder` | 1.21.0 | 1.22.0 | Minor |
| `@backstage/plugin-scaffolder-backend` | 1.22.9 | 1.22.11 | Patch |
| `@backstage/plugin-scaffolder-backend-module-azure` | 0.1.11 | 0.1.13 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket` | 0.2.9 | 0.2.11 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` | 0.1.9 | 0.1.11 | Patch |
| `@backstage/plugin-scaffolder-backend-module-bitbucket-server` | 0.1.9 | 0.1.11 | Patch |
| `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` | 0.2.20 | 0.2.22 | Patch |
| `@backstage/plugin-scaffolder-backend-module-cookiecutter` | 0.2.43 | 0.2.45 | Patch |
| `@backstage/plugin-scaffolder-backend-module-gerrit` | 0.1.11 | 0.1.13 | Patch |
| `@backstage/plugin-scaffolder-backend-module-gitea` | 0.1.9 | 0.1.11 | Patch |
| `@backstage/plugin-scaffolder-backend-module-github` | 0.3.0 | 0.3.2 | Patch |
| `@backstage/plugin-scaffolder-backend-module-gitlab` | 0.4.1 | 0.4.3 | Patch |
| `@backstage/plugin-scaffolder-backend-module-notifications` | 0.0.2 | 0.0.4 | Patch ⚠️ |
| `@backstage/plugin-scaffolder-backend-module-rails` | 0.4.36 | 0.4.38 | Patch |
| `@backstage/plugin-scaffolder-backend-module-sentry` | 0.1.27 | 0.1.29 | Patch |
| `@backstage/plugin-scaffolder-backend-module-yeoman` | 0.3.2 | 0.3.5 | Patch |
| `@backstage/plugin-scaffolder-node` | 0.4.5 | 0.4.7 | Patch |
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.5 | 0.1.8 | Patch |
| `@backstage/plugin-search` | 1.4.12 | 1.4.13 | Patch |
| `@backstage/plugin-search-backend` | 1.5.10 | 1.5.13 | Patch |
| `@backstage/plugin-search-backend-module-catalog` | 0.1.25 | 0.1.27 | Patch |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.5.0 | 1.5.2 | Patch |
| `@backstage/plugin-search-backend-module-explore` | 0.1.25 | 0.1.27 | Patch |
| `@backstage/plugin-search-backend-module-pg` | 0.5.28 | 0.5.31 | Patch |
| `@backstage/plugin-search-backend-module-stack-overflow-collator` | 0.1.12 | 0.1.14 | Patch |
| `@backstage/plugin-search-backend-module-techdocs` | 0.1.24 | 0.1.26 | Patch |
| `@backstage/plugin-search-backend-node` | 1.2.24 | 1.2.26 | Patch |
| `@backstage/plugin-signals-backend` | 0.1.5 | 0.1.7 | Patch |
| `@backstage/plugin-signals-node` | 0.1.5 | 0.1.7 | Patch |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.33 | 1.0.34 | Patch |
| `@backstage/plugin-techdocs-backend` | 1.10.6 | 1.10.8 | Patch |
| `@backstage/plugin-techdocs-node` | 1.12.5 | 1.12.7 | Patch |
| `@backstage/plugin-user-settings` | 0.8.7 | 0.8.8 | Patch |
| `@backstage/plugin-user-settings-backend` | 0.2.18 | 0.2.20 | Patch |
| `@backstage/repo-tools` | 0.9.1 | 0.9.3 | Patch |
| `@backstage/test-utils` | 1.5.6 | 1.5.7 | Patch |
| `@techdocs/cli` | 1.8.12 | 1.8.15 | Patch |

## Compared to 1.27.7 (previous minor release)

2 added, 0 removed, 159 upgraded, 11 unchanged.

⚠️ Need extra attention: 17 0.x minor, 8 0.0.x patch.
...
| `@backstage/plugin-search` | 1.4.11 | 1.4.13 | Patch |
