# Backstage Release 1.12.1

## Compared to 1.12.0 (previous patch release)
...
| --- | --- | --- | --- |
| `@backstage/cli` | 0.22.4 | 0.22.5 | Patch |

## Compared to 1.11.1 (previous minor release)

3 added, 0 removed, 188 upgraded (⚠️ need extra attention: 1 major, 5 0.x minor, 3 0.0.x patch), 10 unchanged.

### ⚠️ Major version bumps

| Package | 1.11.1 | 1.12.1 |
| --- | --- | --- |
...
| `@backstage/cli` | 0.22.3 | 0.22.5 | Patch |
