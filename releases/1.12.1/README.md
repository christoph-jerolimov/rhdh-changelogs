...
0 major bumps, 0 added, 0 removed, 1 upgraded, 200 unchanged.

### Version bumps

| Package | 1.12.0 | 1.12.1 |
| --- | --- | --- |
| `@backstage/cli` | 0.22.4 | 0.22.5 |

## Compared to 1.11.1 (previous minor release)

1 major bumps, 3 added, 0 removed, 187 upgraded, 10 unchanged.
