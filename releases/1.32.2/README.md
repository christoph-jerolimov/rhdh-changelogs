# Backstage Release 1.32.2

## Compared to 1.32.1 (previous patch release)

0 added, 0 removed, 45 upgraded, 132 unchanged.

### Version bumps

| Package | 1.32.1 | 1.32.2 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-events-backend` | 0.3.13 | 0.3.14 | Patch |
...
| `@backstage/plugin-events-node` | 0.4.1 | 0.4.2 | Patch |
...
| `@backstage/plugin-scaffolder` | 1.26.0 | 1.26.1 | Patch |
| `@backstage/plugin-scaffolder-backend` | 1.26.1 | 1.26.2 | Patch |
...
| `@backstage/plugin-scaffolder-react` | 1.13.0 | 1.13.1 | Patch |
...
| `@backstage/plugin-events-backend` | 0.3.12 | 0.3.14 | Patch |
...
| `@backstage/plugin-events-node` | 0.4.0 | 0.4.2 | Patch |
...
| `@backstage/plugin-scaffolder` | 1.25.1 | 1.26.1 | Minor |
...
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.13 | 0.1.14 | Patch |
| `@backstage/plugin-scaffolder-react` | 1.12.1 | 1.13.1 | Minor |
