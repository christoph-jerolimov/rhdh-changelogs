...
| `@backstage/plugin-events-backend` | 0.3.12 | 0.3.14 |
...
| `@backstage/plugin-events-node` | 0.4.0 | 0.4.2 |
...
| `@backstage/plugin-scaffolder` | 1.25.1 | 1.26.1 |
...
| `@backstage/plugin-scaffolder-node-test-utils` | 0.1.13 | 0.1.14 |
| `@backstage/plugin-scaffolder-react` | 1.12.1 | 1.13.1 |
