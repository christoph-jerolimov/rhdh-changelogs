...
| --- | --- | --- | --- |
| `@backstage/plugin-auth-backend-module-aws-alb-provider` | 0.1.0 | 0.1.1 | Patch |
| `@backstage/plugin-auth-backend-module-gcp-iap-provider` | 0.2.4 | 0.2.5 | Patch |
| `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` | 0.1.2 | 0.1.3 | Patch |
| `@backstage/plugin-auth-node` | 0.4.4 | 0.4.5 | Patch |
...
| `@backstage/plugin-auth-backend-module-gcp-iap-provider` | 0.2.3 | 0.2.5 | Patch |
...
| `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` | 0.1.1 | 0.1.3 | Patch |
...
| `@backstage/plugin-auth-node` | 0.4.3 | 0.4.5 | Patch |
