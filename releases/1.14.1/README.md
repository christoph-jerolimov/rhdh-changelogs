# Backstage Release 1.14.1

## Compared to 1.14.0 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 212 unchanged.

### Version bumps

| Package | 1.14.0 | 1.14.1 | Type |
| --- | --- | --- | --- |
