# Backstage Release 1.31.1

## Compared to 1.31.0 (previous patch release)

0 major bumps, 0 added, 0 removed, 1 upgraded, 177 unchanged.
...
| `@backstage/backend-dynamic-feature-service` | 0.3.2 | 0.4.0 | Minor ⚠️ |
...
| `@backstage/dev-utils` | 1.0.37 | 1.1.0 | Minor |
...
| `@backstage/integration-react` | 1.1.30 | 1.1.31 | Patch |
| `@backstage/plugin-api-docs` | 0.11.8 | 0.11.9 | Patch |
...
| `@backstage/plugin-catalog` | 1.22.0 | 1.23.0 | Minor |
| `@backstage/plugin-catalog-backend` | 1.25.2 | 1.26.0 | Minor |
...
| `@backstage/plugin-catalog-backend-module-github` | 0.7.2 | 0.7.3 | Patch |
| `@backstage/plugin-catalog-backend-module-github-org` | 0.2.2 | 0.3.0 | Minor ⚠️ |
...
| `@backstage/plugin-catalog-backend-module-incremental-ingestion` | 0.5.2 | 0.5.3 | Patch |
| `@backstage/plugin-catalog-backend-module-ldap` | 0.8.1 | 0.9.0 | Minor ⚠️ |
| `@backstage/plugin-catalog-backend-module-logs` | 0.0.4 | 0.1.0 | Minor ⚠️ |
| `@backstage/plugin-catalog-backend-module-msgraph` | 0.6.1 | 0.6.2 | Patch |
| `@backstage/plugin-catalog-backend-module-openapi` | 0.1.43 | 0.2.0 | Minor ⚠️ |
...
| `@backstage/plugin-catalog-graph` | 0.4.8 | 0.4.9 | Patch |
| `@backstage/plugin-catalog-import` | 0.12.2 | 0.12.3 | Patch |
| `@backstage/plugin-catalog-node` | 1.12.6 | 1.13.0 | Minor |
| `@backstage/plugin-catalog-react` | 1.12.3 | 1.13.0 | Minor |
...
| `@backstage/plugin-home` | 0.7.9 | 0.7.10 | Patch |
| `@backstage/plugin-home-react` | 0.1.16 | 0.1.17 | Patch |
| `@backstage/plugin-kubernetes` | 0.11.13 | 0.11.14 | Patch |
| `@backstage/plugin-kubernetes-backend` | 0.18.5 | 0.18.6 | Patch |
| `@backstage/plugin-kubernetes-cluster` | 0.0.14 | 0.0.15 | Patch ⚠️ |
...
| `@backstage/plugin-org` | 0.6.28 | 0.6.29 | Patch |
| `@backstage/plugin-org-react` | 0.1.27 | 0.1.28 | Patch |
...
| `@backstage/plugin-scaffolder` | 1.24.0 | 1.25.0 | Minor |
...
| `@backstage/plugin-scaffolder-react` | 1.11.0 | 1.12.0 | Minor |
| `@backstage/plugin-search` | 1.4.15 | 1.4.16 | Patch |
...
| `@backstage/plugin-techdocs` | 1.10.8 | 1.10.9 | Patch |
| `@backstage/plugin-techdocs-addons-test-utils` | 1.0.37 | 1.0.38 | Patch |
| `@backstage/plugin-techdocs-backend` | 1.10.12 | 1.10.13 | Patch |
| `@backstage/plugin-techdocs-module-addons-contrib` | 1.1.13 | 1.1.14 | Patch |
| `@backstage/plugin-techdocs-node` | 1.12.10 | 1.12.11 | Patch |
| `@backstage/plugin-techdocs-react` | 1.2.7 | 1.2.8 | Patch |
| `@backstage/plugin-user-settings` | 0.8.11 | 0.8.12 | Patch |
