...
| `@backstage/backend-app-api` | 0.8.0 | 0.9.0 | Minor ⚠️ |
| `@backstage/backend-common` | 0.23.3 | 0.24.0 | Minor ⚠️ |
| `@backstage/backend-defaults` | 0.4.1 | 0.4.2 | Patch |
...
| `@backstage/plugin-techdocs-backend` | 1.10.9 | 1.10.10 | Patch |
